...
# 48 "./src/main/io/serial.c" 2


# 1 "./src/main/telemetry/telemetry.h" 1
# 24 "./src/main/telemetry/telemetry.h"
...
# 25 "./src/main/telemetry/telemetry.h" 2
...
_Bool isSerialConfigValid(serialConfig_t *serialConfigToCheck)
{
    ...
    for (index = 0; index < 5; index++) {
        ...
        if (bitCount > 1) {
            ...
            if (!(portConfig->functionMask & (FUNCTION_BLACKBOX | (FUNCTION_TELEMETRY_FRSKY | FUNCTION_TELEMETRY_HOTT | FUNCTION_TELEMETRY_SMARTPORT | FUNCTION_TELEMETRY_LTM)))) {
    ...
    if (mspPortCount == 0 || mspPortCount > 2) {
        return 0;
    }
    return 1;
}
...
_Bool doesConfigurationUsePort(serialPortIdentifier_e identifier)
{
    serialPortConfig_t *candidate = serialFindPortConfiguration(identifier);
    return candidate != ((void *)0) && candidate->functionMask;
}
    ...
    portOptions_t options)
{
    ...
    serialPort_t *serialPort = ((void *)0);
    ...
    switch(identifier) {
        ...
        case SERIAL_PORT_UART1:
            serialPort = uartOpen(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), callback, baudRate, mode, options);
            break;


        case SERIAL_PORT_UART2:
            serialPort = uartOpen(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), callback, baudRate, mode, options);
            break;


        case SERIAL_PORT_UART3:
            serialPort = uartOpen(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), callback, baudRate, mode, options);
            break;
...
void closeSerialPort(serialPort_t *serialPort) {
    ...
    serialPort->callback = ((void *)0);

    serialPortUsage->function = FUNCTION_NONE;
    serialPortUsage->serialPort = ((void *)0);
}
