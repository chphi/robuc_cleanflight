...
# 57 "./src/main/io/gps.c" 2




extern void pgResetFn_gpsConfig(gpsConfig_t *); gpsConfig_t gpsConfig_System; extern const pgRegistry_t gpsConfig_Registry; const pgRegistry_t gpsConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 30 | (0 << 12), .size = sizeof(gpsConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&gpsConfig_System, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_gpsConfig }, };
...
# 467 "./src/main/io/gps.c"
#define NO_FRAME 0
#define FRAME_GGA 1
#define FRAME_RMC 2
#define FRAME_GSV 3
# 514 "./src/main/io/gps.c"
...
void gpsEnablePassthrough(serialPort_t *gpsPassthroughPort)
{
    ...
    serialPassthrough(gpsPort, gpsPassthroughPort, &gpsHandlePassthrough, ((void *)0));
}
