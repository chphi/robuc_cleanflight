...
# 23 "./src/main/io/serial_1wire.c" 2
...
# 24 "./src/main/io/serial_1wire.c" 2
...
# 25 "./src/main/io/serial_1wire.c" 2
...
# 26 "./src/main/io/serial_1wire.c" 2
...
# 27 "./src/main/io/serial_1wire.c" 2
...
# 30 "./src/main/io/serial_1wire.c" 2
...
void ledInit(void);
# 31 "./src/main/io/serial_1wire.c" 2
...
# 32 "./src/main/io/serial_1wire.c" 2
...
# 33 "./src/main/io/serial_1wire.c" 2
...
# 34 "./src/main/io/serial_1wire.c" 2
...
# 35 "./src/main/io/serial_1wire.c" 2
...
# 36 "./src/main/io/serial_1wire.c" 2

uint8_t escCount;

static escHardware_t escHardware[12];
    ...
    for (volatile uint8_t i = 0; i < pwmIOConfiguration->ioCount; i++) {
        if ((pwmIOConfiguration->ioConfigurations[i].flags & PWM_PF_MOTOR) == PWM_PF_MOTOR) {
            if(motor[pwmIOConfiguration->ioConfigurations[i].index] > 0) {
                ...
                gpio_set_mode(escHardware[escCount].gpio,escHardware[escCount].pin, Mode_IPU);
                escCount++;
            }
        }
    }
...
void usb1WirePassthrough(uint8_t escIndex)
{
    ...
    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0400));
    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0200));

    gpio_set_mode(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0400), Mode_IPU);
    gpio_set_mode(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0200), Mode_Out_PP);
    ...
    gpioSetOne(escIndex, Mode_Out_PP);
    escHardware[escIndex].gpio->BSRR = escHardware[escIndex].pin;
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR = ((uint16_t)0x0200);

    while(((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->IDR & ((uint16_t)0x0400)) != (uint32_t)Bit_RESET));
    ...
    while(1) {
        ...
        escHardware[escIndex].gpio->BRR = escHardware[escIndex].pin;

        ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BRR = ((uint16_t)0x0200);
        ...
        while (((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->IDR & ((uint16_t)0x0400)) != (uint32_t)Bit_RESET)) {
            if (((escHardware[escIndex].gpio->IDR & escHardware[escIndex].pin) != (uint32_t)Bit_RESET)) {
                ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR = ((uint16_t)0x0200);
                digitalHi(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), Pin_3);
            }
            else {
