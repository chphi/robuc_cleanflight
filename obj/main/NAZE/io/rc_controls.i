...
# 19 "./src/main/io/rc_controls.c" 2
...
# 20 "./src/main/io/rc_controls.c" 2
...
# 21 "./src/main/io/rc_controls.c" 2
...
# 23 "./src/main/io/rc_controls.c" 2
...
# 25 "./src/main/io/rc_controls.c" 2
...
# 27 "./src/main/io/rc_controls.c" 2
...
# 29 "./src/main/io/rc_controls.c" 2
...
# 30 "./src/main/io/rc_controls.c" 2
...
# 32 "./src/main/io/rc_controls.c" 2
...
void mwDisarm(void);
# 33 "./src/main/io/rc_controls.c" 2
...
# 35 "./src/main/io/rc_controls.c" 2
...
# 36 "./src/main/io/rc_controls.c" 2
...
# 37 "./src/main/io/rc_controls.c" 2
...
# 39 "./src/main/io/rc_controls.c" 2
...
# 41 "./src/main/io/rc_controls.c" 2
...
# 42 "./src/main/io/rc_controls.c" 2
...
# 43 "./src/main/io/rc_controls.c" 2
...
# 44 "./src/main/io/rc_controls.c" 2
...
# 45 "./src/main/io/rc_controls.c" 2
...
# 47 "./src/main/io/rc_controls.c" 2
...
# 48 "./src/main/io/rc_controls.c" 2
...
# 49 "./src/main/io/rc_controls.c" 2
...
# 50 "./src/main/io/rc_controls.c" 2
...
# 52 "./src/main/io/rc_controls.c" 2
...
# 54 "./src/main/io/rc_controls.c" 2
...
# 55 "./src/main/io/rc_controls.c" 2
...
# 56 "./src/main/io/rc_controls.c" 2
...
# 58 "./src/main/io/rc_controls.c" 2
...
void mwDisarm(void);
void mwArm(void);
# 60 "./src/main/io/rc_controls.c" 2
...
static _Bool isUsingSticksToArm = 1;
...
_Bool areSticksInApModePosition(uint16_t ap_mode)
{
    return ((rcCommand[ROLL]) > 0 ? (rcCommand[ROLL]) : -(rcCommand[ROLL])) < ap_mode && ((rcCommand[PITCH]) > 0 ? (rcCommand[PITCH]) : -(rcCommand[PITCH])) < ap_mode;
}
...
rollPitchStatus_e calculateRollPitchCenterStatus(rxConfig_t *rxConfig)
{
    if (((rcData[PITCH] < (rxConfig->midrc + 12)) && (rcData[PITCH] > (rxConfig->midrc -12)))
            && ((rcData[ROLL] < (rxConfig->midrc + 12)) && (rcData[ROLL] > (rxConfig->midrc -12))))
        return CENTERED;
...
void processRcStickPositions(rxConfig_t *rxConfig, throttleStatus_e throttleStatus, _Bool retarded_arm, _Bool disarm_kill_switch)
{
    ...
    if (isUsingSticksToArm) {
        ...
        if (rcSticks == (1 << (2 * THROTTLE)) + (1 << (2 * YAW)) + (3 << (2 * PITCH)) + (3 << (2 * ROLL))) {
        ...
        if (retarded_arm && (rcSticks == (1 << (2 * THROTTLE)) + (3 << (2 * YAW)) + (3 << (2 * PITCH)) + (1 << (2 * ROLL)))) {
            if ((armingFlags & (ARMED)))
                mwDisarm();
            else {
                beeper(BEEPER_DISARM_REPEAT);
    ...
    if (isUsingSticksToArm) {
        ...
        if (rcSticks == (1 << (2 * THROTTLE)) + (2 << (2 * YAW)) + (3 << (2 * PITCH)) + (3 << (2 * ROLL))) {

            mwArm();
            return;
        }

        if (retarded_arm && (rcSticks == (1 << (2 * THROTTLE)) + (3 << (2 * YAW)) + (3 << (2 * PITCH)) + (2 << (2 * ROLL)))) {
...
_Bool isRangeActive(uint8_t auxChannelIndex, channelRange_t *range) {
    ...
    uint16_t channelValue = constrain(rcData[auxChannelIndex + 4], 900, 2100 - 1);
    return (channelValue >= (900 + 25 * (range->startStep))
            && channelValue < (900 + 25 * (range->endStep)));
}
...
void updateActivatedModes(modeActivationCondition_t *modeActivationConditions)
{
    ...
    for (index = 0; index < 20; index++) {
        ...
        if (isRangeActive(modeActivationCondition->auxChannelIndex, &modeActivationCondition->range)) {
            (rcModeActivationMask |= (1 << modeActivationCondition->modeId));
        }
    }
}
...
adjustmentState_t adjustmentStates[4];
...
static void setAdjustment(uint8_t* ptr, float* ptrFP, uint8_t adjustment, int delta, float factor, uint8_t min, uint8_t max) {
  if(ptrFP != 0 && (pidProfile->pidController == PID_CONTROLLER_LUX_FLOAT)) {
    *ptrFP = constrainf((*ptrFP) + (delta / factor), 0, 100);
...
void applyStepAdjustment(controlRateConfig_t *controlRateConfig, uint8_t adjustmentFunction, int delta) {
    ...
    switch(adjustmentFunction) {
        case ADJUSTMENT_RC_RATE:
            setAdjustment(&controlRateConfig->rcRate8,0,ADJUSTMENT_RC_RATE,delta,0,0,250);
            generatePitchRollCurve(controlRateConfig);
        break;
        case ADJUSTMENT_RC_EXPO:
            setAdjustment(&controlRateConfig->rcExpo8,0,ADJUSTMENT_RC_EXPO,delta,0,0,100);
            generatePitchRollCurve(controlRateConfig);
        break;
        case ADJUSTMENT_THROTTLE_EXPO:
            setAdjustment(&controlRateConfig->thrExpo8,0,ADJUSTMENT_THROTTLE_EXPO,delta,0,0,100);
            generateThrottleCurve(controlRateConfig, escAndServoConfig);
        break;
        case ADJUSTMENT_PITCH_ROLL_RATE:
        case ADJUSTMENT_PITCH_RATE:
            setAdjustment(&controlRateConfig->rates[FD_PITCH],0,ADJUSTMENT_PITCH_RATE,delta,0,0,100);
            if (adjustmentFunction == ADJUSTMENT_PITCH_RATE) {
                break;
            }

        case ADJUSTMENT_ROLL_RATE:
            setAdjustment(&controlRateConfig->rates[FD_ROLL],0,ADJUSTMENT_ROLL_RATE,delta,0,0,100);
            break;
        case ADJUSTMENT_YAW_RATE:
            setAdjustment(&controlRateConfig->rates[FD_YAW],0,ADJUSTMENT_YAW_RATE,delta,0,0,255);
            break;
        case ADJUSTMENT_PITCH_ROLL_P:
        case ADJUSTMENT_PITCH_P:
            setAdjustment(&pidProfile->P8[PIDPITCH],&pidProfile->P_f[PIDPITCH],ADJUSTMENT_PITCH_P,delta,10.0f,0,200);
            if (adjustmentFunction == ADJUSTMENT_PITCH_P) {
                break;
            }

        case ADJUSTMENT_ROLL_P:
            setAdjustment(&pidProfile->P8[PIDROLL],&pidProfile->P_f[PIDROLL],ADJUSTMENT_ROLL_P,delta,10.0f,0,200);
            break;
        case ADJUSTMENT_PITCH_ROLL_I:
        case ADJUSTMENT_PITCH_I:
            setAdjustment(&pidProfile->I8[PIDPITCH],&pidProfile->I_f[PIDPITCH],ADJUSTMENT_PITCH_I,delta,100.0f,0,200);
            if (adjustmentFunction == ADJUSTMENT_PITCH_I) {
                break;
            }

        case ADJUSTMENT_ROLL_I:
           setAdjustment(&pidProfile->I8[PIDROLL],&pidProfile->I_f[PIDROLL],ADJUSTMENT_ROLL_I,delta,100.0f,0,200);
            break;
        case ADJUSTMENT_PITCH_ROLL_D:
        case ADJUSTMENT_PITCH_D:
            setAdjustment(&pidProfile->D8[PIDPITCH],&pidProfile->D_f[PIDPITCH],ADJUSTMENT_PITCH_D,delta,1000.0f,0,200);
            if (adjustmentFunction == ADJUSTMENT_PITCH_D) {
                break;
            }

        case ADJUSTMENT_ROLL_D:
            setAdjustment(&pidProfile->D8[PIDROLL],&pidProfile->D_f[PIDROLL],ADJUSTMENT_ROLL_D,delta,1000.0f,0,200);
            break;
        case ADJUSTMENT_YAW_P:
                setAdjustment(&pidProfile->P8[PIDYAW],&pidProfile->P_f[PIDYAW],ADJUSTMENT_YAW_P,delta,10.0f,0,200);
            break;
        case ADJUSTMENT_YAW_I:
            setAdjustment(&pidProfile->I8[PIDYAW],&pidProfile->I_f[PIDYAW],ADJUSTMENT_YAW_I,delta,100.0f,0,200);
            break;
        case ADJUSTMENT_YAW_D:
                setAdjustment(&pidProfile->D8[PIDYAW],&pidProfile->D_f[PIDYAW],ADJUSTMENT_YAW_D,delta,1000.0f,0,200);
            break;
        case ADJUSTMENT_LEVEL_P:
            setAdjustment(&pidProfile->P8[PIDLEVEL],&pidProfile->A_level,ADJUSTMENT_LEVEL_P,delta,10.0f,0,200);
            break;
        case ADJUSTMENT_LEVEL_I:
            setAdjustment(&pidProfile->I8[PIDLEVEL],&pidProfile->H_level,ADJUSTMENT_LEVEL_I,delta,10.0f,0,200);
            break;
        case ADJUSTMENT_LEVEL_D:
            if ((pidProfile->pidController == PID_CONTROLLER_LUX_FLOAT)) {
              setAdjustment(&pidProfile->H_sensitivity,0,ADJUSTMENT_LEVEL_D,delta,0,0,200);
            } else {
              setAdjustment(&pidProfile->D8[PIDLEVEL],0,ADJUSTMENT_LEVEL_D,delta,0,0,200);
            }
            break;
        case ADJUSTMENT_ALT_P:
            setAdjustment(&pidProfile->P8[PIDALT],0,ADJUSTMENT_ALT_P,delta,0,0,200);
            break;
        case ADJUSTMENT_ALT_I:
            setAdjustment(&pidProfile->I8[PIDALT],0,ADJUSTMENT_ALT_I,delta,0,0,200);
            break;
        case ADJUSTMENT_ALT_D:
            setAdjustment(&pidProfile->D8[PIDALT],0,ADJUSTMENT_ALT_D,delta,0,0,200);
            break;
        case ADJUSTMENT_POS_P:
            setAdjustment(&pidProfile->P8[PIDPOS],0,ADJUSTMENT_POS_P,delta,0,0,200);
            break;
        case ADJUSTMENT_POS_I:
            setAdjustment(&pidProfile->I8[PIDPOS],0,ADJUSTMENT_POS_I,delta,0,0,200);
            break;
        case ADJUSTMENT_POSR_P:
            setAdjustment(&pidProfile->P8[PIDPOSR],0,ADJUSTMENT_POSR_P,delta,0,0,200);
            break;
        case ADJUSTMENT_POSR_I:
            setAdjustment(&pidProfile->I8[PIDPOSR],0,ADJUSTMENT_POSR_I,delta,0,0,200);
            break;
        case ADJUSTMENT_POSR_D:
            setAdjustment(&pidProfile->D8[PIDPOSR],0,ADJUSTMENT_POSR_D,delta,0,0,200);
            break;
       case ADJUSTMENT_NAVR_P:
            setAdjustment(&pidProfile->P8[PIDNAVR],0,ADJUSTMENT_NAVR_P,delta,0,0,200);
            break;
        case ADJUSTMENT_NAVR_I:
            setAdjustment(&pidProfile->I8[PIDNAVR],0,ADJUSTMENT_NAVR_I,delta,0,0,200);
            break;
        case ADJUSTMENT_NAVR_D:
            setAdjustment(&pidProfile->D8[PIDNAVR],0,ADJUSTMENT_NAVR_D,delta,0,0,200);
            break;
        case ADJUSTMENT_MAG_P:
            setAdjustment(&pidProfile->P8[PIDMAG],0,ADJUSTMENT_MAG_P,delta,0,0,200);
            break;
        case ADJUSTMENT_VEL_P:
            setAdjustment(&pidProfile->P8[PIDVEL],0,ADJUSTMENT_VEL_P,delta,0,0,200);
            break;
        case ADJUSTMENT_VEL_I:
            setAdjustment(&pidProfile->I8[PIDVEL],0,ADJUSTMENT_VEL_I,delta,0,0,200);
            break;
        case ADJUSTMENT_VEL_D:
            setAdjustment(&pidProfile->D8[PIDVEL],0,ADJUSTMENT_VEL_D,delta,0,0,200);
            break;
        default:
            break;
    };
...
void processRcAdjustments(controlRateConfig_t *controlRateConfig, rxConfig_t *rxConfig)
{
    ...
    _Bool canUseRxData = rxIsReceivingSignal();


    for (adjustmentIndex = 0; adjustmentIndex < 4; adjustmentIndex++) {
        ...
        _Bool canResetReadyStates = signedDiff >= 0L;
        ...
        uint8_t channelIndex = 4 + adjustmentState->auxChannelIndex;
...
int32_t getRcStickDeflection(int32_t axis, uint16_t midrc) {
    return ((((rcData[axis] - midrc) > 0 ? (rcData[axis] - midrc) : -(rcData[axis] - midrc))) < (500) ? (((rcData[axis] - midrc) > 0 ? (rcData[axis] - midrc) : -(rcData[axis] - midrc))) : (500));
}
