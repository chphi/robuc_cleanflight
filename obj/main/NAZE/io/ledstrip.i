...
# 50 "./src/main/io/ledstrip.c" 2

static _Bool ledStripInitialised = 0;
static _Bool ledStripEnabled = 1;

static void ledStripDisable(void);
# 64 "./src/main/io/ledstrip.c"
...
const hsvColor_t hsv_red = { 0, 0, 255};
const hsvColor_t hsv_orange = { 30, 0, 255};
const hsvColor_t hsv_yellow = { 60, 0, 255};
const hsvColor_t hsv_limeGreen = { 90, 0, 255};
const hsvColor_t hsv_green = {120, 0, 255};
const hsvColor_t hsv_mintGreen = {150, 0, 255};
const hsvColor_t hsv_cyan = {180, 0, 255};
const hsvColor_t hsv_lightBlue = {210, 0, 255};
const hsvColor_t hsv_blue = {240, 0, 255};
const hsvColor_t hsv_darkViolet = {270, 0, 255};
const hsvColor_t hsv_magenta = {300, 0, 255};
const hsvColor_t hsv_deepPink = {330, 0, 255};
...
hsvColor_t *colors;
# 249 "./src/main/io/ledstrip.c"
const ledConfig_t defaultLedStripConfig[] = {
    { (((15 & (0x0F)) << 4) | ((15 & (0x0F)) << 0)), 0, LED_DIRECTION_SOUTH | LED_DIRECTION_EAST | LED_FUNCTION_INDICATOR | LED_FUNCTION_ARM_STATE },

    { (((15 & (0x0F)) << 4) | ((8 & (0x0F)) << 0)), 0, LED_DIRECTION_EAST | LED_FUNCTION_FLIGHT_MODE | LED_FUNCTION_WARNING },
    { (((15 & (0x0F)) << 4) | ((7 & (0x0F)) << 0)), 0, LED_DIRECTION_EAST | LED_FUNCTION_FLIGHT_MODE | LED_FUNCTION_WARNING },

    { (((15 & (0x0F)) << 4) | ((0 & (0x0F)) << 0)), 0, LED_DIRECTION_NORTH | LED_DIRECTION_EAST | LED_FUNCTION_INDICATOR | LED_FUNCTION_ARM_STATE },

    { (((8 & (0x0F)) << 4) | ((0 & (0x0F)) << 0)), 0, LED_DIRECTION_NORTH | LED_FUNCTION_FLIGHT_MODE },
    { (((7 & (0x0F)) << 4) | ((0 & (0x0F)) << 0)), 0, LED_DIRECTION_NORTH | LED_FUNCTION_FLIGHT_MODE },

    { (((0 & (0x0F)) << 4) | ((0 & (0x0F)) << 0)), 0, LED_DIRECTION_NORTH | LED_DIRECTION_WEST | LED_FUNCTION_INDICATOR | LED_FUNCTION_ARM_STATE },

    { (((0 & (0x0F)) << 4) | ((7 & (0x0F)) << 0)), 0, LED_DIRECTION_WEST | LED_FUNCTION_FLIGHT_MODE | LED_FUNCTION_WARNING },
    { (((0 & (0x0F)) << 4) | ((8 & (0x0F)) << 0)), 0, LED_DIRECTION_WEST | LED_FUNCTION_FLIGHT_MODE | LED_FUNCTION_WARNING },

    { (((0 & (0x0F)) << 4) | ((15 & (0x0F)) << 0)), 0, LED_DIRECTION_SOUTH | LED_DIRECTION_WEST | LED_FUNCTION_INDICATOR | LED_FUNCTION_ARM_STATE },

    { (((7 & (0x0F)) << 4) | ((15 & (0x0F)) << 0)), 0, LED_DIRECTION_SOUTH | LED_FUNCTION_FLIGHT_MODE | LED_FUNCTION_WARNING },
    { (((8 & (0x0F)) << 4) | ((15 & (0x0F)) << 0)), 0, LED_DIRECTION_SOUTH | LED_FUNCTION_FLIGHT_MODE | LED_FUNCTION_WARNING },

    { (((7 & (0x0F)) << 4) | ((7 & (0x0F)) << 0)), 0, LED_DIRECTION_UP | LED_FUNCTION_FLIGHT_MODE | LED_FUNCTION_WARNING },
    { (((8 & (0x0F)) << 4) | ((7 & (0x0F)) << 0)), 0, LED_DIRECTION_UP | LED_FUNCTION_FLIGHT_MODE | LED_FUNCTION_WARNING },
    { (((7 & (0x0F)) << 4) | ((8 & (0x0F)) << 0)), 0, LED_DIRECTION_DOWN | LED_FUNCTION_FLIGHT_MODE | LED_FUNCTION_WARNING },
    { (((8 & (0x0F)) << 4) | ((8 & (0x0F)) << 0)), 0, LED_DIRECTION_DOWN | LED_FUNCTION_FLIGHT_MODE | LED_FUNCTION_WARNING },

    { (((8 & (0x0F)) << 4) | ((9 & (0x0F)) << 0)), 3, LED_FUNCTION_THRUST_RING},
    { (((9 & (0x0F)) << 4) | ((10 & (0x0F)) << 0)), 3, LED_FUNCTION_THRUST_RING},
    { (((10 & (0x0F)) << 4) | ((11 & (0x0F)) << 0)), 3, LED_FUNCTION_THRUST_RING},
    { (((10 & (0x0F)) << 4) | ((12 & (0x0F)) << 0)), 3, LED_FUNCTION_THRUST_RING},
    { (((9 & (0x0F)) << 4) | ((13 & (0x0F)) << 0)), 3, LED_FUNCTION_THRUST_RING},
    { (((8 & (0x0F)) << 4) | ((14 & (0x0F)) << 0)), 3, LED_FUNCTION_THRUST_RING},
    { (((7 & (0x0F)) << 4) | ((14 & (0x0F)) << 0)), 3, LED_FUNCTION_THRUST_RING},
    { (((6 & (0x0F)) << 4) | ((13 & (0x0F)) << 0)), 3, LED_FUNCTION_THRUST_RING},
    { (((5 & (0x0F)) << 4) | ((12 & (0x0F)) << 0)), 3, LED_FUNCTION_THRUST_RING},
    { (((5 & (0x0F)) << 4) | ((11 & (0x0F)) << 0)), 3, LED_FUNCTION_THRUST_RING},
    { (((6 & (0x0F)) << 4) | ((10 & (0x0F)) << 0)), 3, LED_FUNCTION_THRUST_RING},
    { (((7 & (0x0F)) << 4) | ((9 & (0x0F)) << 0)), 3, LED_FUNCTION_THRUST_RING},

};
# 303 "./src/main/io/ledstrip.c"
typedef enum {
    X_COORDINATE,
    Y_COORDINATE,
    DIRECTIONS,
...
static const char chunkSeparators[5] = {',', ':', ':',':', '\0' };

static const char directionCodes[] = { 'N', 'E', 'S', 'W', 'U', 'D' };
#define DIRECTION_COUNT (sizeof(directionCodes) / sizeof(directionCodes[0]))
static const uint8_t directionMappings[(sizeof(directionCodes) / sizeof(directionCodes[0]))] = {
    LED_DIRECTION_NORTH,
    LED_DIRECTION_EAST,
    LED_DIRECTION_SOUTH,
    LED_DIRECTION_WEST,
...
static const uint16_t functionMappings[(sizeof(functionCodes) / sizeof(functionCodes[0]))] = {
...
void determineLedStripDimensions(void)
{
    ...
    for (ledIndex = 0; ledIndex < ledCount; ledIndex++) {
        ...
        if (((ledConfig->xy >> 4) & (0x0F)) >= ledGridWidth) {
            ledGridWidth = ((ledConfig->xy >> 4) & (0x0F)) + 1;
        }
        if (((ledConfig->xy >> 0) & (0x0F)) >= ledGridHeight) {
            ledGridHeight = ((ledConfig->xy >> 0) & (0x0F)) + 1;
        }
    }
}
...
{
    _Bool isOddHeight = (ledGridHeight & 1);
    _Bool isOddWidth = (ledGridWidth & 1);
...
void updateLedCount(void)
{
    ...
    for (ledIndex = 0; ledIndex < 32; ledIndex++) {
...
_Bool parseLedStripConfig(uint8_t ledIndex, const char *config)
{
    ...
    while (ok) {
        ...
        while (*config && chunkIndex < 10 && *config != chunkSeparator) {
        ...
        switch((parseState_e)parseState) {
            case X_COORDINATE:
                val = atoi(chunk);
                ledConfig->xy |= ((val & (0x0F)) << 4);
                break;
            case Y_COORDINATE:
                val = atoi(chunk);
                ledConfig->xy |= ((val & (0x0F)) << 0);
                break;
            case DIRECTIONS:
                for (chunkIndex = 0; chunk[chunkIndex] && chunkIndex < 10; chunkIndex++) {
                    for (uint8_t mappingIndex = 0; mappingIndex < (sizeof(directionCodes) / sizeof(directionCodes[0])); mappingIndex++) {
            ...
            case FUNCTIONS:
                for (chunkIndex = 0; chunk[chunkIndex] && chunkIndex < 10; chunkIndex++) {
                    for (uint8_t mappingIndex = 0; mappingIndex < (sizeof(functionCodes) / sizeof(functionCodes[0])); mappingIndex++) {
...
void generateLedConfig(uint8_t ledIndex, char *ledConfigBuffer, size_t bufferSize)
{
    char functions[(sizeof(functionCodes) / sizeof(functionCodes[0]))];
    char directions[(sizeof(directionCodes) / sizeof(directionCodes[0]))];
    uint8_t index;
    ...
    for (mappingIndex = 0, index = 0; mappingIndex < (sizeof(functionCodes) / sizeof(functionCodes[0])); mappingIndex++) {
        if (ledConfig->flags & functionMappings[mappingIndex]) {
            functions[index++] = functionCodes[mappingIndex];
        }
    }

    for (mappingIndex = 0, index = 0; mappingIndex < (sizeof(directionCodes) / sizeof(directionCodes[0])); mappingIndex++) {
        if (ledConfig->flags & directionMappings[mappingIndex]) {
            directions[index++] = directionCodes[mappingIndex];
        }
    }

    tfp_sprintf(ledConfigBuffer, "%u,%u:%s:%s:%u", ((ledConfig->xy >> 4) & (0x0F)), ((ledConfig->xy >> 0) & (0x0F)), directions, functions, ledConfig->color);
}
...
void applyDirectionalModeColor(const uint8_t ledIndex, const ledConfig_t *ledConfig, const modeColorIndexes_t *modeColors)
{
    ...
    if ((ledConfig->flags & LED_DIRECTION_WEST) && ((ledConfig->xy >> 4) & (0x0F)) <= highestXValueForWest) {
        setLedHsv(ledIndex, &colors[modeColors->west]);
    }

    if ((ledConfig->flags & LED_DIRECTION_EAST) && ((ledConfig->xy >> 4) & (0x0F)) >= lowestXValueForEast) {
        setLedHsv(ledIndex, &colors[modeColors->east]);
    }

    if ((ledConfig->flags & LED_DIRECTION_NORTH) && ((ledConfig->xy >> 0) & (0x0F)) <= highestYValueForNorth) {
        setLedHsv(ledIndex, &colors[modeColors->north]);
    }

    if ((ledConfig->flags & LED_DIRECTION_SOUTH) && ((ledConfig->xy >> 0) & (0x0F)) >= lowestYValueForSouth) {
...
void applyQuadrantColor(const uint8_t ledIndex, const ledConfig_t *ledConfig, const quadrant_e quadrant, const hsvColor_t *color)
{
    switch (quadrant) {
        case QUADRANT_NORTH_EAST:
            if (((ledConfig->xy >> 0) & (0x0F)) <= highestYValueForNorth && ((ledConfig->xy >> 4) & (0x0F)) >= lowestXValueForEast) {
                setLedHsv(ledIndex, color);
            }
            return;

        case QUADRANT_SOUTH_EAST:
            if (((ledConfig->xy >> 0) & (0x0F)) >= lowestYValueForSouth && ((ledConfig->xy >> 4) & (0x0F)) >= lowestXValueForEast) {
                setLedHsv(ledIndex, color);
            }
            return;

        case QUADRANT_SOUTH_WEST:
            if (((ledConfig->xy >> 0) & (0x0F)) >= lowestYValueForSouth && ((ledConfig->xy >> 4) & (0x0F)) <= highestXValueForWest) {
                setLedHsv(ledIndex, color);
            }
            return;

        case QUADRANT_NORTH_WEST:
            if (((ledConfig->xy >> 0) & (0x0F)) <= highestYValueForNorth && ((ledConfig->xy >> 4) & (0x0F)) <= highestXValueForWest) {
                setLedHsv(ledIndex, color);
            }
            return;
    }
...
void applyLedModeLayer(void)
{
    ...
    for (ledIndex = 0; ledIndex < ledCount; ledIndex++) {
        ...
        } else if ((flightModeFlags & (MAG_MODE))) {
...
void applyLedWarningLayer(uint8_t updateNow)
{
    ...
    if (updateNow && warningFlashCounter == 0) {
        ...
        if (!(armingFlags & (ARMED)) && !(armingFlags & (OK_TO_ARM))) {
...
void applyLedThrottleLayer()
{
    ...
    for (ledIndex = 0; ledIndex < ledCount; ledIndex++) {
        ...
        int scaled = scaleRange(rcData[THROTTLE], 1000, 2000, -60, +60);
        scaled += 359;
        color.h = (color.h + scaled) % 359;
        setLedHsv(ledIndex, &color);
    }
}
...
void applyLedThrustRingLayer(void)
{
    ...
    static uint8_t rotationPhase = 6;
    _Bool nextLedOn = 0;
    ...
    for (ledIndex = 0; ledIndex < ledCount; ledIndex++) {
        ...
        _Bool applyColor = 0;
        if ((armingFlags & (ARMED))) {
            if ((ledRingIndex + rotationPhase) % rotationSeqLedCount < 2) {
                applyColor = 1;
            }
        } else {
            if (nextLedOn == 0) {
    ...
    if (rotationSeqLedCount == 255) {
        ...
        if ((ledRingLedCount % 6) == 0) {
            rotationSeqLedCount = 6;
        } else {

            while ((rotationSeqLedCount > 6) && ((rotationSeqLedCount % 2) == 0)) {
...
void updateLedStrip(void)
{
 ...
 if (!(ledStripInitialised && isWS2811LedStripReady())) {
    ...
    if (((1 << (BOXLEDLOW)) & rcModeActivationMask)) {
        if (ledStripEnabled) {
            ledStripDisable();
            ledStripEnabled = 0;
        }
    ...
    _Bool indicatorFlashNow = (int32_t)(now - nextIndicatorFlashAt) >= 0L;
    _Bool warningFlashNow = (int32_t)(now - nextWarningFlashAt) >= 0L;
    _Bool rotationUpdateNow = (int32_t)(now - nextRotationUpdateAt) >= 0L;
    ...
    if (warningFlashNow) {
        nextWarningFlashAt = now + ((1000 * 1000) / 10);
    }
    ...
    if (indicatorFlashNow) {
        ...
        uint8_t rollScale = ((rcCommand[ROLL]) > 0 ? (rcCommand[ROLL]) : -(rcCommand[ROLL])) / 50;
        uint8_t pitchScale = ((rcCommand[PITCH]) > 0 ? (rcCommand[PITCH]) : -(rcCommand[PITCH])) / 50;
        uint8_t scale = ((rollScale) > (pitchScale) ? (rollScale) : (pitchScale));
        nextIndicatorFlashAt = now + (((1000 * 1000) / 5) / ((1) > (scale) ? (1) : (scale)));
...
# 978 "./src/main/io/ledstrip.c"
    if (rotationUpdateNow) {
        ...
        if ((armingFlags & (ARMED))) {
            animationSpeedScale = scaleRange(rcData[THROTTLE], 1000, 2000, 1, 10);
        }

        nextRotationUpdateAt = now + ((1000 * 1000) / 5)/animationSpeedScale;
    }
...
_Bool parseColor(uint8_t index, const char *colorConfig)
{
    ...
    for (componentIndex = 0; ok && componentIndex < (HSV_VALUE + 1); componentIndex++) {
...
{
    memset(ledConfigs, 0, 32 * sizeof(ledConfig_t));
...
void ledStripInit(ledConfig_t *ledConfigsToUse, hsvColor_t *colorsToUse)
{
    ...
    colors = colorsToUse;
    ledStripInitialised = 0;
}

void ledStripEnable(void)
{
    reevalulateLedConfig();
    ledStripInitialised = 1;
