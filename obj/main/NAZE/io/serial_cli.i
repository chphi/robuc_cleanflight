...
# 20 "./src/main/io/serial_cli.c" 2
# 1 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\stdlib.h" 1 3
...
# 11 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\stdlib.h" 2 3
...
# 12 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\stdlib.h" 2 3
...
#undef __need_NULL
# 17 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\stdlib.h" 2 3
...
# 19 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\stdlib.h" 2 3
# 1 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\machine\\stdlib.h" 1 3

#define _MACHSTDLIB_H_ 
# 20 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\stdlib.h" 2 3

# 1 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\alloca.h" 1 3
...
# 22 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\stdlib.h" 2 3
...
# 221 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\stdlib.h" 3
...
# 21 "./src/main/io/serial_cli.c" 2
# 1 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\lib\\gcc\\arm-none-eabi\\4.8.4\\include\\stdarg.h" 1 3 4
# 31 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\lib\\gcc\\arm-none-eabi\\4.8.4\\include\\stdarg.h" 3 4
#define _STDARG_H 
...
# 98 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\lib\\gcc\\arm-none-eabi\\4.8.4\\include\\stdarg.h" 3 4
...
# 24 "./src/main/io/serial_cli.c" 2
# 1 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\ctype.h" 1 3
...
# 57 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\ctype.h" 3
...
# 84 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\ctype.h" 3
...
# 104 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\ctype.h" 3
...
int32_t filterApplyAverage(int32_t input, uint8_t averageCount, int32_t averageState[12]);
float filterApplyAveragef(float input, uint8_t averageCount, float averageState[12]);
# 37 "./src/main/io/serial_cli.c" 2
...
_Bool i2cWriteBuffer(uint8_t addr_, uint8_t reg_, uint8_t len_, uint8_t *data);
_Bool i2cWrite(uint8_t addr_, uint8_t reg, uint8_t data);
_Bool i2cRead(uint8_t addr_, uint8_t reg, uint8_t len, uint8_t* buf);
uint16_t i2cGetErrorCounter(void);
void i2cSetOverclock(uint8_t OverClock);
# 49 "./src/main/io/serial_cli.c" 2
...
typedef enum {
    ...
    TASK_LEDSTRIP,
# 66 "./src/main/fc/fc_tasks.h"
    TASK_COUNT
} cfTaskId_e;

void taskSystem(void);
_Bool taskGyroCheck(uint32_t currentDeltaTime);
void taskGyro(void);
_Bool taskPidCheck(uint32_t currentDeltaTime);
void taskPid(void);
void taskUpdateAccelerometer(void);
void taskUpdateAttitude(void);
_Bool taskUpdateRxCheck(uint32_t currentDeltaTime);
...
# 61 "./src/main/io/serial_cli.c" 2
# 1 "./src/main/fc/fc_debug.h" 1
# 18 "./src/main/fc/fc_debug.h"
typedef enum {
...
extern debugConfig_t debugConfig_System; static inline debugConfig_t* debugConfig(void) { return &debugConfig_System; } struct _dummy;
# 62 "./src/main/io/serial_cli.c" 2
...
typedef struct {
    ...
    const char * taskName;
    _Bool (*checkFunc)(uint32_t currentDeltaTime);
    void (*taskFunc)(void);
    uint32_t desiredPeriod;
...
void setTaskEnabled(const int taskId, _Bool newEnabledState);
...
extern motorConfig_t motorConfig_System; static inline motorConfig_t* motorConfig(void) { return &motorConfig_System; } struct _dummy;
# 66 "./src/main/io/serial_cli.c" 2
...
extern servoConfig_t servoConfig_System; static inline servoConfig_t* servoConfig(void) { return &servoConfig_System; } struct _dummy;
# 67 "./src/main/io/serial_cli.c" 2
...
_Bool spektrumInit(const rxConfig_t *initialRxConfig, rxRuntimeConfig_t *rxRuntimeConfig);

void spektrumBind(rxConfig_t *rxConfig);
# 79 "./src/main/io/serial_cli.c" 2
...
extern blackboxConfig_t blackboxConfig_System; static inline blackboxConfig_t* blackboxConfig(void) { return &blackboxConfig_System; } struct _dummy;
...
_Bool blackboxMayEditConfig();
# 90 "./src/main/io/serial_cli.c" 2
...
# 92 "./src/main/io/serial_cli.c" 2
# 1 "./src/main/flight/gtune.h" 1
# 18 "./src/main/flight/gtune.h"
...
extern gtuneConfig_t *gtuneConfig_ProfileCurrent; static inline gtuneConfig_t* gtuneConfig(void) { return gtuneConfig_ProfileCurrent; } struct _dummy;

void init_Gtune(void);
void calculate_Gtune(uint8_t axis);
# 93 "./src/main/io/serial_cli.c" 2
...
extern servoMixer_t customServoMixer_SystemArray[(2 * 8)]; static inline servoMixer_t* customServoMixer(int _index) { return &customServoMixer_SystemArray[_index]; } static inline servoMixer_t (* customServoMixer_arr(void))[(2 * 8)] { return &customServoMixer_SystemArray; } struct _dummy;
...
# 101 "./src/main/io/serial_cli.c" 2
# 1 "./src/main/telemetry/frsky.h" 1
# 21 "./src/main/telemetry/frsky.h"
...
extern frskyTelemetryConfig_t frskyTelemetryConfig_System; static inline frskyTelemetryConfig_t* frskyTelemetryConfig(void) { return &frskyTelemetryConfig_System; } struct _dummy;

void handleFrSkyTelemetry(uint16_t deadband3d_throttle);
_Bool checkFrSkyTelemetryState(void);

void initFrSkyTelemetry(void);
void configureFrSkyTelemetryPort(void);
void freeFrSkyTelemetryPort(void);
# 102 "./src/main/io/serial_cli.c" 2
# 1 "./src/main/telemetry/hott.h" 1
# 27 "./src/main/telemetry/hott.h"
...
typedef struct HOTT_GAM_MSG_s {
    ...
    uint8_t warning_beeps;
# 143 "./src/main/telemetry/hott.h"
    uint8_t sensor_id;
    uint8_t alarm_invers1;
# 154 "./src/main/telemetry/hott.h"
    uint8_t alarm_invers2;
# 165 "./src/main/telemetry/hott.h"
    uint8_t cell1;
    uint8_t cell2;
    uint8_t cell3;
    uint8_t cell4;
...
typedef struct HOTT_EAM_MSG_s {
    ...
    uint8_t warning_beeps;
# 280 "./src/main/telemetry/hott.h"
    uint8_t sensor_id;
    uint8_t alarm_invers1;
# 291 "./src/main/telemetry/hott.h"
    uint8_t alarm_invers2;
# 302 "./src/main/telemetry/hott.h"
    uint8_t cell1_L;
    uint8_t cell2_L;
    uint8_t cell3_L;
    uint8_t cell4_L;
...
extern hottTelemetryConfig_t hottTelemetryConfig_System; static inline hottTelemetryConfig_t* hottTelemetryConfig(void) { return &hottTelemetryConfig_System; } struct _dummy;

void handleHoTTTelemetry(void);
_Bool checkHoTTTelemetryState(void);
...
# 103 "./src/main/io/serial_cli.c" 2
...
extern ibusTelemetryConfig_t ibusTelemetryConfig_System; static inline ibusTelemetryConfig_t* ibusTelemetryConfig(void) { return &ibusTelemetryConfig_System; } struct _dummy;

void initIbusTelemetry(void);

void handleIbusTelemetry(void);
_Bool checkIbusTelemetryState(void);

void configureIbusTelemetryPort(void);
void freeIbusTelemetryPort(void);
# 104 "./src/main/io/serial_cli.c" 2
...
extern mspServerConfig_t mspServerConfig_System; static inline mspServerConfig_t* mspServerConfig(void) { return &mspServerConfig_System; } struct _dummy;
# 106 "./src/main/io/serial_cli.c" 2
...
void mwDisarm(void);
# 108 "./src/main/io/serial_cli.c" 2
...
# 109 "./src/main/io/serial_cli.c" 2
...
extern systemConfig_t systemConfig_System; static inline systemConfig_t* systemConfig(void) { return &systemConfig_System; } struct _dummy;
# 110 "./src/main/io/serial_cli.c" 2
...
# 111 "./src/main/io/serial_cli.c" 2
...
extern profileSelection_t profileSelection_System; static inline profileSelection_t* profileSelection(void) { return &profileSelection_System; } struct _dummy;

uint8_t getCurrentProfile(void);
void setProfile(uint8_t profileIndex);
# 112 "./src/main/io/serial_cli.c" 2
...
extern flashchipConfig_t flashchipConfig_System; static inline flashchipConfig_t* flashchipConfig(void) { return &flashchipConfig_System; } struct _dummy;
# 113 "./src/main/io/serial_cli.c" 2
...
# 115 "./src/main/io/serial_cli.c" 2

# 1 "./src/main/io/serial_cli.h" 1
# 18 "./src/main/io/serial_cli.h"
...
_Bool cliIsActiveOnPort(serialPort_t *serialPort);
# 117 "./src/main/io/serial_cli.c" 2
# 1 "./src/main/io/../sensors/amperage.h" 1
# 18 "./src/main/io/../sensors/amperage.h"
...
void amperageMeterInit(void);
# 118 "./src/main/io/serial_cli.c" 2
...
static const char * const mixerNames[] = {
    ...
    "ATAIL4", "CUSTOM", "CUSTOMAIRPLANE", "CUSTOMTRI", ((void *)0)
};
...
static const char * const featureNames[] = {
    ...
    "BLACKBOX", "CHANNEL_FORWARDING", "TRANSPONDER", "OSD", ((void *)0)
};
...
static const char * const sensorTypeNames[] = {
    "GYRO", "ACC", "BARO", "MAG", "SONAR", "GPS", "GPS+MAG", ((void *)0)
};

#define SENSOR_NAMES_MASK (SENSOR_GYRO | SENSOR_ACC | SENSOR_BARO | SENSOR_MAG)

static const char * const sensorHardwareNames[4][11] = {
    { "", "None", "MPU6050", "L3G4200D", "MPU3050", "L3GD20", "MPU6000", "MPU6500", "FAKE", ((void *)0) },
    { "", "None", "ADXL345", "MPU6050", "MMA845x", "BMA280", "LSM303DLHC", "MPU6000", "MPU6500", "FAKE", ((void *)0) },
    { "", "None", "BMP085", "MS5611", "BMP280", ((void *)0) },
    { "", "None", "HMC5883", "AK8975", "AK8963", ((void *)0) }
};
...
# 279 "./src/main/io/serial_cli.c"
const clicmd_t cmdTable[] = {
    { "adjrange" , "configure adjustment ranges" , ((void *)0) , cliAdjustmentRange },
    { "aux" , "configure modes" , ((void *)0) , cliAux },

    { "color" , "configure colors" , ((void *)0) , cliColor },
    { "mode_color" , "configure mode and special colors" , ((void *)0) , cliModeColor },

    { "defaults" , "reset to defaults and reboot" , ((void *)0) , cliDefaults },
    { "dump" , "dump configuration" , "[master|profile|rates]" , cliDump }
                                          ,
    { "exit" , ((void *)0) , ((void *)0) , cliExit },
    { "feature" , "configure features" , "list\r\n" "\t<+|->[name]" , cliFeature }

                                    ,

    { "flash_erase" , "erase flash chip" , ((void *)0) , cliFlashErase },
    { "flash_info" , "show flash chip info" , ((void *)0) , cliFlashInfo },
    ...
    { "gpspassthrough" , "passthrough gps to serial" , ((void *)0) , cliGpsPassthrough },


    { "help" , ((void *)0) , ((void *)0) , cliHelp },


    { "led" , "configure leds" , ((void *)0) , cliLed },

    { "map" , "configure rc channel order" , "[<map>]" , cliMap }
                          ,

    { "mixer" , "configure mixer" , "list\r\n" "\t<name>" , cliMixer }

                             ,

    { "mmix" , "custom motor mixer" , ((void *)0) , cliMotorMix },
    { "motor" , "get/set motor" , "<index> [<value>]" , cliMotor }
                                     ,
    ...
    { "rateprofile" , "change rate profile" , "[<index>]" , cliRateProfile }
                                    ,
    { "rxrange" , "configure rx channel ranges" , ((void *)0) , cliRxRange },
    { "rxfail" , "show/set rx failsafe settings" , ((void *)0) , cliRxFail },
    { "save" , "save and reboot" , ((void *)0) , cliSave },
    { "serial" , "configure serial ports" , ((void *)0) , cliSerial },

    { "serialpassthrough" , "passthrough serial data to port" , "<id> [baud] [mode] : passthrough to serial" , cliSerialPassthrough }

                                         ,


    { "servo" , "configure servos" , ((void *)0) , cliServo },

    { "set" , "change setting" , "[<name>=<value>]" , cliSet }
                                   ,

    { "smix" , "servo mixer" , "<rule> <servo> <source> <rate> <speed> <min> <max> <box>\r\n" "\treset\r\n" "\tload <mixer>\r\n" "\treverse <servo> <source> r|n" , cliServoMix }
    ...
    { "status" , "show status" , ((void *)0) , cliStatus },


    { "tasks" , "show task stats" , ((void *)0) , cliTasks },

    { "version" , "show version" , ((void *)0) , cliVersion },
};
...
const clivalue_t valueTable[] = {
    { "debug_mode", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_DEBUG }, 51, __builtin_offsetof (debugConfig_t, debug_mode)},

    { "emf_avoidance", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 18, __builtin_offsetof (systemConfig_t, emf_avoidance)},
    { "i2c_highspeed", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 18, __builtin_offsetof (systemConfig_t, i2c_highspeed)},

    { "flashchip_id", VAR_UINT32 | MASTER_VALUE, .config.minmax = { 0, 0xffffff } , 101, __builtin_offsetof (flashchipConfig_t, flashchip_id)},
    { "flashchip_nsect", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 0xffff } , 101, __builtin_offsetof (flashchipConfig_t, flashchip_nsect)},
    { "flashchip_pps", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 0xffff } , 101, __builtin_offsetof (flashchipConfig_t, flashchip_pps)},


    { "mid_rc", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 1200, 1700 } , 24, __builtin_offsetof (rxConfig_t, midrc)},
    { "min_check", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 2000 } , 24, __builtin_offsetof (rxConfig_t, mincheck)},
    { "max_check", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 2000 } , 24, __builtin_offsetof (rxConfig_t, maxcheck)},
    { "rssi_channel", VAR_INT8 | MASTER_VALUE, .config.minmax = { 0, (18) } , 24, __builtin_offsetof (rxConfig_t, rssi_channel)},
    { "rssi_scale", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 1, 255 } , 24, __builtin_offsetof (rxConfig_t, rssi_scale)},
    { "rssi_invert", VAR_INT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 24, __builtin_offsetof (rxConfig_t, rssi_invert)},
    { "rc_smoothing", VAR_INT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 24, __builtin_offsetof (rxConfig_t, rcSmoothing)},
    { "rx_min_usec", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 750, 2250 } , 24, __builtin_offsetof (rxConfig_t, rx_min_usec)},
    { "rx_max_usec", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 750, 2250 } , 24, __builtin_offsetof (rxConfig_t, rx_max_usec)},
    { "serialrx_provider", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_SERIAL_RX } , 24, __builtin_offsetof (rxConfig_t, serialrx_provider)},
    { "sbus_inversion", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 24, __builtin_offsetof (rxConfig_t, sbus_inversion)},
    { "spektrum_sat_bind", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, 10} , 24, __builtin_offsetof (rxConfig_t, spektrum_sat_bind)},

    { "input_filtering_mode", VAR_INT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 100, __builtin_offsetof (pwmRxConfig_t, inputFilteringMode)},

    { "min_throttle", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 2000 } , 6, __builtin_offsetof (motorConfig_t, minthrottle)},
    { "max_throttle", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 2000 } , 6, __builtin_offsetof (motorConfig_t, maxthrottle)},
    { "min_command", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 2000 } , 6, __builtin_offsetof (motorConfig_t, mincommand)},
    { "motor_pwm_rate", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 50, 32000 } , 6, __builtin_offsetof (motorConfig_t, motor_pwm_rate)},

    { "servo_center_pulse", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 2000 } , 52, __builtin_offsetof (servoConfig_t, servoCenterPulse)},
    { "servo_pwm_rate", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 50, 498 } , 52, __builtin_offsetof (servoConfig_t, servo_pwm_rate)},



    { "3d_deadband_low", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 2000 } , 26, __builtin_offsetof (motor3DConfig_t, deadband3d_low)},
    { "3d_deadband_high", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 2000 } , 26, __builtin_offsetof (motor3DConfig_t, deadband3d_high)},
    { "3d_neutral", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 2000 } , 26, __builtin_offsetof (motor3DConfig_t, neutral3d)},

    { "retarded_arm", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 16, __builtin_offsetof (armingConfig_t, retarded_arm)},
    { "disarm_kill_switch", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 16, __builtin_offsetof (armingConfig_t, disarm_kill_switch)},
    { "auto_disarm_delay", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, 60 } , 16, __builtin_offsetof (armingConfig_t, auto_disarm_delay)},
    { "max_arm_angle", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, 180 } , 16, __builtin_offsetof (armingConfig_t, max_arm_angle)},

    { "fixedwing_althold_dir", VAR_INT8 | MASTER_VALUE, .config.minmax = { -1, 1 }, 29, __builtin_offsetof (airplaneConfig_t, fixedwing_althold_dir) },

    { "reboot_character", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 48, 126 } , 13, __builtin_offsetof (serialConfig_t, reboot_character)},


    { "gps_provider", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_GPS_PROVIDER }, 30, __builtin_offsetof (gpsConfig_t, provider)},
    { "gps_sbas_mode", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_GPS_SBAS_MODE }, 30, __builtin_offsetof (gpsConfig_t, sbasMode)},
    { "gps_auto_config", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, 30, __builtin_offsetof (gpsConfig_t, autoConfig)},
    { "gps_auto_baud", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, 30, __builtin_offsetof (gpsConfig_t, autoBaud)},

    { "gps_pos_p", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 }, 14, __builtin_offsetof (pidProfile_t, P8[PIDPOS]) },
    { "gps_pos_i", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 }, 14, __builtin_offsetof (pidProfile_t, I8[PIDPOS]) },
    { "gps_pos_d", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 }, 14, __builtin_offsetof (pidProfile_t, D8[PIDPOS]) },

    { "gps_posr_p", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 }, 14, __builtin_offsetof (pidProfile_t, P8[PIDPOSR]) },
    { "gps_posr_i", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 }, 14, __builtin_offsetof (pidProfile_t, I8[PIDPOSR]) },
    { "gps_posr_d", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 }, 14, __builtin_offsetof (pidProfile_t, D8[PIDPOSR]) },

    { "gps_nav_p", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 }, 14, __builtin_offsetof (pidProfile_t, P8[PIDNAVR]) },
    { "gps_nav_i", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 }, 14, __builtin_offsetof (pidProfile_t, I8[PIDNAVR]) },
    { "gps_nav_d", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 }, 14, __builtin_offsetof (pidProfile_t, D8[PIDNAVR]) },

    { "gps_wp_radius", VAR_UINT16 | PROFILE_VALUE, .config.minmax = { 0, 2000 }, 34, __builtin_offsetof (gpsProfile_t, gps_wp_radius) },

    { "nav_controls_heading", VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, 34, __builtin_offsetof (gpsProfile_t, nav_controls_heading) },
    { "nav_speed_min", VAR_UINT16 | PROFILE_VALUE, .config.minmax = { 10, 2000 }, 34, __builtin_offsetof (gpsProfile_t, nav_speed_min) },
    { "nav_speed_max", VAR_UINT16 | PROFILE_VALUE, .config.minmax = { 10, 2000 }, 34, __builtin_offsetof (gpsProfile_t, nav_speed_max) },
    { "nav_slew_rate", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 100 }, 34, __builtin_offsetof (gpsProfile_t, nav_slew_rate) },



    { "telemetry_switch", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 31, __builtin_offsetof (telemetryConfig_t, telemetry_switch)},
    { "telemetry_inversion", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 31, __builtin_offsetof (telemetryConfig_t, telemetry_inversion)},
 { "telemetry_send_cells", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 31, __builtin_offsetof (telemetryConfig_t, telemetry_send_cells)},

    { "frsky_default_lattitude", VAR_FLOAT | MASTER_VALUE, .config.minmax = { -90.0, 90.0 } , 32, __builtin_offsetof (frskyTelemetryConfig_t, gpsNoFixLatitude)},
    { "frsky_default_longitude", VAR_FLOAT | MASTER_VALUE, .config.minmax = { -180.0, 180.0 } , 32, __builtin_offsetof (frskyTelemetryConfig_t, gpsNoFixLongitude)},
    { "frsky_coordinates_format", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, FRSKY_FORMAT_NMEA } , 32, __builtin_offsetof (frskyTelemetryConfig_t, frsky_coordinate_format)},
    { "frsky_unit", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_UNIT } , 32, __builtin_offsetof (frskyTelemetryConfig_t, frsky_unit)},
    { "frsky_vfas_precision", VAR_UINT8 | MASTER_VALUE, .config.minmax = { FRSKY_VFAS_PRECISION_LOW, FRSKY_VFAS_PRECISION_HIGH } , 32, __builtin_offsetof (frskyTelemetryConfig_t, frsky_vfas_precision)},

    { "hott_alarm_sound_interval", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, 120 } , 33, __builtin_offsetof (hottTelemetryConfig_t, hottAlarmSoundInterval)},


    { "ibus_report_cell_voltage", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 53, __builtin_offsetof (ibusTelemetryConfig_t, report_cell_voltage)},


    { "battery_capacity", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 20000 } , 11, __builtin_offsetof (batteryConfig_t, batteryCapacity)},
    { "vbat_scale", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, 255 } , 49, __builtin_offsetof (voltageMeterConfig_t, vbatscale)},
    { "vbat_max_cell_voltage", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 10, 50 } , 11, __builtin_offsetof (batteryConfig_t, vbatmaxcellvoltage)},
    { "vbat_min_cell_voltage", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 10, 50 } , 11, __builtin_offsetof (batteryConfig_t, vbatmincellvoltage)},
    { "vbat_warning_cell_voltage", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 10, 50 } , 11, __builtin_offsetof (batteryConfig_t, vbatwarningcellvoltage)},
    { "amperage_meter_scale", VAR_INT16 | MASTER_VALUE, .config.minmax = { -10000, 10000 } , 50, __builtin_offsetof (amperageMeterConfig_t, scale)},
    { "amperage_meter_offset", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 3300 } , 50, __builtin_offsetof (amperageMeterConfig_t, offset)},
    { "multiwii_amperage_meter_output", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 48, __builtin_offsetof (mspServerConfig_t, multiwiiCurrentMeterOutput)},
    { "amperage_meter_source", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_AMPERAGE_METER } , 11, __builtin_offsetof (batteryConfig_t, amperageMeterSource)},
    { "vbat_hysteresis", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, 250 } , 11, __builtin_offsetof (batteryConfig_t, vbathysteresis)},

    { "align_gyro", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_ALIGNMENT } , 8, __builtin_offsetof (sensorAlignmentConfig_t, gyro_align)},
    { "align_acc", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_ALIGNMENT } , 8, __builtin_offsetof (sensorAlignmentConfig_t, acc_align)},
    { "align_mag", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_ALIGNMENT } , 8, __builtin_offsetof (sensorAlignmentConfig_t, mag_align)},

    { "align_board_roll", VAR_INT16 | MASTER_VALUE, .config.minmax = { -180, 360 } , 2, __builtin_offsetof (boardAlignment_t, rollDegrees)},
    { "align_board_pitch", VAR_INT16 | MASTER_VALUE, .config.minmax = { -180, 360 } , 2, __builtin_offsetof (boardAlignment_t, pitchDegrees)},
    { "align_board_yaw", VAR_INT16 | MASTER_VALUE, .config.minmax = { -180, 360 } , 2, __builtin_offsetof (boardAlignment_t, yawDegrees)},

    { "small_angle", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, 180 } , 22, __builtin_offsetof (imuConfig_t, small_angle)},
    { "max_angle_inclination", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 100, 900 } , 22, __builtin_offsetof (imuConfig_t, max_angle_inclination) },
    { "pid_process_denom", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 1, 8 } , 10, __builtin_offsetof (gyroConfig_t, pid_process_denom)},
    { "gyro_sync", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, 1 } , 10, __builtin_offsetof (gyroConfig_t, gyro_sync)},
    { "gyro_sample_hz", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 1000, 8000 } , 10, __builtin_offsetof (gyroConfig_t, gyro_sample_hz)},

    { "gyro_lpf", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_GYRO_LPF } , 10, __builtin_offsetof (gyroConfig_t, gyro_lpf)},
    { "gyro_lowpass_level", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_LOWPASS_TYPE }, 10, __builtin_offsetof (gyroConfig_t, gyro_soft_type)},
    { "gyro_lowpass_hz", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 500 } , 10, __builtin_offsetof (gyroConfig_t, gyro_soft_lpf_hz)},
    { "gyro_notch_hz", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 500 } , 10, __builtin_offsetof (gyroConfig_t, gyro_soft_notch_hz)},
    { "gyro_notch_cutoff_hz", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 1, 500 } , 10, __builtin_offsetof (gyroConfig_t, gyro_soft_notch_cutoff_hz)},
    { "moron_threshold", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, 128 } , 10, __builtin_offsetof (gyroConfig_t, gyroMovementCalibrationThreshold)},
    { "imu_dcm_kp", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 20000 } , 22, __builtin_offsetof (imuConfig_t, dcm_kp)},
    { "imu_dcm_ki", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 20000 } , 22, __builtin_offsetof (imuConfig_t, dcm_ki)},

    { "alt_hold_deadband", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 1, 250 } , 25, __builtin_offsetof (rcControlsConfig_t, alt_hold_deadband)},
    { "alt_hold_fast_change", VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 25, __builtin_offsetof (rcControlsConfig_t, alt_hold_fast_change)},
    { "deadband", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 32 } , 25, __builtin_offsetof (rcControlsConfig_t, deadband)},
    { "yaw_deadband", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 100 } , 25, __builtin_offsetof (rcControlsConfig_t, yaw_deadband)},
    { "yaw_control_direction", VAR_INT8 | PROFILE_VALUE, .config.minmax = { -1, 1 } , 25, __builtin_offsetof (rcControlsConfig_t, yaw_control_direction) },
    { "3d_deadband_throttle", VAR_UINT16 | PROFILE_VALUE, .config.minmax = { 0, 2000 }, 25, __builtin_offsetof (rcControlsConfig_t, deadband3d_throttle) },

    { "throttle_correction_value", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 150 } , 39, __builtin_offsetof (throttleCorrectionConfig_t, throttle_correction_value)},
    { "throttle_correction_angle", VAR_UINT16 | PROFILE_VALUE, .config.minmax = { 1, 900 } , 39, __builtin_offsetof (throttleCorrectionConfig_t, throttle_correction_angle)},


    { "pid_at_min_throttle", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 20, __builtin_offsetof (mixerConfig_t, pid_at_min_throttle)},
    { "yaw_motor_direction", VAR_INT8 | MASTER_VALUE, .config.minmax = { -1, 1 } , 20, __builtin_offsetof (mixerConfig_t, yaw_motor_direction)},
    { "yaw_jump_prevention_limit", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 80, 500 } , 20, __builtin_offsetof (mixerConfig_t, yaw_jump_prevention_limit)},


    { "tri_unarmed_servo", VAR_INT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 20, __builtin_offsetof (mixerConfig_t, tri_unarmed_servo)},
    { "servo_lowpass_freq", VAR_FLOAT | MASTER_VALUE, .config.minmax = { 10, 400} , 20, __builtin_offsetof (mixerConfig_t, servo_lowpass_freq)},
    { "servo_lowpass_enable", VAR_INT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 20, __builtin_offsetof (mixerConfig_t, servo_lowpass_enable)},


    { "default_rate_profile", VAR_UINT8 | PROFILE_VALUE , .config.minmax = { 0, 3 - 1 } , 36, __builtin_offsetof (rateProfileSelection_t, defaultRateProfileIndex)},

    { "rc_rate", VAR_UINT8 | CONTROL_RATE_VALUE, .config.minmax = { 0, 250 } , 12, __builtin_offsetof (controlRateConfig_t, rcRate8)},
    { "rc_expo", VAR_UINT8 | CONTROL_RATE_VALUE, .config.minmax = { 0, 100 } , 12, __builtin_offsetof (controlRateConfig_t, rcExpo8)},
    { "rc_yaw_expo", VAR_UINT8 | CONTROL_RATE_VALUE, .config.minmax = { 0, 100 } , 12, __builtin_offsetof (controlRateConfig_t, rcYawExpo8)},
    { "thr_mid", VAR_UINT8 | CONTROL_RATE_VALUE, .config.minmax = { 0, 100 } , 12, __builtin_offsetof (controlRateConfig_t, thrMid8)},
    { "thr_expo", VAR_UINT8 | CONTROL_RATE_VALUE, .config.minmax = { 0, 100 } , 12, __builtin_offsetof (controlRateConfig_t, thrExpo8)},
    { "roll_rate", VAR_UINT8 | CONTROL_RATE_VALUE, .config.minmax = { 0, 100 } , 12, __builtin_offsetof (controlRateConfig_t, rates[ROLL])},
    { "pitch_rate", VAR_UINT8 | CONTROL_RATE_VALUE, .config.minmax = { 0, 100 } , 12, __builtin_offsetof (controlRateConfig_t, rates[PITCH])},
    { "yaw_rate", VAR_UINT8 | CONTROL_RATE_VALUE, .config.minmax = { 0, 255 } , 12, __builtin_offsetof (controlRateConfig_t, rates[YAW])},
    { "tpa_rate", VAR_UINT8 | CONTROL_RATE_VALUE, .config.minmax = { 0, 100} , 12, __builtin_offsetof (controlRateConfig_t, dynThrPID)},
    { "tpa_breakpoint", VAR_UINT16 | CONTROL_RATE_VALUE, .config.minmax = { 1000, 2000} , 12, __builtin_offsetof (controlRateConfig_t, tpa_breakpoint)},

    { "failsafe_delay", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, 200 } , 1, __builtin_offsetof (failsafeConfig_t, failsafe_delay)},
    { "failsafe_off_delay", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, 200 } , 1, __builtin_offsetof (failsafeConfig_t, failsafe_off_delay)},
    { "failsafe_throttle", VAR_UINT16 | MASTER_VALUE, .config.minmax = { 1000, 2000 } , 1, __builtin_offsetof (failsafeConfig_t, failsafe_throttle)},
    { "failsafe_kill_switch", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 1, __builtin_offsetof (failsafeConfig_t, failsafe_kill_switch)},
    { "failsafe_throttle_low_delay",VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 300 } , 1, __builtin_offsetof (failsafeConfig_t, failsafe_throttle_low_delay)},
    { "failsafe_procedure", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, 1 } , 1, __builtin_offsetof (failsafeConfig_t, failsafe_procedure)},


    { "gimbal_mode", VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_GIMBAL_MODE }, 3, __builtin_offsetof (gimbalConfig_t, mode)},


    { "acc_hardware", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, ACC_FAKE } , 7, __builtin_offsetof (sensorSelectionConfig_t, acc_hardware)},

    { "acc_cut_hz", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 35, __builtin_offsetof (accelerometerConfig_t, acc_cut_hz)},
    { "accxy_deadband", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 100 } , 35, __builtin_offsetof (accelerometerConfig_t, accDeadband.xy)},
    { "accz_deadband", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 100 } , 35, __builtin_offsetof (accelerometerConfig_t, accDeadband.z)},
    { "accz_lpf_cutoff", VAR_FLOAT | PROFILE_VALUE, .config.minmax = { 1, 20 } , 35, __builtin_offsetof (accelerometerConfig_t, accz_lpf_cutoff)},
    { "acc_unarmedcal", VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , 35, __builtin_offsetof (accelerometerConfig_t, acc_unarmedcal)},
    { "acc_trim_pitch", VAR_INT16 | PROFILE_VALUE, .config.minmax = { -300, 300 } , 35, __builtin_offsetof (accelerometerConfig_t, accelerometerTrims.values.pitch)},
    { "acc_trim_roll", VAR_INT16 | PROFILE_VALUE, .config.minmax = { -300, 300 } , 35, __builtin_offsetof (accelerometerConfig_t, accelerometerTrims.values.roll)},


    { "baro_tab_size", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 48 } , 38, __builtin_offsetof (barometerConfig_t, baro_sample_count)},
    { "baro_noise_lpf", VAR_FLOAT | PROFILE_VALUE, .config.minmax = { 0 , 1 } , 38, __builtin_offsetof (barometerConfig_t, baro_noise_lpf)},
    { "baro_cf_vel", VAR_FLOAT | PROFILE_VALUE, .config.minmax = { 0 , 1 } , 38, __builtin_offsetof (barometerConfig_t, baro_cf_vel)},
    { "baro_cf_alt", VAR_FLOAT | PROFILE_VALUE, .config.minmax = { 0 , 1 } , 38, __builtin_offsetof (barometerConfig_t, baro_cf_alt)},

    { "baro_hardware", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, BARO_BMP280 } , 7, __builtin_offsetof (sensorSelectionConfig_t, baro_hardware)},



    { "mag_hardware", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, MAG_AK8963 } , 7, __builtin_offsetof (sensorSelectionConfig_t, mag_hardware)},

    { "mag_declination", VAR_INT16 | PROFILE_VALUE, .config.minmax = { -18000, 18000 } , 40, __builtin_offsetof (compassConfig_t, mag_declination)},


    { "p_pitch", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, P8[FD_PITCH])},
    { "i_pitch", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, I8[FD_PITCH])},
    { "d_pitch", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, D8[FD_PITCH])},
    { "p_roll", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, P8[FD_ROLL])},
    { "i_roll", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, I8[FD_ROLL])},
    { "d_roll", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, D8[FD_ROLL])},
    { "p_yaw", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, P8[FD_YAW])},
    { "i_yaw", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, I8[FD_YAW])},
    { "d_yaw", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, D8[FD_YAW])},

    { "p_alt", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, P8[PIDALT])},
    { "i_alt", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, I8[PIDALT])},
    { "d_alt", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, D8[PIDALT])},

    { "p_level", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, P8[PIDLEVEL])},
    { "i_level", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, I8[PIDLEVEL])},
    { "d_level", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, D8[PIDLEVEL])},

    { "p_vel", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, P8[PIDVEL])},
    { "i_vel", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, I8[PIDVEL])},
    { "d_vel", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 14, __builtin_offsetof (pidProfile_t, D8[PIDVEL])},

    { "pid_delta_method", VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_PID_DELTA_METHOD }, 14, __builtin_offsetof (pidProfile_t, deltaMethod) },
    { "yaw_p_limit", VAR_UINT16 | PROFILE_VALUE, .config.minmax = { 100, 500 } , 14, __builtin_offsetof (pidProfile_t, yaw_p_limit)},
    { "yaw_lpf_hz", VAR_UINT16 | PROFILE_VALUE, .config.minmax = {0, 500 } , 14, __builtin_offsetof (pidProfile_t, yaw_lpf_hz)},
    { "dterm_lowpass_level", VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_LOWPASS_TYPE }, 14, __builtin_offsetof (pidProfile_t, dterm_filter_type)},
    { "dterm_lowpass_hz", VAR_UINT16 | PROFILE_VALUE, .config.minmax = {0, 500 } , 14, __builtin_offsetof (pidProfile_t, dterm_lpf_hz)},
    { "horizon_tilt_effect", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 250 } , 14, __builtin_offsetof (pidProfile_t, horizon_tilt_effect)},
    { "horizon_tilt_mode", VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_HORIZON_TILT_MODE }, 14, __builtin_offsetof (pidProfile_t, horizon_tilt_mode)},


    { "gtune_loP_rll", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 10, 200 } , 15, __builtin_offsetof (gtuneConfig_t, gtune_lolimP[FD_ROLL])},
    { "gtune_loP_ptch", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 10, 200 } , 15, __builtin_offsetof (gtuneConfig_t, gtune_lolimP[FD_PITCH])},
    { "gtune_loP_yw", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 10, 200 } , 15, __builtin_offsetof (gtuneConfig_t, gtune_lolimP[FD_YAW])},
    { "gtune_hiP_rll", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 15, __builtin_offsetof (gtuneConfig_t, gtune_hilimP[FD_ROLL])},
    { "gtune_hiP_ptch", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 15, __builtin_offsetof (gtuneConfig_t, gtune_hilimP[FD_PITCH])},
    { "gtune_hiP_yw", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 200 } , 15, __builtin_offsetof (gtuneConfig_t, gtune_hilimP[FD_YAW])},
    { "gtune_pwr", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 10 } , 15, __builtin_offsetof (gtuneConfig_t, gtune_pwr)},
    { "gtune_settle_time", VAR_UINT16 | PROFILE_VALUE, .config.minmax = { 200, 1000 } , 15, __builtin_offsetof (gtuneConfig_t, gtune_settle_time)},
    { "gtune_average_cycles", VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 8, 128 } , 15, __builtin_offsetof (gtuneConfig_t, gtune_average_cycles)},



    { "blackbox_rate_num", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 1, 32 } , 5, __builtin_offsetof (blackboxConfig_t, rate_num)},
    { "blackbox_rate_denom", VAR_UINT8 | MASTER_VALUE, .config.minmax = { 1, 32 } , 5, __builtin_offsetof (blackboxConfig_t, rate_denom)},
    { "blackbox_device", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_BLACKBOX_DEVICE } , 5, __builtin_offsetof (blackboxConfig_t, device)},


    { "magzero_x", VAR_INT16 | MASTER_VALUE, .config.minmax = { -32768, 32767 } , 9, __builtin_offsetof (sensorTrims_t, magZero.raw[X])},
    { "magzero_y", VAR_INT16 | MASTER_VALUE, .config.minmax = { -32768, 32767 } , 9, __builtin_offsetof (sensorTrims_t, magZero.raw[Y])},
    { "magzero_z", VAR_INT16 | MASTER_VALUE, .config.minmax = { -32768, 32767 } , 9, __builtin_offsetof (sensorTrims_t, magZero.raw[Z])},
};
...
static _Bool isEmpty(const char *string)
{
    return *string == '\0';
}
...
static void cliRxFail(char *cmdline)
{
    ...
    if (isEmpty(cmdline)) {
        ...
        if ((channel < (18))) {
            ...
            uint16_t value;
            rxFailsafeChannelType_e type = (channel < 4) ? RX_FAILSAFE_TYPE_FLIGHT : RX_FAILSAFE_TYPE_AUX;
            rxFailsafeChannelMode_e mode = failsafeChannelConfig->mode;
            _Bool requireValue = failsafeChannelConfig->mode == RX_FAILSAFE_MODE_SET;
            ...
            if (requireValue) {
                cliPrintf("rxfail %u %c %d\r\n",
                    channel,
                    modeCharacter,
                    (750 + 25 * failsafeChannelConfig->step)
                );
            } else {
...
static void cliSerialPassthrough(char *cmdline)
{
    ...
    if (!passThroughPortUsage || passThroughPortUsage->serialPort == ((void *)0)) {
        if (!baud) {
            tfp_printf("Port %d is not open, you must specify baud\r\n", id);
            return;
        }
        if (!mode)
            mode = MODE_RXTX;

        passThroughPort = openSerialPort(id, FUNCTION_PASSTHROUGH, ((void *)0),
                                         baud, mode,
                                         SERIAL_NOT_INVERTED);
        if (!passThroughPort) {
        ...
        if (mode && passThroughPort->mode != mode) {
            tfp_printf("Adjusting mode from configured value %d to %d\r\n",
                   passThroughPort->mode, mode);
            serialSetMode(passThroughPort, mode);
        }
    }

    tfp_printf("Relaying data to device on port %d, Reset your board to exit "
           "serial passthrough mode.\r\n");

    serialPassthrough(cliPort, passThroughPort, ((void *)0), ((void *)0));
}
...
static void cliAdjustmentRange(char *cmdline)
{
    ...
    if (isEmpty(cmdline)) {
        ...
        if (i < 12) {
            ...
            cliShowArgumentRangeError("index", 0, 12 - 1);
        }
    }
}
...
static void cliRxRange(char *cmdline)
{
    ...
    if (isEmpty(cmdline)) {
        ...
        do { extern const pgRegistry_t channelRanges_Registry; pgResetCurrent(&channelRanges_Registry); } while(0);
    } else {
        ptr = cmdline;
        i = atoi(ptr);
        if (i >= 0 && i < 4) {
...
static void cliModeColor(char *cmdline)
{
    if (isEmpty(cmdline)) {
        ...
        if (ptr != ((void *)0) || argNo != ARGS_COUNT) {
            cliShowParseError();
            return;
        }
...
static void cliServoMix(char *cmdline)
{
    ...
    if (len == 0) {
        ...
        ptr = strtok(ptr, " ");
        while (ptr != ((void *)0) && check < ARGS_COUNT - 1) {
            args[check++] = atoi(ptr);
            ptr = strtok(((void *)0), " ");
        }

        if (ptr == ((void *)0) || check != ARGS_COUNT - 1) {
            cliShowParseError();
            return;
        }
        ...
        ptr = strtok(cmdline, " ");
        while (ptr != ((void *)0) && check < ARGS_COUNT) {
            args[check++] = atoi(ptr);
            ptr = strtok(((void *)0), " ");
        }

        if (ptr != ((void *)0) || check != ARGS_COUNT) {
            cliShowParseError();
            return;
        }
...
# 1841 "./src/main/io/serial_cli.c"
static void dumpValues(uint16_t valueSection)
{
    uint32_t i;
    const clivalue_t *value;
    for (i = 0; i < (sizeof(valueTable) / sizeof((valueTable)[0])); i++) {
        value = &valueTable[i];
...
static void cliDump(char *cmdline)
{
    ...
    uint8_t dumpMask = (DUMP_MASTER | DUMP_PROFILE | DUMP_CONTROL_RATE_PROFILE);
...
static void cliHelp(char *cmdline)
{
    ...
    for (i = 0; i < (sizeof(cmdTable) / sizeof(clicmd_t)); i++) {
...
static void cliMap(char *cmdline)
{
    ...
    if (len == 8) {
        ...
        for (i = 0; i < 8; i++)
            cmdline[i] = __extension__ ({ __typeof__ ((unsigned char)cmdline[i]) __x = ((unsigned char)cmdline[i]); ((((__ctype_ptr__+sizeof(""[__x]))[(int)(__x)])&(01|02))==02) ? (int) __x - 'a' + 'A' : (int) __x;});
        for (i = 0; i < 8; i++) {
...
static void cliPrintVar(const clivalue_t *var, uint32_t full)
{
    ...
    switch (var->type & (0x0F)) {
        ...
        case VAR_FLOAT:
            ...
            if (full && (var->type & (0xC0)) == MODE_DIRECT) {
...
static void cliSet(char *cmdline)
{
    ...
    } else if ((eqptr = strstr(cmdline, "=")) != ((void *)0)) {
                ...
                switch (valueTable[i].type & (0xC0)) {
                    case MODE_DIRECT: {
                            ...
                            if (valuef >= valueTable[i].config.minmax.min && valuef <= valueTable[i].config.minmax.max) {
                                ...
                                if ((valueTable[i].type & (0x0F)) == VAR_FLOAT)
...
static void cliStatus(char *cmdline)
{
    ...
    for (i = 0; ; i++) {
        ...
        if (sensorTypeNames[i] == ((void *)0))
            break;

        mask = (1 << i);
        if ((detectedSensorsMask & mask) && (mask & (SENSOR_GYRO | SENSOR_ACC | SENSOR_BARO | SENSOR_MAG))) {
    ...
    cliPrintf("PIDd: %d, GYROd: %d, I2C Errors: %d, registry size: %d\r\n", pidDeltaUs, gyroDeltaUs, i2cErrorCounter, (__pg_registry_end - __pg_registry_start));
}
...
void cliProcess(void)
{
    ...
    while (serialRxBytesWaiting(cliPort)) {
        ...
        if (c == '\t' || c == '?') {
            ...
            const clicmd_t *cmd, *pstart = ((void *)0), *pend = ((void *)0);
            uint32_t i = bufferIndex;
            for (cmd = cmdTable; cmd < cmdTable + (sizeof(cmdTable) / sizeof(clicmd_t)); cmd++) {
            ...
            if (bufferIndex > 0) {
                ...
                for (cmd = cmdTable; cmd < cmdTable + (sizeof(cmdTable) / sizeof(clicmd_t)); cmd++) {
                    if(!strncasecmp(cliBuffer, cmd->name, strlen(cmd->name))
                       && !(((__ctype_ptr__+sizeof(""[(unsigned)cliBuffer[strlen(cmd->name)]]))[(int)((unsigned)cliBuffer[strlen(cmd->name)])])&(01|02|04)))
                        break;
                }
                if(cmd < cmdTable + (sizeof(cmdTable) / sizeof(clicmd_t)))
