...
# 1 "C:\\cygwin64\\home\\Charles\\robuc_cleanflight//"
# 1 "<built-in>"
#define __STDC__ 1
...
# 1 "./src/main/scheduler.h" 1
# 18 "./src/main/scheduler.h"
...
void setTaskEnabled(cfTaskId_e taskId, _Bool newEnabledState);
...
# 29 "./src/main/io/serial_cli.c" 2

# 1 "./src/main/build_config.h" 1
# 18 "./src/main/build_config.h"
...
typedef _Bool (*sensorIsDataReadyFuncPtr)(void);
...
struct serialPortVTable {
    ...
    _Bool (*isSerialTransmitBufferEmpty)(serialPort_t *instance);
...
# 1 "./src/main/io/escservo.h" 1
# 18 "./src/main/io/escservo.h"
...
# 21 "./src/main/io/rc_controls.h" 2
...
#define LED_DIRECTION_MASK ( LED_DIRECTION_NORTH | LED_DIRECTION_EAST | LED_DIRECTION_SOUTH | LED_DIRECTION_WEST | LED_DIRECTION_UP | LED_DIRECTION_DOWN )
...
#define LED_FUNCTION_MASK ( LED_FUNCTION_INDICATOR | LED_FUNCTION_WARNING | LED_FUNCTION_FLIGHT_MODE | LED_FUNCTION_ARM_STATE | LED_FUNCTION_THROTTLE | LED_FUNCTION_THRUST_RING | LED_FUNCTION_COLOR )
# 75 "./src/main/io/ledstrip.h"
...
_Bool parseLedStripConfig(uint8_t ledIndex, const char *config);
...
_Bool parseColor(uint8_t index, const char *colorConfig);
...
_Bool spektrumInit(rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback);
...
typedef struct mixerConfig_s {
    ...
    uint8_t airmode_saturation_limit;
...
# 27 "./src/main/telemetry/telemetry.h"
...
# 1 "./src/main/config/config_profile.h" 1
# 18 "./src/main/config/config_profile.h"
...
# 1 "./src/main/config/config_master.h" 1
# 18 "./src/main/config/config_master.h"
...
typedef struct master_t {
    ...
    motorMixer_t customMotorMixer[12];

    servoMixer_t customServoMixer[(2 * 8)];
    ...
    controlRateConfig_t controlRateProfiles[3];
...
static const char * const featureNames[] = {
    ...
    "BLACKBOX", "CHANNEL_FORWARDING", "TRANSPONDER", ((void *)0)
};
...
const clicmd_t cmdTable[] = {
    ...
    { "dump" , "dump configuration" , "[master|profile]" , cliDump }
                                    ,
...
const clivalue_t valueTable[] = {
    ...
    { "min_check", VAR_UINT16 | MASTER_VALUE, &masterConfig.rxConfig.mincheck, .config.minmax = { 0, 2000 } },
    { "max_check", VAR_UINT16 | MASTER_VALUE, &masterConfig.rxConfig.maxcheck, .config.minmax = { 0, 2000 } },
    { "rssi_channel", VAR_INT8 | MASTER_VALUE, &masterConfig.rxConfig.rssi_channel, .config.minmax = { 0, (18) } },
    { "rssi_scale", VAR_UINT8 | MASTER_VALUE, &masterConfig.rxConfig.rssi_scale, .config.minmax = { 1, 255 } },
    ...
    { "min_throttle", VAR_UINT16 | MASTER_VALUE, &masterConfig.escAndServoConfig.minthrottle, .config.minmax = { 0, 2000 } },
    { "max_throttle", VAR_UINT16 | MASTER_VALUE, &masterConfig.escAndServoConfig.maxthrottle, .config.minmax = { 0, 2000 } },
    { "min_command", VAR_UINT16 | MASTER_VALUE, &masterConfig.escAndServoConfig.mincommand, .config.minmax = { 0, 2000 } },
    { "servo_center_pulse", VAR_UINT16 | MASTER_VALUE, &masterConfig.escAndServoConfig.servoCenterPulse, .config.minmax = { 0, 2000 } },

    { "3d_deadband_low", VAR_UINT16 | MASTER_VALUE, &masterConfig.flight3DConfig.deadband3d_low, .config.minmax = { 0, 2000 } },
    { "3d_deadband_high", VAR_UINT16 | MASTER_VALUE, &masterConfig.flight3DConfig.deadband3d_high, .config.minmax = { 0, 2000 } },
    { "3d_neutral", VAR_UINT16 | MASTER_VALUE, &masterConfig.flight3DConfig.neutral3d, .config.minmax = { 0, 2000 } },
    { "3d_deadband_throttle", VAR_UINT16 | MASTER_VALUE, &masterConfig.flight3DConfig.deadband3d_throttle, .config.minmax = { 0, 2000 } },
    ...
    { "spektrum_sat_bind", VAR_UINT8 | MASTER_VALUE, &masterConfig.rxConfig.spektrum_sat_bind, .config.minmax = { 0, 10} },
    ...
    { "vbat_scale", VAR_UINT8 | MASTER_VALUE, &masterConfig.batteryConfig.vbatscale, .config.minmax = { 0, 255 } },
    ...
    { "yaw_jump_prevention_limit", VAR_UINT16 | MASTER_VALUE, &masterConfig.mixerConfig.yaw_jump_prevention_limit, .config.minmax = { 80, 500 } },
    ...
    { "default_rate_profile", VAR_UINT8 | PROFILE_VALUE , &masterConfig.profile[0].defaultRateProfileIndex, .config.minmax = { 0, 3 - 1 } },
    ...
    { "roll_rate", VAR_UINT8 | CONTROL_RATE_VALUE, &masterConfig.controlRateProfiles[0].rates[FD_ROLL], .config.minmax = { 0, 100 } },
    { "pitch_rate", VAR_UINT8 | CONTROL_RATE_VALUE, &masterConfig.controlRateProfiles[0].rates[FD_PITCH], .config.minmax = { 0, 100 } },
    { "yaw_rate", VAR_UINT8 | CONTROL_RATE_VALUE, &masterConfig.controlRateProfiles[0].rates[FD_YAW], .config.minmax = { 0, 255 } },
    { "tpa_rate", VAR_UINT8 | CONTROL_RATE_VALUE, &masterConfig.controlRateProfiles[0].dynThrPID, .config.minmax = { 0, 100} },
    { "tpa_breakpoint", VAR_UINT16 | CONTROL_RATE_VALUE, &masterConfig.controlRateProfiles[0].tpa_breakpoint, .config.minmax = { 1000, 2000} },
    ...
    { "failsafe_throttle", VAR_UINT16 | MASTER_VALUE, &masterConfig.failsafeConfig.failsafe_throttle, .config.minmax = { 1000, 2000 } },
    ...
    { "rx_min_usec", VAR_UINT16 | MASTER_VALUE, &masterConfig.rxConfig.rx_min_usec, .config.minmax = { 750, 2250 } },
    { "rx_max_usec", VAR_UINT16 | MASTER_VALUE, &masterConfig.rxConfig.rx_max_usec, .config.minmax = { 750, 2250 } },


    { "gimbal_mode", VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, &masterConfig.profile[0].gimbalConfig.mode, .config.lookup = { TABLE_GIMBAL_MODE } },


    { "acc_hardware", VAR_UINT8 | MASTER_VALUE, &masterConfig.acc_hardware, .config.minmax = { 0, ACC_FAKE } },
    ...
    { "baro_tab_size", VAR_UINT8 | PROFILE_VALUE, &masterConfig.profile[0].barometerConfig.baro_sample_count, .config.minmax = { 0, 48 } },
    ...
    { "baro_hardware", VAR_UINT8 | MASTER_VALUE, &masterConfig.baro_hardware, .config.minmax = { 0, BARO_BMP280 } },



    { "mag_hardware", VAR_UINT8 | MASTER_VALUE, &masterConfig.mag_hardware, .config.minmax = { 0, MAG_AK8975 } },
    ...
    { "yaw_p_limit", VAR_UINT16 | PROFILE_VALUE, &masterConfig.profile[0].pidProfile.yaw_p_limit, .config.minmax = { 100, 500 } },
...
static void cliRxFail(char *cmdline)
{
    ...
    if (isEmpty(cmdline)) {
        ...
        if ((channel < (18))) {
            ...
            _Bool requireValue = channelFailsafeConfiguration->mode == RX_FAILSAFE_MODE_SET;
            ...
            if (requireValue) {
                cliPrintf("rxfail %u %c %d\r\n",
                    channel,
                    modeCharacter,
                    (750 + 25 * channelFailsafeConfiguration->step)
                );
            } else {
...
# 1642 "./src/main/io/serial_cli.c"
static void dumpValues(uint16_t valueSection)
{
    uint32_t i;
    const clivalue_t *value;
    for (i = 0; i < (sizeof(valueTable) / sizeof(clivalue_t)); i++) {
        value = &valueTable[i];
...
static void cliPlaySound(char *cmdline)
{
    ...
    if (isEmpty(cmdline)) {
        i = lastSoundIdx + 1;
        if ((name=beeperNameForTableIndex(i)) == ((void *)0)) {
            while (1) {
...
static void cliPrintVar(const clivalue_t *var, uint32_t full)
{
    ...
    void *ptr = var->ptr;
    if ((var->type & (0x30)) == PROFILE_VALUE) {
        ptr = ((uint8_t *)ptr) + (sizeof(profile_t) * masterConfig.current_profile_index);
    }
    if ((var->type & (0x30)) == CONTROL_RATE_VALUE) {
