...
# 31 "./src/main/io/servos.c" 2


extern const servoConfig_t pgResetTemplate_servoConfig; servoConfig_t servoConfig_System; extern const pgRegistry_t servoConfig_Registry; const pgRegistry_t servoConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 52 | (0 << 12), .size = sizeof(servoConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&servoConfig_System, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_servoConfig}, };

const servoConfig_t pgResetTemplate_servoConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .servoCenterPulse = 1500, .servo_pwm_rate = 50, }
