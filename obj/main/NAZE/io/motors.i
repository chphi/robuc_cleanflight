...
extern const motorConfig_t pgResetTemplate_motorConfig; motorConfig_t motorConfig_System; extern const pgRegistry_t motorConfig_Registry; const pgRegistry_t motorConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 6 | (1 << 12), .size = sizeof(motorConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&motorConfig_System, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_motorConfig}, };

const motorConfig_t pgResetTemplate_motorConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .minthrottle = 1150, .maxthrottle = 1850, .mincommand = 1000, .reserved1 = 0, .motor_pwm_rate = 400, .reserved2 = 0, }
