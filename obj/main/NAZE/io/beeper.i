...
static uint8_t beep_multiBeeps[20 + 2];
...
static const beeperTableEntry_t beeperTable[] = {
    ...
    { BEEPER_RX_LOST_LANDING,1,beep_sos,"RX_LOST_LANDING" },
    ...
    { BEEPER_GPS_STATUS,8,beep_multiBeeps,((void *)0) },
    ...
    { BEEPER_MULTI_BEEPS,13,beep_multiBeeps,((void *)0) },
    { BEEPER_DISARM_REPEAT,14,beep_disarmRepeatBeep,"DISARM_REPEAT" },
    { BEEPER_ARMED,15,beep_armedBeep,"ARMED" },
};

static const beeperTableEntry_t *currentBeeperEntry = ((void *)0);
...
void beeper(beeperMode_e mode)
{
    ...
    const beeperTableEntry_t *selectedCandidate = ((void *)0);
...
void beeperUpdate(void)
{
    ...
    if (((1 << (BOXBEEPERON)) & rcModeActivationMask)) {
...
const char *beeperNameForTableIndex(int idx)
{
    ...
    return (idx >= 0 && idx < (int)(sizeof(beeperTable) / sizeof(beeperTableEntry_t))) ? beeperTable[idx].name : ((void *)0);
