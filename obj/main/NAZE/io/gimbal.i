...
# 31 "./src/main/io/gimbal.c" 2



static gimbalConfig_t gimbalConfig_Storage[3]; gimbalConfig_t *gimbalConfig_ProfileCurrent; extern const pgRegistry_t gimbalConfig_Registry; const pgRegistry_t gimbalConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 3 | (0 << 12), .size = sizeof(gimbalConfig_t) | PGR_SIZE_PROFILE_FLAG, .address = (uint8_t*)&gimbalConfig_Storage, .ptr = (uint8_t **)&gimbalConfig_ProfileCurrent, .reset = {.ptr = 0}, };
