...
# 19 "./src/main/msp/msp_server.c" 2
...
# 20 "./src/main/msp/msp_server.c" 2
...
# 22 "./src/main/msp/msp_server.c" 2
...
# 23 "./src/main/msp/msp_server.c" 2
...
# 25 "./src/main/msp/msp_server.c" 2
...
# 26 "./src/main/msp/msp_server.c" 2
...
# 28 "./src/main/msp/msp_server.c" 2

mspServerConfig_t mspServerConfig_System; extern const pgRegistry_t mspServerConfig_Registry; const pgRegistry_t mspServerConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 48 | (0 << 12), .size = sizeof(mspServerConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&mspServerConfig_System, .ptr = 0, .reset = {.ptr = 0}, };
