...
# 22 "./src/main/blackbox/blackbox_io.c" 2
...
# 24 "./src/main/blackbox/blackbox_io.c" 2
...
# 46 "./src/main/blackbox/blackbox_io.c" 2
...
# 85 "./src/main/blackbox/blackbox_io.c"
void blackboxWrite(uint8_t value)
{
...
int blackboxPrint(const char *s)
{
    ...
    switch (blackboxConfig()->device) {
        ...
        break;
# 175 "./src/main/blackbox/blackbox_io.c"
        case BLACKBOX_DEVICE_SERIAL:
        default:
            pos = (uint8_t*) s;
            while (*pos) {
...
# 268 "./src/main/blackbox/blackbox_io.c"
    ...
    switch (selector) {
        ...
        break;
        case BITS_32:
# 310 "./src/main/blackbox/blackbox_io.c"
            selector2 = 0;
...
# 544 "./src/main/blackbox/blackbox_io.c"
        default:
            return 0;
    }
}
        ...
        case BLACKBOX_DEVICE_SERIAL:
            {
                ...
                blackboxPort = openSerialPort(portConfig->identifier, FUNCTION_BLACKBOX, ((void *)0), baudRates[baudRateIndex],
                    MODE_TX, portOptions);
# 591 "./src/main/blackbox/blackbox_io.c"
        ...
        case BLACKBOX_DEVICE_FLASH:
            ...
            return 1;
        break;
# 618 "./src/main/blackbox/blackbox_io.c"
        default:
            return 0;
    }
}
...
# 782 "./src/main/blackbox/blackbox_io.c"
_Bool blackboxDeviceBeginLog(void)
{
    switch (blackboxConfig()->device) {
...
# 802 "./src/main/blackbox/blackbox_io.c"
_Bool blackboxDeviceEndLog(_Bool retainLog)
{
    ...
    switch (blackboxConfig()->device) {
# 823 "./src/main/blackbox/blackbox_io.c"
        default:
            return 1;
    }
}
...
# 896 "./src/main/blackbox/blackbox_io.c"
blackboxBufferReserveStatus_e blackboxDeviceReserveBufferSpace(int32_t bytes)
{
    ...
    switch (blackboxConfig()->device) {
        ...
        case BLACKBOX_DEVICE_FLASH:
            ...
            return BLACKBOX_RESERVE_TEMPORARY_FAILURE;
# 939 "./src/main/blackbox/blackbox_io.c"
        default:
            return BLACKBOX_RESERVE_PERMANENT_FAILURE;
    }
}
