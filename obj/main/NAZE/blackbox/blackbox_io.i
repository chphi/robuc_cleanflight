...
# 1 "./src/main/blackbox/blackbox_io.c"
# 18 "./src/main/blackbox/blackbox_io.c"
...
# 21 "./src/main/blackbox/blackbox_io.h" 2
...
# 22 "./src/main/blackbox/blackbox_io.h" 2
...
# 24 "./src/main/blackbox/blackbox_io.h" 2
...
_Bool blackboxDeviceFlushForce(void);
_Bool blackboxDeviceOpen(void);
void blackboxDeviceClose(void);

_Bool blackboxDeviceBeginLog(void);
_Bool blackboxDeviceEndLog(_Bool retainLog);

_Bool isBlackboxDeviceFull(void);
...
# 25 "./src/main/blackbox/blackbox_io.c" 2
...
# 26 "./src/main/blackbox/blackbox_io.c" 2
...
# 28 "./src/main/blackbox/blackbox_io.c" 2
...
# 29 "./src/main/blackbox/blackbox_io.c" 2
...
# 30 "./src/main/blackbox/blackbox_io.c" 2
...
# 31 "./src/main/blackbox/blackbox_io.c" 2
...
# 33 "./src/main/blackbox/blackbox_io.c" 2
...
# 34 "./src/main/blackbox/blackbox_io.c" 2
...
# 35 "./src/main/blackbox/blackbox_io.c" 2
...
# 36 "./src/main/blackbox/blackbox_io.c" 2
...
# 37 "./src/main/blackbox/blackbox_io.c" 2
...
# 38 "./src/main/blackbox/blackbox_io.c" 2
...
# 39 "./src/main/blackbox/blackbox_io.c" 2
...
# 40 "./src/main/blackbox/blackbox_io.c" 2
...
# 37 "./src/main/drivers/light_led.h"
...
void ledInit(void);
# 41 "./src/main/blackbox/blackbox_io.c" 2
...
# 42 "./src/main/blackbox/blackbox_io.c" 2
...
# 43 "./src/main/blackbox/blackbox_io.c" 2
...
# 45 "./src/main/blackbox/blackbox_io.c" 2
...
# 47 "./src/main/blackbox/blackbox_io.c" 2
...
# 48 "./src/main/blackbox/blackbox_io.c" 2
...
# 49 "./src/main/blackbox/blackbox_io.c" 2
...
# 50 "./src/main/blackbox/blackbox_io.c" 2
...
# 51 "./src/main/blackbox/blackbox_io.c" 2
...
# 52 "./src/main/blackbox/blackbox_io.c" 2
...
# 54 "./src/main/blackbox/blackbox_io.c" 2
...
# 55 "./src/main/blackbox/blackbox_io.c" 2
...
# 56 "./src/main/blackbox/blackbox_io.c" 2
...
# 58 "./src/main/blackbox/blackbox_io.c" 2
...
# 59 "./src/main/blackbox/blackbox_io.c" 2
...
# 60 "./src/main/blackbox/blackbox_io.c" 2
...
# 61 "./src/main/blackbox/blackbox_io.c" 2
...
# 62 "./src/main/blackbox/blackbox_io.c" 2
...
# 63 "./src/main/blackbox/blackbox_io.c" 2
...
# 64 "./src/main/blackbox/blackbox_io.c" 2
...
# 65 "./src/main/blackbox/blackbox_io.c" 2
...
# 66 "./src/main/blackbox/blackbox_io.c" 2
...
# 67 "./src/main/blackbox/blackbox_io.c" 2
...
# 69 "./src/main/blackbox/blackbox_io.c" 2
# 1 "./src/main/flight/altitudehold.h" 1
# 20 "./src/main/flight/altitudehold.h"
...
# 21 "./src/main/flight/altitudehold.h" 2
...
# 70 "./src/main/blackbox/blackbox_io.c" 2
...
# 71 "./src/main/blackbox/blackbox_io.c" 2
...
# 72 "./src/main/blackbox/blackbox_io.c" 2
...
# 73 "./src/main/blackbox/blackbox_io.c" 2
...
void mwDisarm(void);
# 75 "./src/main/blackbox/blackbox_io.c" 2
...
# 76 "./src/main/blackbox/blackbox_io.c" 2
...
# 77 "./src/main/blackbox/blackbox_io.c" 2
...
# 78 "./src/main/blackbox/blackbox_io.c" 2
...
_Bool flashfsIsEOF();
# 80 "./src/main/blackbox/blackbox_io.c" 2
...
# 81 "./src/main/blackbox/blackbox_io.c" 2
...
static serialPort_t *blackboxPort = ((void *)0);
static portSharing_e blackboxPortSharing;
# 115 "./src/main/blackbox/blackbox_io.c"
void blackboxWrite(uint8_t value)
{
...
{
    return tfp_format(((void *)0), _putc, fmt, va);
}
...
int blackboxPrint(const char *s)
{
    ...
    switch (masterConfig.blackbox_device) {
        ...
        case BLACKBOX_DEVICE_FLASH:
            length = strlen(s);
            flashfsWrite((const uint8_t*) s, length, 0);
        break;
...
# 297 "./src/main/blackbox/blackbox_io.c"
    ...
    switch (selector) {
        ...
        break;
        case BITS_32:
# 339 "./src/main/blackbox/blackbox_io.c"
            selector2 = 0;
...
# 572 "./src/main/blackbox/blackbox_io.c"
        default:
            return 0;
    }
}
        ...
        case BLACKBOX_DEVICE_SERIAL:
            {
                ...
                blackboxPort = openSerialPort(portConfig->identifier, FUNCTION_BLACKBOX, ((void *)0), baudRates[baudRateIndex],
                    MODE_TX, portOptions);
# 619 "./src/main/blackbox/blackbox_io.c"
                blackboxMaxHeaderBytesPerIteration = constrain((targetLooptime * 3) / 500, 1, 64);

                return blackboxPort != ((void *)0);
            }
            break;
        ...
        case BLACKBOX_DEVICE_FLASH:
            ...
            return 1;
        break;
# 646 "./src/main/blackbox/blackbox_io.c"
        default:
            return 0;
    }
}
...
# 810 "./src/main/blackbox/blackbox_io.c"
_Bool blackboxDeviceBeginLog(void)
{
    switch (masterConfig.blackbox_device) {
...
# 830 "./src/main/blackbox/blackbox_io.c"
_Bool blackboxDeviceEndLog(_Bool retainLog)
{
    ...
    switch (masterConfig.blackbox_device) {
# 851 "./src/main/blackbox/blackbox_io.c"
        default:
            return 1;
    }
}
...
void blackboxReplenishHeaderBudget()
{
    ...
    blackboxHeaderBudget = ((((freeSpace) < (blackboxHeaderBudget + blackboxMaxHeaderBytesPerIteration) ? (freeSpace) : (blackboxHeaderBudget + blackboxMaxHeaderBytesPerIteration))) < (256) ? (((freeSpace) < (blackboxHeaderBudget + blackboxMaxHeaderBytesPerIteration) ? (freeSpace) : (blackboxHeaderBudget + blackboxMaxHeaderBytesPerIteration))) : (256));
}
# 924 "./src/main/blackbox/blackbox_io.c"
blackboxBufferReserveStatus_e blackboxDeviceReserveBufferSpace(int32_t bytes)
{
    ...
    switch (masterConfig.blackbox_device) {
        ...
        case BLACKBOX_DEVICE_FLASH:
            ...
            return BLACKBOX_RESERVE_TEMPORARY_FAILURE;
# 967 "./src/main/blackbox/blackbox_io.c"
        default:
            return BLACKBOX_RESERVE_PERMANENT_FAILURE;
    }
}
