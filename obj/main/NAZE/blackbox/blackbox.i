...
# 23 "./src/main/blackbox/blackbox.c" 2
...
# 32 "./src/main/blackbox/blackbox.c" 2
...
# 35 "./src/main/blackbox/blackbox.c" 2
...
#define RESET_CONFIG(_type,_name,...) static const _type __UNIQL(_reset_template_) = { __VA_ARGS__ }; memcpy((_name), &__UNIQL(_reset_template_), sizeof(*(_name)));
...
#define RESET_CONFIG_2(_type,_name,...) *(_name) = (_type) { __VA_ARGS__ };
...
# 42 "./src/main/blackbox/blackbox.c" 2
...
# 44 "./src/main/blackbox/blackbox.c" 2
...
# 48 "./src/main/blackbox/blackbox.c" 2
...
# 74 "./src/main/blackbox/blackbox.c" 2
...
void mwDisarm(void);
# 76 "./src/main/blackbox/blackbox.c" 2
...
# 77 "./src/main/blackbox/blackbox.c" 2
...
# 79 "./src/main/blackbox/blackbox.c" 2
...
# 80 "./src/main/blackbox/blackbox.c" 2
...
extern const blackboxConfig_t pgResetTemplate_blackboxConfig; blackboxConfig_t blackboxConfig_System; extern const pgRegistry_t blackboxConfig_Registry; const pgRegistry_t blackboxConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 5 | (0 << 12), .size = sizeof(blackboxConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&blackboxConfig_System, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_blackboxConfig}, };

const blackboxConfig_t pgResetTemplate_blackboxConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .device = BLACKBOX_DEVICE_SERIAL, .rate_num = 1, .rate_denom = 1, }
...
static const blackboxDeltaFieldDefinition_t blackboxMainFields[] = {
    ...
    {"amperageLatest",-1, FLIGHT_LOG_FIELD_SIGNED, .Ipredict = FLIGHT_LOG_FIELD_PREDICTOR_0, .Iencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, .Ppredict = FLIGHT_LOG_FIELD_PREDICTOR_PREVIOUS, .Pencode = FLIGHT_LOG_FIELD_ENCODING_TAG8_8SVB, FLIGHT_LOG_FIELD_CONDITION_AMPERAGE},
    ...
    {"sonarRaw", -1, FLIGHT_LOG_FIELD_SIGNED, .Ipredict = FLIGHT_LOG_FIELD_PREDICTOR_0, .Iencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, .Ppredict = FLIGHT_LOG_FIELD_PREDICTOR_PREVIOUS, .Pencode = FLIGHT_LOG_FIELD_ENCODING_TAG8_8SVB, FLIGHT_LOG_FIELD_CONDITION_SONAR},
    ...
    {"accSmooth", 0, FLIGHT_LOG_FIELD_SIGNED, .Ipredict = FLIGHT_LOG_FIELD_PREDICTOR_0, .Iencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, .Ppredict = FLIGHT_LOG_FIELD_PREDICTOR_AVERAGE_2, .Pencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, FLIGHT_LOG_FIELD_CONDITION_ALWAYS},
    {"accSmooth", 1, FLIGHT_LOG_FIELD_SIGNED, .Ipredict = FLIGHT_LOG_FIELD_PREDICTOR_0, .Iencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, .Ppredict = FLIGHT_LOG_FIELD_PREDICTOR_AVERAGE_2, .Pencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, FLIGHT_LOG_FIELD_CONDITION_ALWAYS},
    {"accSmooth", 2, FLIGHT_LOG_FIELD_SIGNED, .Ipredict = FLIGHT_LOG_FIELD_PREDICTOR_0, .Iencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, .Ppredict = FLIGHT_LOG_FIELD_PREDICTOR_AVERAGE_2, .Pencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, FLIGHT_LOG_FIELD_CONDITION_ALWAYS},

    {"motor", 0, FLIGHT_LOG_FIELD_UNSIGNED, .Ipredict = FLIGHT_LOG_FIELD_PREDICTOR_MINTHROTTLE, .Iencode = FLIGHT_LOG_FIELD_ENCODING_UNSIGNED_VB, .Ppredict = FLIGHT_LOG_FIELD_PREDICTOR_AVERAGE_2, .Pencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, FLIGHT_LOG_FIELD_CONDITION_AT_LEAST_MOTORS_1},
...
typedef struct blackboxSlowState_s {
    ...
    _Bool rxSignalReceived;
    _Bool rxFlightChannelsValid;
...
typedef char assert_failed_too_many_flight_log_conditions [((sizeof(blackboxConditionCache) * 8) >= FLIGHT_LOG_FIELD_CONDITION_NEVER) ? 1 : -1 ];

static uint32_t blackboxIteration;
static uint16_t blackboxPFrameIndex, blackboxIFrameIndex;
static uint16_t blackboxSlowFrameIterationTimer;
static _Bool blackboxLoggedAnyFrames;
...
static _Bool blackboxModeActivationConditionPresent = 0;
...
static _Bool blackboxIsOnlyLoggingIntraframes()
{
    return blackboxConfig()->rate_num == 1 && blackboxConfig()->rate_denom == 32;
}

static _Bool testBlackboxConditionUncached(FlightLogFieldCondition condition)
{
    switch (condition) {
...
static _Bool testBlackboxCondition(FlightLogFieldCondition condition)
{
...
static void blackboxSetState(BlackboxState newState)
{
    ...
    switch (newState) {
        ...
        case BLACKBOX_STATE_RUNNING:
            blackboxSlowFrameIterationTimer = 4096;
        break;
...
static void writeInterframe(void)
{
    ...
    blackboxWriteMainStateArrayUsingAveragePredictor(__builtin_offsetof (blackboxMainState_t, gyroADC), 3);
    blackboxWriteMainStateArrayUsingAveragePredictor(__builtin_offsetof (blackboxMainState_t, accSmooth), 3);
    blackboxWriteMainStateArrayUsingAveragePredictor(__builtin_offsetof (blackboxMainState_t, motor), motorCount);
...
static void writeSlowFrameIfNeeded(_Bool allowPeriodicWrite)
{

    _Bool shouldWrite = allowPeriodicWrite && blackboxSlowFrameIterationTimer >= 4096;
...
void startBlackbox(void)
{
    if (blackboxState == BLACKBOX_STATE_STOPPED) {
        ...
        vbatReference = getLatestVoltageForADCChannel(ADC_CHANNEL1);
# 855 "./src/main/blackbox/blackbox.c"
...
void finishBlackbox(void)
{
    switch (blackboxState) {
        ...
        case BLACKBOX_STATE_PAUSED:
            blackboxLogEvent(FLIGHT_LOG_EVENT_LOG_END, ((void *)0));
...
static void loadMainState(void)
{
    ...
    blackboxCurrent->vbatLatest = getLatestVoltageForADCChannel(ADC_CHANNEL1);
...
# 1019 "./src/main/blackbox/blackbox.c"
static _Bool sendFieldDefinition(char mainFrameChar, char deltaFrameChar, const void *fieldDefinitions,
...
static _Bool blackboxWriteSysinfo()
{
    ...
    switch (xmitState.headerIndex) {
        ...
        break;
        case 4:
            blackboxPrintfHeaderLine("Device UID:0x%x%x%x", (*(uint32_t*)0x1FFFF7E8), (*(uint32_t*)0x1FFFF7EC), (*(uint32_t*)0x1FFFF7F0));
        break;
        case 5:
        ...
        case 10:
            if (testBlackboxCondition(FLIGHT_LOG_FIELD_CONDITION_VBAT)) {
                voltageMeterConfig_t *config = getVoltageMeterConfig(ADC_CHANNEL1);
...
static _Bool blackboxShouldLogPFrame(uint32_t pFrameIndex)
{
...
static _Bool blackboxShouldLogIFrame()
{
    ...
    if (blackboxShouldLogIFrame()) {
        ...
        if (feature(FEATURE_GPS)) {
            ...
            if (GPS_home[0] != gpsHistory.GPS_home[0] || GPS_home[1] != gpsHistory.GPS_home[1]
                || (blackboxPFrameIndex == 32 / 2 && blackboxIFrameIndex % 128 == 0)) {
...
void handleBlackbox(void)
{
    ...
    if (blackboxState >= BLACKBOX_STATE_SEND_HEADER && blackboxState <= BLACKBOX_STATE_SEND_SYSINFO) {
    ...
    switch (blackboxState) {
        ...
        case BLACKBOX_STATE_SEND_HEADER:
            ...
            if (millis() > xmitState.u.startTime + 100) {
                if (blackboxDeviceReserveBufferSpace(64) == BLACKBOX_RESERVE_SUCCESS) {
                    for (i = 0; i < 64 && blackboxHeader[xmitState.headerIndex] != '\0'; i++, xmitState.headerIndex++) {
        ...
        break;
        case BLACKBOX_STATE_SHUTTING_DOWN:
# 1462 "./src/main/blackbox/blackbox.c"
...
static _Bool canUseBlackboxWithCurrentConfiguration(void)
{
