...
# 22 "./src/main/config/feature.c" 2
...
# 24 "./src/main/config/feature.c" 2
...
featureConfig_t featureConfig_System; extern const pgRegistry_t featureConfig_Registry; const pgRegistry_t featureConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 19 | (0 << 12), .size = sizeof(featureConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&featureConfig_System, .ptr = 0, .reset = {.ptr = 0}, };
