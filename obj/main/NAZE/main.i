...
_Bool isSoftSerialTransmitBufferEmpty(serialPort_t *s);
# 42 "./src/main/main.c" 2
...
_Bool isUartTransmitBufferEmpty(serialPort_t *s);
# 43 "./src/main/main.c" 2
...
void serialInit(serialConfig_t *initialSerialConfig, _Bool softserialEnabled);
...
void flashLedsAndBeep(void)
{
    ...
    digitalHi(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), Pin_3);
    for (uint8_t i = 0; i < 10; i++) {
        digitalToggle(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), Pin_4);
        digitalToggle(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), Pin_3);
        delay(25);
        systemBeep(1);
        delay(25);
        systemBeep(0);
...
# 299 "./src/main/main.c"
    ...
    if (feature(FEATURE_SONAR)) {
        ...
        sonarGPIOConfig_t sonarGPIOConfig = {
            .gpio = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),
...
int main(void) {
    ...
    if (masterConfig.gyroSync) {
        rescheduleTask(TASK_GYROPID, targetLooptime - 10);
    }
    else {
        rescheduleTask(TASK_GYROPID, targetLooptime);
    }

    setTaskEnabled(TASK_GYROPID, 1);
