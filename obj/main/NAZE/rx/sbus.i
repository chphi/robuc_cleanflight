...
# 50 "./src/main/rx/sbus.c"
#define SBUS_TIME_NEEDED_PER_FRAME 3000
# 64 "./src/main/rx/sbus.c"
...
_Bool sbusInit(rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback)
{
    int b;
    for (b = 0; b < 18; b++)
    ...
    portOptions_t options = (rxConfig->sbus_inversion) ? ((SERIAL_STOPBITS_2 | SERIAL_PARITY_EVEN) | SERIAL_INVERTED) : (SERIAL_STOPBITS_2 | SERIAL_PARITY_EVEN);
    serialPort_t *sBusPort = openSerialPort(portConfig->identifier, FUNCTION_RX_SERIAL, sbusDataReceive, 100000, MODE_RX, options);

    return sBusPort != ((void *)0);
}
