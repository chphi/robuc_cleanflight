...
static _Bool rcFrameComplete = 0;
static _Bool spekHiRes = 0;
...
_Bool spektrumInit(rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback)
{
    ...
    serialPort_t *spektrumPort = openSerialPort(portConfig->identifier, FUNCTION_RX_SERIAL, spektrumDataReceive, 115200, MODE_RX, SERIAL_NOT_INVERTED);

    return spektrumPort != ((void *)0);
}
...
_Bool spekShouldBind(uint8_t spektrum_sat_bind)
{
# 178 "./src/main/rx/spektrum.c"
    return !(
        isMPUSoftReset() ||
        spektrum_sat_bind == 0 ||
...
void spektrumBind(rxConfig_t *rxConfig)
{
    ...
    gpioInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), &cfg);


    digitalHi(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), Pin_3);
    ...
    for (i = 0; i < rxConfig->spektrum_sat_bind; i++) {
        ...
        digitalLo(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), Pin_3);
