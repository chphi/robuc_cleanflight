...
# 29 "./src/main/telemetry/ibus.c" 2
...
# 31 "./src/main/telemetry/ibus.c" 2
...
# 32 "./src/main/telemetry/ibus.c" 2
...
# 37 "./src/main/telemetry/ibus.c" 2
...
# 42 "./src/main/telemetry/ibus.c" 2
...
# 44 "./src/main/telemetry/ibus.c" 2
...
# 46 "./src/main/telemetry/ibus.c" 2
...
# 48 "./src/main/telemetry/ibus.c" 2
...
# 53 "./src/main/telemetry/ibus.c" 2
...
# 56 "./src/main/telemetry/ibus.c" 2
...
# 60 "./src/main/telemetry/ibus.c" 2
# 168 "./src/main/telemetry/ibus.c"
extern const ibusTelemetryConfig_t pgResetTemplate_ibusTelemetryConfig; ibusTelemetryConfig_t ibusTelemetryConfig_System; extern const pgRegistry_t ibusTelemetryConfig_Registry; const pgRegistry_t ibusTelemetryConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 53 | (0 << 12), .size = sizeof(ibusTelemetryConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&ibusTelemetryConfig_System, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_ibusTelemetryConfig}, };

const ibusTelemetryConfig_t pgResetTemplate_ibusTelemetryConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .report_cell_voltage = 0, }
...
static serialPort_t *ibusSerialPort = ((void *)0);
...
static _Bool ibusTelemetryEnabled = 0;
static portSharing_e ibusPortSharing;

#define INVALID_IBUS_ADDRESS 0
static ibusAddress_t ibusBaseAddress = 0;
...
static uint16_t calculateChecksum(const uint8_t *ibusPacket, size_t packetLength)
{
    ...
    for (size_t i = 0; i < packetLength - (2); i++) {
...
static _Bool isChecksumOk(const uint8_t *ibusPacket)
{
    uint16_t calculatedChecksum = calculateChecksum(ibusReceiveBuffer, ((4)));


    return (calculatedChecksum >> 8) == ibusPacket[((4)) - 1]
           && (calculatedChecksum & 0xFF) == ibusPacket[((4)) - 2];
}

static void transmitIbusPacket(uint8_t *ibusPacket, size_t payloadLength)
{
    uint16_t checksum = calculateChecksum(ibusPacket, payloadLength + (2));
    ...
    outboundBytesToIgnoreOnRxCount += payloadLength + (2);
}
...
static _Bool isCommand(ibusCommand_e expected, const uint8_t *ibusPacket)
{
...
static void dispatchMeasurementReply(ibusAddress_t address)
{
    ...
    case IBUS_SENSOR_TYPE_TEMPERATURE:
            ...
            value = (baroTemperature + 5) / 10;



        sendIbusMeasurement(address, value + (400));
        break;
...
{
    if ((0 == ibusBaseAddress) &&
        (0 != returnAddress)) {
        ibusBaseAddress = returnAddress;
    }
}

static _Bool theAddressIsWithinOurRange(ibusAddress_t returnAddress)
{
    return (returnAddress >= ibusBaseAddress) &&
           (ibusAddress_t)(returnAddress - ibusBaseAddress) < (sizeof(sensorAddressTypeLookup) / sizeof((sensorAddressTypeLookup)[0]));
}

static void respondToIbusRequest(uint8_t ibusPacket[static ((4))])
{
...
_Bool checkIbusTelemetryState(void)
{
    _Bool newTelemetryEnabledValue = telemetryDetermineEnabledState(ibusPortSharing);
    ...
    if (newTelemetryEnabledValue) {
        rescheduleTask(TASK_TELEMETRY, (500));
...
void configureIbusTelemetryPort(void)
{
    ...
    ibusSerialPort = openSerialPort(ibusSerialPortConfig->identifier, FUNCTION_TELEMETRY_IBUS, ((void *)0), (115200),
...
void freeIbusTelemetryPort(void)
{
    ...
    ibusSerialPort = ((void *)0);

    ibusTelemetryEnabled = 0;
}
