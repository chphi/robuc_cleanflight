...
# 23 "./src/main/telemetry/frsky.c" 2
...
# 27 "./src/main/telemetry/frsky.c" 2
...
# 31 "./src/main/telemetry/frsky.c" 2
...
# 35 "./src/main/telemetry/frsky.c" 2
...
# 39 "./src/main/telemetry/frsky.c" 2
...
# 41 "./src/main/telemetry/frsky.c" 2
...
# 44 "./src/main/telemetry/frsky.c" 2
...
# 48 "./src/main/telemetry/frsky.c" 2
...
# 62 "./src/main/telemetry/frsky.c" 2
...
# 19 "./src/main/telemetry/frsky.h" 2
...
frskyTelemetryConfig_t frskyTelemetryConfig_System; extern const pgRegistry_t frskyTelemetryConfig_Registry; const pgRegistry_t frskyTelemetryConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 32 | (0 << 12), .size = sizeof(frskyTelemetryConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&frskyTelemetryConfig_System, .ptr = 0, .reset = {.ptr = 0}, };

static serialPort_t *frskyPort = ((void *)0);
static serialPortConfig_t *portConfig;

#define FRSKY_BAUDRATE 9600
#define FRSKY_INITIAL_PORT_MODE MODE_TX

static _Bool frskyTelemetryEnabled = 0;
...
static void sendBaro(void)
{
    ...
    sendDataHead(0x21);
    serialize16(((BaroAlt % 100) > 0 ? (BaroAlt % 100) : -(BaroAlt % 100)));
...
static void GPStoDDDMM_MMMM(int32_t mwiigps, gpsCoordinateDDDMMmmmm_t *result)
{
    ...
    absgps = ((mwiigps) > 0 ? (mwiigps) : -(mwiigps));
...
static void sendFakeLatLong(void)
{
    ...
    coord[0] = (frskyTelemetryConfig()->gpsNoFixLatitude * 10000000L);
    coord[1] = (frskyTelemetryConfig()->gpsNoFixLongitude * 10000000L);
...
static void sendGPSLatLong(void)
{
    ...
    if ((stateFlags & (GPS_FIX)) || gpsFixOccured == 1) {
...
static void sendVoltage(void)
{
    ...
    uint16_t payload;
# 378 "./src/main/telemetry/frsky.c"
...
void configureFrSkyTelemetryPort(void)
{
    ...
    frskyPort = openSerialPort(portConfig->identifier, FUNCTION_TELEMETRY_FRSKY, ((void *)0), 9600, MODE_TX, telemetryConfig()->telemetry_inversion ? SERIAL_INVERTED : SERIAL_NOT_INVERTED);
    if (!frskyPort) {
        return;
    }

    frskyTelemetryEnabled = 1;
}

_Bool hasEnoughTimeLapsedSinceLastTelemetryTransmission(uint32_t currentMillis)
{
...
_Bool checkFrSkyTelemetryState(void)
{
    _Bool newTelemetryEnabledValue = telemetryDetermineEnabledState(frskyPortSharing);
