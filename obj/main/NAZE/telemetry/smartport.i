...
# 11 "./src/main/telemetry/smartport.c" 2
...
# 15 "./src/main/telemetry/smartport.c" 2
...
# 19 "./src/main/telemetry/smartport.c" 2
...
# 20 "./src/main/telemetry/smartport.c" 2
...
# 22 "./src/main/telemetry/smartport.c" 2
...
# 24 "./src/main/telemetry/smartport.c" 2
...
# 27 "./src/main/telemetry/smartport.c" 2
...
void ledInit(void);
# 29 "./src/main/telemetry/smartport.c" 2
...
# 34 "./src/main/telemetry/smartport.c" 2
...
# 42 "./src/main/telemetry/smartport.c" 2
...
# 47 "./src/main/telemetry/smartport.c" 2
...
# 9 "./src/main/telemetry/smartport.h"
...
_Bool isSmartPortTimedOut(void);
# 57 "./src/main/telemetry/smartport.c" 2
...
# 61 "./src/main/telemetry/smartport.c" 2
...
# 62 "./src/main/telemetry/smartport.c" 2
...
static serialPort_t *smartPortSerialPort = ((void *)0);
static serialPortConfig_t *portConfig;

static telemetryConfig_t *telemetryConfig;
static _Bool smartPortTelemetryEnabled = 0;
...
static void smartPortSendPackage(uint16_t id, uint32_t val)
{
    ...
    smartPortSendByte(0xFF - (uint8_t)crc, ((void *)0));
}
...
void freeSmartPortTelemetryPort(void)
{
    ...
    smartPortSerialPort = ((void *)0);

    smartPortState = SPSTATE_UNINITIALIZED;
    smartPortTelemetryEnabled = 0;
}
...
void configureSmartPortTelemetryPort(void)
{
    ...
    smartPortSerialPort = openSerialPort(portConfig->identifier, FUNCTION_TELEMETRY_SMARTPORT, ((void *)0), 57600, MODE_RXTX, portOptions);
    ...
    smartPortTelemetryEnabled = 1;
    smartPortLastRequestTime = millis();
}

_Bool canSendSmartPortTelemetry(void)
{
...
void checkSmartPortTelemetryState(void)
{
    _Bool newTelemetryEnabledValue = telemetryDetermineEnabledState(smartPortPortSharing);
...
void handleSmartPortTelemetry(void)
{
    ...
    if ((now - smartPortLastRequestTime) > 7000) {
    ...
    while (smartPortHasRequest) {
        ...
        if ((millis() - smartPortLastServiceTime) > 1) {
        ...
        switch(id) {
            ...
            case FSSP_DATAID_LATLONG :
                if (sensors(SENSOR_GPS) && (stateFlags & (GPS_FIX))) {
                    ...
                    if (smartPortIdCnt & 1) {
                        tmpui = abs(GPS_coord[1]);
                        tmpui = (tmpui + tmpui / 2) / 25 | 0x80000000;
                        if (GPS_coord[1] < 0) tmpui |= 0x40000000;
                    }
                    else {
                        tmpui = abs(GPS_coord[0]);
                        tmpui = (tmpui + tmpui / 2) / 25;
                        if (GPS_coord[0] < 0) tmpui |= 0x40000000;
                    }
                    smartPortSendPackage(id, tmpui);
                    smartPortHasRequest = 0;
                }
            ...
            case FSSP_DATAID_T2 :
                if (sensors(SENSOR_GPS)) {
                    ...
                    smartPortSendPackage(id, ((stateFlags & (GPS_FIX)) ? 1000 : 0) + ((stateFlags & (GPS_FIX_HOME)) ? 2000 : 0) + GPS_numSat);
                    smartPortHasRequest = 0;
