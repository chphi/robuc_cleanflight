...
# 28 "./src/main/telemetry/telemetry.c" 2
...
# 31 "./src/main/telemetry/telemetry.c" 2
...
void mwDisarm(void);
# 35 "./src/main/telemetry/telemetry.c" 2
...
# 37 "./src/main/telemetry/telemetry.c" 2
...
# 41 "./src/main/telemetry/telemetry.c" 2
...
# 45 "./src/main/telemetry/telemetry.c" 2
...
_Bool checkSmartPortTelemetryState(void);
...
extern const telemetryConfig_t pgResetTemplate_telemetryConfig; telemetryConfig_t telemetryConfig_System; extern const pgRegistry_t telemetryConfig_Registry; const pgRegistry_t telemetryConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 31 | (0 << 12), .size = sizeof(telemetryConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&telemetryConfig_System, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_telemetryConfig}, };
...
const telemetryConfig_t pgResetTemplate_telemetryConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .telemetry_inversion = 0, .telemetry_send_cells = 1, }
...
_Bool telemetryDetermineEnabledState(portSharing_e portSharing)
{
    _Bool enabled = portSharing == PORTSHARING_NOT_SHARED;
