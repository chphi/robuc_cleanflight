    ...
    while ((ch = *(fmt++))) {
        if (ch != '%') {
            ...
            case 'u':{
                    ...
                    if (lng)
                        uli2a(__builtin_va_arg(va,unsigned long int), 10, 0, bf);
                    else

                        ui2a(__builtin_va_arg(va,unsigned int), 10, 0, bf);
            ...
            case 'd':{
                    ...
                    if (lng)
                        li2a(__builtin_va_arg(va,unsigned long int), bf);
                    else

                        i2a(__builtin_va_arg(va,int), bf);
                    written += putchw(putp, putf, w, lz, bf);
                    break;
                }
            case 'x':
            case 'X':
                ...
                if (lng)
                    uli2a(__builtin_va_arg(va,unsigned long int), 16, (ch == 'X'), bf);
                else

                    ui2a(__builtin_va_arg(va,unsigned int), 16, (ch == 'X'), bf);
                written += putchw(putp, putf, w, lz, bf);
                break;
            case 'c':
                putf(putp, (char) (__builtin_va_arg(va,int))); written++;
                break;
            case 's':
                written += putchw(putp, putf, w, 0, __builtin_va_arg(va,char *));
                break;
            case '%':
                putf(putp, ch); written++;
                break;
            case 'n':
                *__builtin_va_arg(va,int*) = written;
                break;
            default:
                break;
            }
