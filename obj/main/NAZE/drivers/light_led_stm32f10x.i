...
void ledInit(_Bool alternative_led)
{
    ...
    led_config[0].gpio = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00));
    led_config[0].pin = Pin_3;
    ...
    RCC_APB2PeriphClockCmd(((uint32_t)0x00000008), ENABLE);
    led_config[1].gpio = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00));
    led_config[1].pin = Pin_4;
    cfg.pin = led_config[1].pin;
    digitalHi(led_config[1].gpio, led_config[1].pin);
    gpioInit(led_config[1].gpio, &cfg);
# 65 "./src/main/drivers/light_led_stm32f10x.c"
}
