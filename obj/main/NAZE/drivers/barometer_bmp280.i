# 1 "./src/main/drivers/barometer_bmp280.c"
...
# 1 "./src/main/drivers/barometer_bmp280.c"
# 18 "./src/main/drivers/barometer_bmp280.c"
...
# 19 "./src/main/drivers/barometer_bmp280.c" 2
...
# 20 "./src/main/drivers/barometer_bmp280.c" 2
...
# 22 "./src/main/drivers/barometer_bmp280.c" 2
...
# 24 "./src/main/drivers/barometer_bmp280.c" 2
...
# 26 "./src/main/drivers/barometer_bmp280.c" 2
...
# 28 "./src/main/drivers/barometer_bmp280.c" 2
...
# 29 "./src/main/drivers/barometer_bmp280.c" 2
...
# 31 "./src/main/drivers/barometer_bmp280.c" 2
...
_Bool bmp280Detect(baro_t *baro)
{
    ...
    i2cRead((0x76), (0xD0), 1, &bmp280_chip_id);
    if (bmp280_chip_id != (0x58))
        return 0;


    i2cRead((0x76), (0x88), 24, (uint8_t *)&bmp280_cal);

    i2cWrite((0x76), (0xF4), (((0x04)) << 2 | ((0x01)) << 5 | (0x01)));
