...
# 1 "./src/main/drivers/serial_uart.c"
# 23 "./src/main/drivers/serial_uart.c"
...
# 24 "./src/main/drivers/serial_uart.c" 2
...
# 25 "./src/main/drivers/serial_uart.c" 2
...
# 28 "./src/main/drivers/serial_uart.c" 2
...
# 30 "./src/main/drivers/serial_uart.c" 2
...
# 33 "./src/main/drivers/serial_uart.c" 2
...
# 40 "./src/main/drivers/serial_uart.c" 2
...
void usartInitAllIOSignals(void)
{
    ...
    gpio.pin = Pin_9;
    digitalHi(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), gpio.pin);
...
# 96 "./src/main/drivers/serial_uart.c"
}
...
static void usartConfigurePinInversion(uartPort_t *uartPort) {
    ...
    _Bool inverted = uartPort->port.options & SERIAL_INVERTED;


    if (inverted && uartPort->USARTx == ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))) {

        digitalHi(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), Pin_2);
    }
# 124 "./src/main/drivers/serial_uart.c"
}
...
# 178 "./src/main/drivers/serial_uart.c"
    } else {
...
# 327 "./src/main/drivers/serial_uart.c"
...
_Bool isUartTransmitBufferEmpty(serialPort_t *instance)
{
    uartPort_t *s = (uartPort_t *)instance;
    if (s->txDMAChannel)
        return s->txDMAEmpty;
