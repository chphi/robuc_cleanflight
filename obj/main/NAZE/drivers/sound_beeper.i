...
# 21 "./src/main/drivers/sound_beeper.c" 2
...
# 23 "./src/main/drivers/sound_beeper.c" 2
...
# 28 "./src/main/drivers/sound_beeper.c" 2
...
# 30 "./src/main/drivers/sound_beeper.c" 2




void (*systemBeepPtr)(_Bool onoff) = ((void *)0);

static void beepNormal(_Bool onoff)
{
    if (onoff) {
        digitalLo(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), Pin_12);
    } else {
        digitalHi(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), Pin_12);
    }
}

static void beepInverted(_Bool onoff)
{
    if (onoff) {
        digitalHi(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), Pin_12);
    } else {
