# 1 "./src/main/drivers/accgyro_spi_mpu6500.c"
...
# 1 "./src/main/drivers/accgyro_spi_mpu6500.c"
# 18 "./src/main/drivers/accgyro_spi_mpu6500.c"
...
# 19 "./src/main/drivers/accgyro_spi_mpu6500.c" 2
...
# 20 "./src/main/drivers/accgyro_spi_mpu6500.c" 2
...
# 21 "./src/main/drivers/accgyro_spi_mpu6500.c" 2
...
# 23 "./src/main/drivers/accgyro_spi_mpu6500.c" 2
...
# 25 "./src/main/drivers/accgyro_spi_mpu6500.c" 2
...
# 26 "./src/main/drivers/accgyro_spi_mpu6500.c" 2
...
# 28 "./src/main/drivers/accgyro_spi_mpu6500.c" 2
...
# 29 "./src/main/drivers/accgyro_spi_mpu6500.c" 2
...
# 30 "./src/main/drivers/accgyro_spi_mpu6500.c" 2
...
# 31 "./src/main/drivers/accgyro_spi_mpu6500.c" 2
...
# 33 "./src/main/drivers/accgyro_spi_mpu6500.c" 2
...
# 34 "./src/main/drivers/accgyro_spi_mpu6500.c" 2
...
# 35 "./src/main/drivers/accgyro_spi_mpu6500.c" 2
...
# 36 "./src/main/drivers/accgyro_spi_mpu6500.c" 2
...
# 37 "./src/main/drivers/accgyro_spi_mpu6500.c" 2
...
_Bool mpu6500WriteRegister(uint8_t reg, uint8_t data)
{
    ...
    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), reg);
    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), data);
...
{
    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x1000));
    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), reg | 0x80);
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), data, ((void *)0), length);
    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x1000));
...
{
    static _Bool hardwareInitialised = 0;

    if (hardwareInitialised) {
        return;
    }
# 83 "./src/main/drivers/accgyro_spi_mpu6500.c"
    RCC_APB2PeriphClockCmd(((uint32_t)0x00000008), ENABLE);

    gpio_config_t gpio;

    gpio.mode = Mode_Out_PP;
    gpio.pin = ((uint16_t)0x1000);
    gpio.speed = Speed_50MHz;
    gpioInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), &gpio);


    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x1000));

    spiSetDivisor(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), SPI_CLOCK_STANDARD);

    hardwareInitialised = 1;
}
...
_Bool mpu6500SpiDetect(void)
{
    ...
    mpu6500ReadRegister(0x75, 1, &sig);

    if (sig == (0x70) || sig == (0x71) || sig == (0xAF) || sig == (0x12)) {
        return 1;
    }
