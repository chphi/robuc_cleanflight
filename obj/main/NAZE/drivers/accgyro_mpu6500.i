# 1 "./src/main/drivers/accgyro_mpu6500.c"
...
# 1 "./src/main/drivers/accgyro_mpu6500.c"
# 18 "./src/main/drivers/accgyro_mpu6500.c"
...
# 19 "./src/main/drivers/accgyro_mpu6500.c" 2
...
# 20 "./src/main/drivers/accgyro_mpu6500.c" 2
...
# 21 "./src/main/drivers/accgyro_mpu6500.c" 2
...
# 23 "./src/main/drivers/accgyro_mpu6500.c" 2
...
# 24 "./src/main/drivers/accgyro_mpu6500.c" 2
...
# 26 "./src/main/drivers/accgyro_mpu6500.c" 2
...
# 27 "./src/main/drivers/accgyro_mpu6500.c" 2
...
# 28 "./src/main/drivers/accgyro_mpu6500.c" 2
...
# 30 "./src/main/drivers/accgyro_mpu6500.c" 2
...
# 31 "./src/main/drivers/accgyro_mpu6500.c" 2
...
# 32 "./src/main/drivers/accgyro_mpu6500.c" 2
...
# 33 "./src/main/drivers/accgyro_mpu6500.c" 2
...
# 35 "./src/main/drivers/accgyro_mpu6500.c" 2
...
# 36 "./src/main/drivers/accgyro_mpu6500.c" 2
...
# 37 "./src/main/drivers/accgyro_mpu6500.c" 2
...
# 38 "./src/main/drivers/accgyro_mpu6500.c" 2

extern uint8_t mpuIntDenominator;

static _Bool mpu6500ReadTemp(int16_t *tempData)
{
    uint8_t buf[2];
    if (!mpuConfiguration.read(0x41, 2, buf)) {
        return 0;
    }
...
void mpu6500GyroInit(gyro_t* gyro, uint8_t lpf)
{
    ...
    mpuConfiguration.write(0x6B, (0x80));
    delay(100);
    mpuConfiguration.write(0x68, 0x07);
    delay(100);
    mpuConfiguration.write(0x6B, 0);
    delay(100);
    mpuConfiguration.write(0x6B, INV_CLK_PLL);
    delay(15);
    mpuConfiguration.write(0x1B, INV_FSR_2000DPS << 3);
    delay(15);
    mpuConfiguration.write(0x1C, INV_FSR_8G << 3);
    delay(15);
    mpuConfiguration.write(0x1A, lpf);
    delay(15);
    mpuConfiguration.write(0x19, 0);
    delay(100);
    ...
    mpuConfiguration.write(0x37, 0 << 7 | 0 << 6 | 0 << 5 | 1 << 4 | 0 << 3 | 0 << 2 | 0 << 1 | 0 << 0);


    delay(15);


    mpuConfiguration.write(0x38, 0x01);
