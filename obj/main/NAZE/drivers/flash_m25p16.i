...
# 21 "./src/main/drivers/flash_m25p16.c" 2
...
# 23 "./src/main/drivers/flash_m25p16.c" 2
...
# 31 "./src/main/drivers/flash_m25p16.c" 2
...
# 32 "./src/main/drivers/flash_m25p16.c" 2
...
# 33 "./src/main/drivers/flash_m25p16.c" 2
...
static void m25p16_performOneByteCommand(uint8_t command)
{
    ...
    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), command);
...
static uint8_t m25p16_readStatus()
{
    ...
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), in, command, sizeof(command));
...
static _Bool m25p16_readIdentification()
{
    ...
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), in, out, sizeof(out));
...
_Bool m25p16_init()
{
    ...
    spiSetDivisor(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), SPI_CLOCK_FAST);
...
void m25p16_eraseSector(uint32_t address)
{
    uint8_t out[] = { 0xD8, (address >> 16) & 0xFF, (address >> 8) & 0xFF, address & 0xFF};
    ...
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), ((void *)0), out, sizeof(out));
...
void m25p16_pageProgramBegin(uint32_t address)
{
    uint8_t command[] = { 0x02, (address >> 16) & 0xFF, (address >> 8) & 0xFF, address & 0xFF};
    ...
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), ((void *)0), command, sizeof(command));
}

void m25p16_pageProgramContinue(const uint8_t *data, int length)
{
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), ((void *)0), data, length);
}
...
# 290 "./src/main/drivers/flash_m25p16.c"
void m25p16_pageProgram(uint32_t address, const uint8_t *data, int length)
{
...
int m25p16_readBytes(uint32_t address, uint8_t *buffer, int length)
{
    ...
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), ((void *)0), command, sizeof(command));
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), buffer, ((void *)0), length);
