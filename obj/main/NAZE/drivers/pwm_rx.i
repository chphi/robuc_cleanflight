...
# 19 "./src/main/drivers/pwm_rx.c" 2
...
# 20 "./src/main/drivers/pwm_rx.c" 2
...
# 22 "./src/main/drivers/pwm_rx.c" 2
...
# 24 "./src/main/drivers/pwm_rx.c" 2
...
# 25 "./src/main/drivers/pwm_rx.c" 2
...
# 26 "./src/main/drivers/pwm_rx.c" 2
...
# 28 "./src/main/drivers/pwm_rx.c" 2
...
# 30 "./src/main/drivers/pwm_rx.c" 2
...
# 32 "./src/main/drivers/pwm_rx.c" 2
...
# 33 "./src/main/drivers/pwm_rx.c" 2
...
# 34 "./src/main/drivers/pwm_rx.c" 2
...
# 36 "./src/main/drivers/pwm_rx.c" 2
...
# 38 "./src/main/drivers/pwm_rx.c" 2
...
static void ppmEdgeCallback(timerCCHandlerRec_t* cbRec, captureCompare_t capture)
{
    ...
    if (currentTime > previousTime) {
        ppmDev.deltaTime = currentTime - (previousTime + (ppmDev.overflowed ? (0x10000 >> ppmCountShift) : 0));
    } else {
        ppmDev.deltaTime = (0x10000 >> ppmCountShift) + currentTime - previousTime;
    }
...
{
    (void)(capture);
    pwmInputPort_t *pwmInputPort = ( __extension__ ({ const typeof( ((pwmInputPort_t *)0)->overflowCb ) *__mptr = (cbRec); (pwmInputPort_t *)( (char *)__mptr - __builtin_offsetof (pwmInputPort_t, overflowCb) );}));
...
{
    pwmInputPort_t *pwmInputPort = ( __extension__ ({ const typeof( ((pwmInputPort_t *)0)->edgeCb ) *__mptr = (cbRec); (pwmInputPort_t *)( (char *)__mptr - __builtin_offsetof (pwmInputPort_t, edgeCb) );}));
...
void pwmInConfig(const timerHardware_t *timerHardwarePtr, uint8_t channel)
{
    ...
    timerConfigure(timerHardwarePtr, (uint16_t)0x10000, 1);
...
void ppmInConfig(const timerHardware_t *timerHardwarePtr)
{
    ...
    pwmInputPort_t *self = &pwmInputPorts[0];
