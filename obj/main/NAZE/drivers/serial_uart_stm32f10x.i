# 1 "./src/main/drivers/serial_uart_stm32f10x.c"
...
# 1 "./src/main/drivers/serial_uart_stm32f10x.c"
# 25 "./src/main/drivers/serial_uart_stm32f10x.c"
...
# 26 "./src/main/drivers/serial_uart_stm32f10x.c" 2
...
# 27 "./src/main/drivers/serial_uart_stm32f10x.c" 2
...
# 28 "./src/main/drivers/serial_uart_stm32f10x.c" 2
...
# 30 "./src/main/drivers/serial_uart_stm32f10x.c" 2
...
# 32 "./src/main/drivers/serial_uart_stm32f10x.c" 2
...
# 34 "./src/main/drivers/serial_uart_stm32f10x.c" 2
...
# 35 "./src/main/drivers/serial_uart_stm32f10x.c" 2
...
# 36 "./src/main/drivers/serial_uart_stm32f10x.c" 2
...
# 37 "./src/main/drivers/serial_uart_stm32f10x.c" 2
...
# 39 "./src/main/drivers/serial_uart_stm32f10x.c" 2
...
# 40 "./src/main/drivers/serial_uart_stm32f10x.c" 2
...
# 41 "./src/main/drivers/serial_uart_stm32f10x.c" 2
# 1 "./src/main/drivers/serial_uart_stm32f10x.h" 1
# 18 "./src/main/drivers/serial_uart_stm32f10x.h"
...
# 47 "./src/main/drivers/serial_uart_stm32f10x.h"
...
# 42 "./src/main/drivers/serial_uart_stm32f10x.c" 2
...
# 64 "./src/main/drivers/serial_uart_stm32f10x.c"
...
void usartIrqHandler(uartPort_t *s)
{
    ...
    if (SR & ((uint16_t)0x0020) && !s->rxDMAChannel) {
    ...
    if (SR & ((uint16_t)0x0080)) {
        if (s->port.txBufferTail != s->port.txBufferHead) {
            ...
            USART_ITConfig(s->USARTx, ((uint16_t)0x0727), DISABLE);
        }
    }
}
...
{
    uartPort_t *s = ( __extension__ ({ const typeof( ((uartPort_t *)0)->dmaTxHandler ) *__mptr = (handler); (uartPort_t *)( (char *)__mptr - __builtin_offsetof (uartPort_t, dmaTxHandler) );}));
...
{
    uartPort_t *s;
    static volatile uint8_t rx1Buffer[256];
    static volatile uint8_t tx1Buffer[256];
    gpio_config_t gpio;
    ...
    s->port.rxBufferSize = 256;
    s->port.txBufferSize = 256;

    s->USARTx = ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800));



    s->rxDMAChannel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058));
    s->rxDMAPeripheralBaseAddr = (uint32_t)&s->USARTx->DR;

    s->txDMAChannel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0044));
    ...
    if (options & SERIAL_BIDIR) {
        ...
        gpioInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), &gpio);
    } else {
        if (mode & MODE_TX) {
    ...
    dmaSetHandler((&dmaChannels[3]), &uartPort1.dmaTxHandler, (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0));
# 184 "./src/main/drivers/serial_uart_stm32f10x.c"
    return s;
}
...
{
    uartPort_t *s;
    static volatile uint8_t rx2Buffer[256];
    static volatile uint8_t tx2Buffer[256];
    gpio_config_t gpio;
    ...
    s->USARTx = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400));
    ...
    NVIC_InitStructure.NVIC_IRQChannelSubPriority = (((((((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((2)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0))>>4)&(0x0f>>(7-(((uint32_t)0x500)>>8)))));
...
{
    uartPort_t *s;
    static volatile uint8_t rx3Buffer[256];
    static volatile uint8_t tx3Buffer[256];
    gpio_config_t gpio;
    NVIC_InitTypeDef NVIC_InitStructure;
    ...
    s->USARTx = ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800));
