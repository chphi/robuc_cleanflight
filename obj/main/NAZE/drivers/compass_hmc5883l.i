# 1 "./src/main/drivers/compass_hmc5883l.c"
...
# 1 "./src/main/drivers/compass_hmc5883l.c"
# 18 "./src/main/drivers/compass_hmc5883l.c"
...
# 19 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 20 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 21 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 23 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 25 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 26 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 28 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 29 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 31 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 32 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 33 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 34 "./src/main/drivers/compass_hmc5883l.c" 2
...
void ledInit(void);
# 35 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 37 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 38 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 40 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 42 "./src/main/drivers/compass_hmc5883l.c" 2
# 105 "./src/main/drivers/compass_hmc5883l.c"
...
# 145 "./src/main/drivers/compass_hmc5883l.c"
}
...
void hmc5883lInit(void)
{
    ...
    delay(50);
    i2cWrite(0x1E, 0, 0x010 + 1);


    i2cWrite(0x1E, 1, 0x60);
    delay(100);
    hmc5883lRead(magADC);
    ...
    for (i = 0; i < 10; i++) {
        ...
        if (-4096 >= ((magADC[X]) < (((magADC[Y]) < (magADC[Z]) ? (magADC[Y]) : (magADC[Z]))) ? (magADC[X]) : (((magADC[Y]) < (magADC[Z]) ? (magADC[Y]) : (magADC[Z]))))) {
            bret = 0;
            break;
        }
    ...
    magGain[X] = fabsf(660.0f * (+1.16f) * 2.0f * 10.0f / xyz_total[X]);
    magGain[Y] = fabsf(660.0f * (+1.16f) * 2.0f * 10.0f / xyz_total[Y]);
    magGain[Z] = fabsf(660.0f * (+1.08f) * 2.0f * 10.0f / xyz_total[Z]);


    i2cWrite(0x1E, 0, 0x70);
    i2cWrite(0x1E, 1, 0x20);
    i2cWrite(0x1E, 2, 0x00);
    delay(100);
...
_Bool hmc5883lRead(int16_t *magData)
{
    ...
    _Bool ack = i2cRead(0x1E, 0x03, 6, buf);
    if (!ack) {
        return 0;
    }
