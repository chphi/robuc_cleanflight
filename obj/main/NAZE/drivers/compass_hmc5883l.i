...
# 36 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 39 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 41 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 43 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 44 "./src/main/drivers/compass_hmc5883l.c" 2
...
# 46 "./src/main/drivers/compass_hmc5883l.c" 2
# 109 "./src/main/drivers/compass_hmc5883l.c"
...
{
    (void)(cb);
# 149 "./src/main/drivers/compass_hmc5883l.c"
}
...
_Bool hmc5883lInit(void)
{
    ...
    int validSamples = 0;
    int failedSamples = 0;
    while (validSamples < 10 && failedSamples < 5) {
        i2cWrite(0x1E, 2, 1);
        delay(50);
        if (hmc5883lRead(magADC)) {
            ++validSamples;
