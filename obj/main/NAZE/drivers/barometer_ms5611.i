# 1 "./src/main/drivers/barometer_ms5611.c"
...
# 1 "./src/main/drivers/barometer_ms5611.c"
# 18 "./src/main/drivers/barometer_ms5611.c"
...
# 19 "./src/main/drivers/barometer_ms5611.c" 2
...
# 20 "./src/main/drivers/barometer_ms5611.c" 2
...
# 22 "./src/main/drivers/barometer_ms5611.c" 2
...
# 24 "./src/main/drivers/barometer_ms5611.c" 2
...
# 26 "./src/main/drivers/barometer_ms5611.c" 2
...
# 27 "./src/main/drivers/barometer_ms5611.c" 2
...
# 28 "./src/main/drivers/barometer_ms5611.c" 2
...
# 30 "./src/main/drivers/barometer_ms5611.c" 2
...
{
    uint8_t rxbuf[2] = { 0, 0 };
    i2cRead(0x77, 0xA0 + coef_num * 2, 2, rxbuf);
...
{
    uint8_t rxbuf[3];
    i2cRead(0x77, 0x00, 3, rxbuf);
    return (rxbuf[0] << 16) | (rxbuf[1] << 8) | rxbuf[2];
}

static void ms5611_start_ut(void)
{
    i2cWrite(0x77, 0x40 + 0x10 + ms5611_osr, 1);
}
...
static void ms5611_start_up(void)
{
    i2cWrite(0x77, 0x40 + 0x00 + ms5611_osr, 1);
}
