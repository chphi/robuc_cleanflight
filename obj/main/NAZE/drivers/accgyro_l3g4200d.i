# 1 "./src/main/drivers/accgyro_l3g4200d.c"
...
# 1 "./src/main/drivers/accgyro_l3g4200d.c"
# 18 "./src/main/drivers/accgyro_l3g4200d.c"
...
# 19 "./src/main/drivers/accgyro_l3g4200d.c" 2
...
# 20 "./src/main/drivers/accgyro_l3g4200d.c" 2
...
# 22 "./src/main/drivers/accgyro_l3g4200d.c" 2
...
# 24 "./src/main/drivers/accgyro_l3g4200d.c" 2
...
# 25 "./src/main/drivers/accgyro_l3g4200d.c" 2
...
# 27 "./src/main/drivers/accgyro_l3g4200d.c" 2
...
# 28 "./src/main/drivers/accgyro_l3g4200d.c" 2
...
# 30 "./src/main/drivers/accgyro_l3g4200d.c" 2
...
static _Bool l3g4200dRead(int16_t *gyroADC);
...
static void l3g4200dInit(uint8_t lpf)
{
    ...
    ack = i2cWrite(0x68, 0x23, 0xF0);
    if (!ack)
        failureMode(FAILURE_ACC_INIT);

    delay(5);
    i2cWrite(0x68, 0x20, 0x0F | mpuLowPassFilter);
}
...
static _Bool l3g4200dRead(int16_t *gyroADC)
{
    ...
    if (!i2cRead(0x68, 0x80 | 0x28, 6, buf)) {
        return 0;
    }
