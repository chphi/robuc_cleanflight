...
# 32 "./src/main/drivers/barometer_bmp085.c" 2
...
# 35 "./src/main/drivers/barometer_bmp085.c" 2
...
_Bool bmp085Detect(const bmp085Config_t *config, baro_t *baro)
{
    ...
    if (config) {
        ...
        EXTIConfig(eocIO, &bmp085_extiCallbackRec, (((((0x0f)<<(4-(7-(((uint32_t)0x500)>>8))))|((0x0f)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), EXTI_Trigger_Rising);
        EXTIEnable(eocIO, 1);
    }
