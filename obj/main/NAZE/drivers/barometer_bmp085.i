# 1 "./src/main/drivers/barometer_bmp085.c"
...
# 1 "./src/main/drivers/barometer_bmp085.c"
# 18 "./src/main/drivers/barometer_bmp085.c"
...
# 19 "./src/main/drivers/barometer_bmp085.c" 2
...
# 20 "./src/main/drivers/barometer_bmp085.c" 2
...
# 22 "./src/main/drivers/barometer_bmp085.c" 2
...
# 24 "./src/main/drivers/barometer_bmp085.c" 2
...
# 26 "./src/main/drivers/barometer_bmp085.c" 2
...
# 28 "./src/main/drivers/barometer_bmp085.c" 2
...
# 29 "./src/main/drivers/barometer_bmp085.c" 2
...
# 30 "./src/main/drivers/barometer_bmp085.c" 2
...
# 31 "./src/main/drivers/barometer_bmp085.c" 2
...
# 33 "./src/main/drivers/barometer_bmp085.c" 2




static _Bool isConversionComplete = 0;
static _Bool isEOCConnected = 1;


void BMP085_EOC_EXTI_Handler(void) {
    if (EXTI_GetITStatus(((uint32_t)0x04000)) == SET) {
        EXTI_ClearITPendingBit(((uint32_t)0x04000));
        isConversionComplete = 1;
    }
}
...
void bmp085Disable(const bmp085Config_t *config)
{
    ...
    digitalLo(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), Pin_13);;
}
...
_Bool bmp085Detect(const bmp085Config_t *config, baro_t *baro)
{
    ...
    if (config) {
        ...
        digitalHi(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), Pin_13);;

        registerExtiCallbackHandler(EXTI15_10_IRQn, BMP085_EOC_EXTI_Handler);


        gpioExtiLineConfig(((uint8_t)0x02), ((uint8_t)0x0E));
...
static void bmp085_start_up(void)
{
    ...
    i2cWrite(0x77, 0xF4, ctrl_reg_data);
}
