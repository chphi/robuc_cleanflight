...
# 28 "./src/main/drivers/pwm_mapping.c" 2
...
# 32 "./src/main/drivers/pwm_mapping.c" 2
...
# 33 "./src/main/drivers/pwm_mapping.c" 2
...
# 37 "./src/main/drivers/pwm_mapping.c" 2
...
# 81 "./src/main/drivers/pwm_mapping.c"
enum {
    MAP_TO_PPM_INPUT = 1,
    MAP_TO_PWM_INPUT,
    MAP_TO_MOTOR_OUTPUT,
...
# 728 "./src/main/drivers/pwm_mapping.c"
...
pwmIOConfiguration_t *pwmInit(drv_pwm_config_t *init)
{
    ...
    for (i = 0; i < 14 && setup[i] != 0xFFFF; i++) {
        ...
        if (init->useUART3 && timerHardwarePtr->gpio == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)) && (timerHardwarePtr->pin == Pin_10 || timerHardwarePtr->pin == Pin_11))
            continue;
# 793 "./src/main/drivers/pwm_mapping.c"
        if ((I2CDEV_2) == I2CDEV_1 && timerHardwarePtr->gpio == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)) && (timerHardwarePtr->pin == Pin_6 || timerHardwarePtr->pin == Pin_7))
            continue;
...
# 838 "./src/main/drivers/pwm_mapping.c"
...
# 859 "./src/main/drivers/pwm_mapping.c"
...
# 932 "./src/main/drivers/pwm_mapping.c"
        }
        ...
        if (init->useChannelForwarding && !init->airplane) {
            ...
            if (init->useLEDStrip) {
                ...
                if (timerIndex >= PWM5 && timerIndex <= PWM8)
                    type = MAP_TO_SERVO_OUTPUT;
# 969 "./src/main/drivers/pwm_mapping.c"
        }
# 986 "./src/main/drivers/pwm_mapping.c"
