# 1 "./src/main/drivers/pwm_mapping.c"
...
# 1 "./src/main/drivers/pwm_mapping.c"
# 18 "./src/main/drivers/pwm_mapping.c"
...
# 19 "./src/main/drivers/pwm_mapping.c" 2
...
# 20 "./src/main/drivers/pwm_mapping.c" 2
...
# 21 "./src/main/drivers/pwm_mapping.c" 2
...
# 22 "./src/main/drivers/pwm_mapping.c" 2
...
# 24 "./src/main/drivers/pwm_mapping.c" 2
...
# 26 "./src/main/drivers/pwm_mapping.c" 2
...
# 27 "./src/main/drivers/pwm_mapping.c" 2
...
# 29 "./src/main/drivers/pwm_mapping.c" 2
...
# 30 "./src/main/drivers/pwm_mapping.c" 2
...
# 31 "./src/main/drivers/pwm_mapping.c" 2
...
# 34 "./src/main/drivers/pwm_mapping.c" 2
...
# 78 "./src/main/drivers/pwm_mapping.c"
enum {
    MAP_TO_PPM_INPUT = 1,
    MAP_TO_PWM_INPUT,
    MAP_TO_MOTOR_OUTPUT,
...
# 630 "./src/main/drivers/pwm_mapping.c"
...
pwmIOConfiguration_t *pwmInit(drv_pwm_config_t *init)
{
    ...
    for (i = 0; i < 14 && setup[i] != 0xFFFF; i++) {
        uint8_t timerIndex = setup[i] & 0x00FF;
        uint8_t type = (setup[i] & 0xFF00) >> 8;

        const timerHardware_t *timerHardwarePtr = &timerHardware[timerIndex];
# 675 "./src/main/drivers/pwm_mapping.c"
        if (init->useUART2 && timerHardwarePtr->gpio == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)) && (timerHardwarePtr->pin == Pin_2 || timerHardwarePtr->pin == Pin_3))
            continue;



        if (init->useUART3 && timerHardwarePtr->gpio == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)) && (timerHardwarePtr->pin == Pin_10 || timerHardwarePtr->pin == Pin_11))
            continue;
# 701 "./src/main/drivers/pwm_mapping.c"
        if (timerHardwarePtr->gpio == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)) && (timerHardwarePtr->pin == Pin_6 || timerHardwarePtr->pin == Pin_7))
            continue;



        if (init->useSoftSerial && timerHardwarePtr->tim == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)))
            continue;
        ...
        if (init->useLEDStrip) {
            if (timerHardwarePtr->tim == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)))
                continue;
        ...
        if (init->useVbat && timerHardwarePtr->gpio == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)) && timerHardwarePtr->pin == ((uint16_t)0x0010)) {
            continue;
        }



        if (init->useRSSIADC && timerHardwarePtr->gpio == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)) && timerHardwarePtr->pin == ((uint16_t)0x0002)) {
            continue;
        }



        if (init->useCurrentMeterADC && timerHardwarePtr->gpio == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)) && timerHardwarePtr->pin == ((uint16_t)0x0002)) {
            continue;
        }
        ...
        if (init->useServos && !init->airplane) {
            ...
            if ((timerIndex == PWM9 || timerIndex == PWM10) && timerHardwarePtr->tim == ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)))
                type = MAP_TO_SERVO_OUTPUT;
# 817 "./src/main/drivers/pwm_mapping.c"
        }
...
# 851 "./src/main/drivers/pwm_mapping.c"
        if (type == MAP_TO_PPM_INPUT) {
# 862 "./src/main/drivers/pwm_mapping.c"
