...
# 21 "./src/main/drivers/system_stm32f10x.c" 2
...
# 23 "./src/main/drivers/system_stm32f10x.c" 2
...
# 26 "./src/main/drivers/system_stm32f10x.c" 2
...
void enableGPIOPowerUsageAndNoiseReductions(void)
{
    ...
    gpioInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), &gpio);
}
