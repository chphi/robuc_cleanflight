# 1 "./src/main/drivers/accgyro_adxl345.c"
...
# 1 "./src/main/drivers/accgyro_adxl345.c"
# 18 "./src/main/drivers/accgyro_adxl345.c"
...
# 19 "./src/main/drivers/accgyro_adxl345.c" 2
...
# 20 "./src/main/drivers/accgyro_adxl345.c" 2
...
# 22 "./src/main/drivers/accgyro_adxl345.c" 2
...
# 24 "./src/main/drivers/accgyro_adxl345.c" 2
...
# 25 "./src/main/drivers/accgyro_adxl345.c" 2
...
# 27 "./src/main/drivers/accgyro_adxl345.c" 2
...
# 28 "./src/main/drivers/accgyro_adxl345.c" 2
...
# 29 "./src/main/drivers/accgyro_adxl345.c" 2
...
static _Bool adxl345Read(int16_t *accelData);

static _Bool useFifo = 0;
...
static void adxl345Init(void)
{
    if (useFifo) {
        ...
        i2cWrite(0x53, 0x2D, 0x08);
        i2cWrite(0x53, 0x31, 0x08 | 0x02);
        i2cWrite(0x53, 0x2C, 0x0C);
        i2cWrite(0x53, 0x38, (fifoDepth & 0x1F) | 0x80);
    } else {
        i2cWrite(0x53, 0x2D, 0x08);
        i2cWrite(0x53, 0x31, 0x08 | 0x02);
        i2cWrite(0x53, 0x2C, 0x0A);
    }
    acc_1G = 265;
}
