# 1 "./src/main/drivers/accgyro_mpu3050.c"
...
# 1 "./src/main/drivers/accgyro_mpu3050.c"
# 18 "./src/main/drivers/accgyro_mpu3050.c"
...
# 19 "./src/main/drivers/accgyro_mpu3050.c" 2
...
# 20 "./src/main/drivers/accgyro_mpu3050.c" 2
...
# 22 "./src/main/drivers/accgyro_mpu3050.c" 2
...
# 24 "./src/main/drivers/accgyro_mpu3050.c" 2
...
# 26 "./src/main/drivers/accgyro_mpu3050.c" 2
...
# 27 "./src/main/drivers/accgyro_mpu3050.c" 2
...
# 28 "./src/main/drivers/accgyro_mpu3050.c" 2
...
# 30 "./src/main/drivers/accgyro_mpu3050.c" 2
...
# 31 "./src/main/drivers/accgyro_mpu3050.c" 2
...
# 32 "./src/main/drivers/accgyro_mpu3050.c" 2
...
# 33 "./src/main/drivers/accgyro_mpu3050.c" 2
...
# 34 "./src/main/drivers/accgyro_mpu3050.c" 2
...
static _Bool mpu3050ReadTemp(int16_t *tempData);
...
static void mpu3050Init(gyro_t *gyro, uint8_t lpf)
{
    ...
    ack = mpuConfiguration.write(0x15, 0);
    if (!ack)
        failureMode(FAILURE_ACC_INIT);

    mpuConfiguration.write(0x16, 0x18 | lpf);
    mpuConfiguration.write(0x17, 0);
    mpuConfiguration.write(0x3D, 0x01);
    mpuConfiguration.write(0x3E, 0x01);
}

static _Bool mpu3050ReadTemp(int16_t *tempData)
{
    uint8_t buf[2];
    if (!mpuConfiguration.read(0x1B, 2, buf)) {
        return 0;
    }
