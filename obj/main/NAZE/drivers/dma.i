...
{
    dmaHandlers.dma1Channel2IRQHandler(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x001C)));
}

void DMA1_Channel3_IRQHandler(void)
{
    dmaHandlers.dma1Channel3IRQHandler(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0030)));
}

void DMA1_Channel6_IRQHandler(void)
{
    dmaHandlers.dma1Channel6IRQHandler(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x006C)));
}

void DMA1_Channel7_IRQHandler(void)
{
    dmaHandlers.dma1Channel7IRQHandler(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0080)));
}
