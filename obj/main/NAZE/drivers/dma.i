...
# 28 "./src/main/drivers/dma.c" 2

#define DEFINE_DMA_CHANNEL(d,c,f,i,r) {.dma = d, .channel = c, .handler = NULL, .flagsShift = f, .irqn = i, .rcc = r}


#define DEFINE_DMA_IRQ_HANDLER(d,c,h) void DMA ## d ## _Channel ## c ## _IRQHandler(void) { DMA_IRQHandler(h); } struct dummy
# 42 "./src/main/drivers/dma.c"
dmaChannel_t dmaChannels[] = {
    {.dma = ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0000)), .channel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0008)), .handler = ((void *)0), .flagsShift = 0, .irqn = DMA1_Channel1_IRQn, .rcc = ((uint32_t)0x00000001)},
    {.dma = ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0000)), .channel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x001C)), .handler = ((void *)0), .flagsShift = 4, .irqn = DMA1_Channel2_IRQn, .rcc = ((uint32_t)0x00000001)},
    {.dma = ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0000)), .channel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0030)), .handler = ((void *)0), .flagsShift = 8, .irqn = DMA1_Channel3_IRQn, .rcc = ((uint32_t)0x00000001)},
    {.dma = ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0000)), .channel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0044)), .handler = ((void *)0), .flagsShift = 12, .irqn = DMA1_Channel4_IRQn, .rcc = ((uint32_t)0x00000001)},
    {.dma = ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0000)), .channel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058)), .handler = ((void *)0), .flagsShift = 16, .irqn = DMA1_Channel5_IRQn, .rcc = ((uint32_t)0x00000001)},
    {.dma = ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0000)), .channel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x006C)), .handler = ((void *)0), .flagsShift = 20, .irqn = DMA1_Channel6_IRQn, .rcc = ((uint32_t)0x00000001)},
    {.dma = ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0000)), .channel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0080)), .handler = ((void *)0), .flagsShift = 24, .irqn = DMA1_Channel7_IRQn, .rcc = ((uint32_t)0x00000001)},
...
void DMA1_Channel1_IRQHandler(void) { DMA_IRQHandler((&dmaChannels[0])); } struct dummy;
void DMA1_Channel2_IRQHandler(void) { DMA_IRQHandler((&dmaChannels[1])); } struct dummy;
void DMA1_Channel3_IRQHandler(void) { DMA_IRQHandler((&dmaChannels[2])); } struct dummy;
void DMA1_Channel4_IRQHandler(void) { DMA_IRQHandler((&dmaChannels[3])); } struct dummy;
void DMA1_Channel5_IRQHandler(void) { DMA_IRQHandler((&dmaChannels[4])); } struct dummy;
void DMA1_Channel6_IRQHandler(void) { DMA_IRQHandler((&dmaChannels[5])); } struct dummy;
void DMA1_Channel7_IRQHandler(void) { DMA_IRQHandler((&dmaChannels[6])); } struct dummy;
# 89 "./src/main/drivers/dma.c"
void dmaInit(void)
{
...
void dmaSetHandler(dmaChannel_t* channel, dmaCallbackHandler_t* handler, uint8_t priority)
{
    ...
    if (!channel->handler) {
        ...
        NVIC_InitStructure.NVIC_IRQChannelSubPriority = ((((priority)>>4)&(0x0f>>(7-(((uint32_t)0x500)>>8)))));
        NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
        NVIC_Init(&NVIC_InitStructure);
    } else {
        _Bool alreadyAdded = 0;
