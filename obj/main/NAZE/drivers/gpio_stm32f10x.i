# 1 "./src/main/drivers/gpio_stm32f10x.c"
...
# 1 "./src/main/drivers/gpio_stm32f10x.c"
# 18 "./src/main/drivers/gpio_stm32f10x.c"
...
# 19 "./src/main/drivers/gpio_stm32f10x.c" 2
...
# 20 "./src/main/drivers/gpio_stm32f10x.c" 2
...
# 22 "./src/main/drivers/gpio_stm32f10x.c" 2
...
# 24 "./src/main/drivers/gpio_stm32f10x.c" 2
...
void gpioInit(GPIO_TypeDef *gpio, gpio_config_t *config)
{
    ...
    for (pinpos = 0; pinpos < 16; pinpos++) {
        ...
        if (config->pin & (0x1 << pinpos)) {
            ...
            volatile uint32_t *cr = &gpio->CRL + (pinpos / 8);
...
void gpioExtiLineConfig(uint8_t portsrc, uint8_t pinsrc)
{
    ...
    ((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EXTICR[pinsrc >> 0x02] &= ~tmp;
    ((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EXTICR[pinsrc >> 0x02] |= (((uint32_t)portsrc) << (0x04 * (pinsrc & (uint8_t)0x03)));
}
...
void gpioPinRemapConfig(uint32_t remap, _Bool enable)
{
    ...
    tmpmask = (remap & ((uint32_t)0x000F0000)) >> 0x10;
    tmp = remap & ((uint16_t)0xFFFF);

    if ((remap & (((uint32_t)0x00200000) | ((uint32_t)0x00100000))) == (((uint32_t)0x00200000) | ((uint32_t)0x00100000))) {
        tmpreg &= ((uint32_t)0xF0FFFFFF);
        ((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->MAPR &= ((uint32_t)0xF0FFFFFF);
    } else if ((remap & ((uint32_t)0x00100000)) == ((uint32_t)0x00100000)) {
