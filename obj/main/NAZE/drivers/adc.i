...
# 29 "./src/main/drivers/adc.c" 2




adc_config_t adcConfig[(ADC_CHANNEL_MAX + 1)];
volatile uint16_t adcValues[(ADC_CHANNEL_MAX + 1)];


uint16_t adcGetChannel(uint8_t channel)
{
# 53 "./src/main/drivers/adc.c"
