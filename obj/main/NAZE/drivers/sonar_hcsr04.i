...
# 32 "./src/main/drivers/sonar_hcsr04.c" 2
# 43 "./src/main/drivers/sonar_hcsr04.c"
...
void hcsr04_init(const sonarHardware_t *initialSonarHardware, sonarRange_t *sonarRange)
{
    ...
    EXTIConfig(echoIO, &hcsr04_extiCallbackRec, (((((2)<<(4-(7-(((uint32_t)0x500)>>8))))|((0)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), EXTI_Trigger_Rising_Falling);
    EXTIEnable(echoIO, 1);
