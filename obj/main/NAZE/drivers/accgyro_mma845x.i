# 1 "./src/main/drivers/accgyro_mma845x.c"
...
# 1 "./src/main/drivers/accgyro_mma845x.c"
# 18 "./src/main/drivers/accgyro_mma845x.c"
...
# 19 "./src/main/drivers/accgyro_mma845x.c" 2
...
# 20 "./src/main/drivers/accgyro_mma845x.c" 2
...
# 22 "./src/main/drivers/accgyro_mma845x.c" 2
...
# 24 "./src/main/drivers/accgyro_mma845x.c" 2
...
# 25 "./src/main/drivers/accgyro_mma845x.c" 2
...
# 26 "./src/main/drivers/accgyro_mma845x.c" 2
...
# 28 "./src/main/drivers/accgyro_mma845x.c" 2
...
static _Bool mma8452Read(int16_t *accelData);
...
static inline void mma8451ConfigureInterrupt(void)
{
    ...
    i2cWrite(0x1C, 0x2C, 0x02);
    i2cWrite(0x1C, 0x2D, 0x01);
    i2cWrite(0x1C, 0x2E, 0);
}

static void mma8452Init(void)
{

    i2cWrite(0x1C, 0x2A, 0);
    i2cWrite(0x1C, 0x0E, 0x02);
    i2cWrite(0x1C, 0x0F, 0x03);
    i2cWrite(0x1C, 0x2B, 0x02 | 0x02 << 3);

    mma8451ConfigureInterrupt();

    i2cWrite(0x1C, 0x2A, 0x04 | 0x01);
