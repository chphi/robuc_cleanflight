...
# 21 "./src/main/drivers/display_ug2864hsweg01.c" 2
...
# 23 "./src/main/drivers/display_ug2864hsweg01.c" 2
...
# 25 "./src/main/drivers/display_ug2864hsweg01.c" 2
...
unsigned char CHAR_FORMAT = 0x00;
...
static _Bool i2c_OLED_send_cmd(uint8_t command)
{
    return i2cWrite(0x3C, 0x80, command);
}

static _Bool i2c_OLED_send_byte(uint8_t val)
{
    return i2cWrite(0x3C, 0x40, val);
}
...
void i2c_OLED_set_xy(uint8_t col, uint8_t row)
{
    ...
    i2c_OLED_send_cmd(0x00 + (((5 + 1) * col) & 0x0f));
    i2c_OLED_send_cmd(0x10 + ((((5 + 1) * col) >> 4) & 0x0f));
}
