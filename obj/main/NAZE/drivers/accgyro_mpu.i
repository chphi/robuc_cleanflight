# 1 "./src/main/drivers/accgyro_mpu.c"
...
# 1 "./src/main/drivers/accgyro_mpu.c"
# 18 "./src/main/drivers/accgyro_mpu.c"
...
# 19 "./src/main/drivers/accgyro_mpu.c" 2
...
# 20 "./src/main/drivers/accgyro_mpu.c" 2
...
# 21 "./src/main/drivers/accgyro_mpu.c" 2
...
# 22 "./src/main/drivers/accgyro_mpu.c" 2
...
# 24 "./src/main/drivers/accgyro_mpu.c" 2
...
# 25 "./src/main/drivers/accgyro_mpu.c" 2
...
# 26 "./src/main/drivers/accgyro_mpu.c" 2
...
# 28 "./src/main/drivers/accgyro_mpu.c" 2
...
# 30 "./src/main/drivers/accgyro_mpu.c" 2
...
# 32 "./src/main/drivers/accgyro_mpu.c" 2
...
# 33 "./src/main/drivers/accgyro_mpu.c" 2
...
# 34 "./src/main/drivers/accgyro_mpu.c" 2
...
# 35 "./src/main/drivers/accgyro_mpu.c" 2
...
# 36 "./src/main/drivers/accgyro_mpu.c" 2
...
# 38 "./src/main/drivers/accgyro_mpu.c" 2
...
# 39 "./src/main/drivers/accgyro_mpu.c" 2
...
# 40 "./src/main/drivers/accgyro_mpu.c" 2
...
# 41 "./src/main/drivers/accgyro_mpu.c" 2
...
# 42 "./src/main/drivers/accgyro_mpu.c" 2
...
# 43 "./src/main/drivers/accgyro_mpu.c" 2
...
# 44 "./src/main/drivers/accgyro_mpu.c" 2
...
# 45 "./src/main/drivers/accgyro_mpu.c" 2



static _Bool mpuReadRegisterI2C(uint8_t reg, uint8_t length, uint8_t* data);
static _Bool mpuWriteRegisterI2C(uint8_t reg, uint8_t data);

static void mpu6050FindRevision(void);

static volatile _Bool mpuDataReady;


static _Bool detectSPISensorsAndUpdateDetectionResult(void);


mpuDetectionResult_t mpuDetectionResult;

mpuConfiguration_t mpuConfiguration;
static const extiConfig_t *mpuIntExtiConfig = ((void *)0);
...
mpuDetectionResult_t *detectMpu(const extiConfig_t *configToUse)
{
    ...
    ack = mpuReadRegisterI2C(0x75, 1, &sig);
    if (ack) {
        mpuConfiguration.read = mpuReadRegisterI2C;
        mpuConfiguration.write = mpuWriteRegisterI2C;
    } else {

        _Bool detectedSpiSensor = detectSPISensorsAndUpdateDetectionResult();
        (void)(detectedSpiSensor);


        return &mpuDetectionResult;
    }

    mpuConfiguration.gyroReadXRegister = 0x43;


    ack = mpuReadRegisterI2C(0x00, 1, &inquiryResult);
    inquiryResult &= 0x7E;
    if (ack && inquiryResult == (0x68)) {
        mpuDetectionResult.sensor = MPU_3050;
        mpuConfiguration.gyroReadXRegister = 0x1D;
        return &mpuDetectionResult;
    }
...
# 141 "./src/main/drivers/accgyro_mpu.c"
    return 0;
}
...
static void mpu6050FindRevision(void)
{
    ...
    ack = mpuConfiguration.read(0x06, 6, readBuffer);
    ...
    if (revision) {
        ...
        ack = mpuConfiguration.read(0x0C, 1, &productId);
...
void MPU_DATA_READY_EXTI_Handler(void)
{
    ...
    mpuDataReady = 1;
# 207 "./src/main/drivers/accgyro_mpu.c"
}
...
# 238 "./src/main/drivers/accgyro_mpu.c"
    ...
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = ((((((((0x0f)<<(4-(7-(((uint32_t)0x500)>>8))))|((0x0f)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0))>>(4-(7-(((uint32_t)0x500)>>8))))>>4);
    NVIC_InitStructure.NVIC_IRQChannelSubPriority = ((((((((0x0f)<<(4-(7-(((uint32_t)0x500)>>8))))|((0x0f)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0))&(0x0f>>(7-(((uint32_t)0x500)>>8))))>>4);
...
void mpuIntExtiInit(void)
{
    ...
    static _Bool mpuExtiInitDone = 0;
...
static _Bool mpuReadRegisterI2C(uint8_t reg, uint8_t length, uint8_t* data)
{
    _Bool ack = i2cRead(0x68, reg, length, data);
    return ack;
}

static _Bool mpuWriteRegisterI2C(uint8_t reg, uint8_t data)
{
    _Bool ack = i2cWrite(0x68, reg, data);
    return ack;
}
...
_Bool mpuAccRead(int16_t *accData)
{
    ...
    _Bool ack = mpuConfiguration.read(0x3B, 6, data);
    if (!ack) {
        return 0;
    }
...
_Bool mpuGyroRead(int16_t *gyroADC)
{
    ...
    _Bool ack = mpuConfiguration.read(mpuConfiguration.gyroReadXRegister, 6, data);
    if (!ack) {
        return 0;
    }
