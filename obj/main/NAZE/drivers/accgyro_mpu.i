...
# 37 "./src/main/drivers/accgyro_mpu.c" 2
...
# 46 "./src/main/drivers/accgyro_mpu.c" 2
...
# 144 "./src/main/drivers/accgyro_mpu.c"
    return 0;
}
...
void configureMPUDataReadyInterruptHandling(void)
{
    ...
    EXTIConfig(mpuIntIO, &mpuIntCallbackRec, (((((0x0f)<<(4-(7-(((uint32_t)0x500)>>8))))|((0x0f)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), EXTI_Trigger_Rising);
    EXTIEnable(mpuIntIO, 1);
