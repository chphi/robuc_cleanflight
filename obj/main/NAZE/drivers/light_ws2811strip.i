...
# 1 "./src/main/drivers/light_ws2811strip.c"
# 26 "./src/main/drivers/light_ws2811strip.c"
...
# 27 "./src/main/drivers/light_ws2811strip.c" 2
...
# 31 "./src/main/drivers/light_ws2811strip.c" 2
...
# 33 "./src/main/drivers/light_ws2811strip.c" 2
...
# 35 "./src/main/drivers/light_ws2811strip.c" 2
...
# 37 "./src/main/drivers/light_ws2811strip.c" 2
...
void ws2811LedStripInit(void)
{
    memset(&ledStripDMABuffer, 0, ((24 * 32) + 42));
    dmaSetHandler(DMA1_CH6_HANDLER, ws2811DMAHandler);
...
static void fastUpdateLEDDMABuffer(rgbColor24bpp_t *color)
{
    ...
    for (int8_t index = 23; index >= 0; index--) {
        ledStripDMABuffer[dmaBufferOffset++] = (grb & (1 << index)) ? 17 : 9;
    }
}
# 139 "./src/main/drivers/light_ws2811strip.c"
void ws2811UpdateStrip(void)
{
