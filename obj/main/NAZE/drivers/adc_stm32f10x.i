...
# 36 "./src/main/drivers/adc_stm32f10x.c" 2
# 1 "./src/main/drivers/adc_impl.h" 1
# 18 "./src/main/drivers/adc_impl.h"
       

extern adc_config_t adcConfig[4];
extern volatile uint16_t adcValues[4];
# 37 "./src/main/drivers/adc_stm32f10x.c" 2
# 50 "./src/main/drivers/adc_stm32f10x.c"
void adcInit(drv_adc_config_t *init)
{
    ...
    if (init->channelMask & ADC_CHANNEL0_ENABLE) {
        ...
        adcConfig[ADC_CHANNEL0].adcChannel = ((uint8_t)0x09);
        adcConfig[ADC_CHANNEL0].dmaIndex = configuredAdcChannels++;
        adcConfig[ADC_CHANNEL0].enabled = 1;
        adcConfig[ADC_CHANNEL0].sampleTime = ((uint8_t)0x07);
    }
    ...
    if (init->channelMask & ADC_CHANNEL1_ENABLE) {
        ...
        adcConfig[ADC_CHANNEL1].adcChannel = ((uint8_t)0x04);
        adcConfig[ADC_CHANNEL1].dmaIndex = configuredAdcChannels++;
        adcConfig[ADC_CHANNEL1].enabled = 1;
        adcConfig[ADC_CHANNEL1].sampleTime = ((uint8_t)0x07);
    }
    ...
    if (init->channelMask & ADC_CHANNEL2_ENABLE) {
        GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0002);
        GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), &GPIO_InitStructure);
        adcConfig[ADC_CHANNEL2].adcChannel = ((uint8_t)0x01);
        adcConfig[ADC_CHANNEL2].dmaIndex = configuredAdcChannels++;
        adcConfig[ADC_CHANNEL2].enabled = 1;
        adcConfig[ADC_CHANNEL2].sampleTime = ((uint8_t)0x07);
    }
    ...
    if (init->channelMask & ADC_CHANNEL3_ENABLE) {
        ...
        GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), &GPIO_InitStructure);
        adcConfig[ADC_CHANNEL3].adcChannel = ((uint8_t)0x05);
        adcConfig[ADC_CHANNEL3].dmaIndex = configuredAdcChannels++;
        adcConfig[ADC_CHANNEL3].enabled = 1;
        adcConfig[ADC_CHANNEL3].sampleTime = ((uint8_t)0x07);
    }
