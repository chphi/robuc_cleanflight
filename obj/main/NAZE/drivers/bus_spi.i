...
# 22 "./src/main/drivers/bus_spi.c" 2
...
# 24 "./src/main/drivers/bus_spi.c" 2
...
# 26 "./src/main/drivers/bus_spi.c" 2
...
# 163 "./src/main/drivers/bus_spi.c"
...
# 244 "./src/main/drivers/bus_spi.c"
    gpio_config_t gpio;


    gpio.mode = Mode_AF_PP;
    gpio.pin = ((uint16_t)0x2000) | ((uint16_t)0x8000);
    gpio.speed = Speed_50MHz;
    gpioInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), &gpio);

    gpio.pin = ((uint16_t)0x4000);
    ...
    SPI_I2S_DeInit(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)));

    spi.SPI_Direction = ((uint16_t)0x0000);
    spi.SPI_Mode = ((uint16_t)0x0104);
    spi.SPI_DataSize = ((uint16_t)0x0000);
    spi.SPI_NSS = ((uint16_t)0x0200);
    spi.SPI_BaudRatePrescaler = ((uint16_t)0x0010);
    spi.SPI_FirstBit = ((uint16_t)0x0000);
    ...
    spi.SPI_CPOL = ((uint16_t)0x0002);
    spi.SPI_CPHA = ((uint16_t)0x0001);
    ...
    SPI_Init(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), &spi);
...
_Bool spiInit(SPI_TypeDef *instance)
{
    ...
    (void)(instance);
# 310 "./src/main/drivers/bus_spi.c"
...
#define BR_CLEAR_MASK 0xFFC7
    ...
    switch (divisor) {
        case 2:
            tempRegister &= 0xFFC7;
            tempRegister |= ((uint16_t)0x0000);
            break;

        case 4:
            tempRegister &= 0xFFC7;
            tempRegister |= ((uint16_t)0x0008);
            break;

        case 8:
            tempRegister &= 0xFFC7;
            tempRegister |= ((uint16_t)0x0010);
            break;

        case 16:
            tempRegister &= 0xFFC7;
            tempRegister |= ((uint16_t)0x0018);
            break;

        case 32:
            tempRegister &= 0xFFC7;
            tempRegister |= ((uint16_t)0x0020);
            break;

        case 64:
            tempRegister &= 0xFFC7;
            tempRegister |= ((uint16_t)0x0028);
            break;

        case 128:
            tempRegister &= 0xFFC7;
            tempRegister |= ((uint16_t)0x0030);
            break;

        case 256:
            tempRegister &= 0xFFC7;
            tempRegister |= ((uint16_t)0x0038);
            break;
    }
