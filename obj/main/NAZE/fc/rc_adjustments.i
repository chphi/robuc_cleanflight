...
# 29 "./src/main/fc/rc_adjustments.c" 2
...
# 30 "./src/main/fc/rc_adjustments.c" 2
...
# 34 "./src/main/fc/rc_adjustments.c" 2
...
# 35 "./src/main/fc/rc_adjustments.c" 2
...
# 37 "./src/main/fc/rc_adjustments.c" 2
...
# 41 "./src/main/fc/rc_adjustments.c" 2
...
# 43 "./src/main/fc/rc_adjustments.c" 2
...
# 46 "./src/main/fc/rc_adjustments.c" 2
...
static adjustmentProfile_t adjustmentProfile_Storage[3]; adjustmentProfile_t *adjustmentProfile_ProfileCurrent; extern const pgRegistry_t adjustmentProfile_Registry; const pgRegistry_t adjustmentProfile_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 37 | (0 << 12), .size = sizeof(adjustmentProfile_t) | PGR_SIZE_PROFILE_FLAG, .address = (uint8_t*)&adjustmentProfile_Storage, .ptr = (uint8_t **)&adjustmentProfile_ProfileCurrent, .reset = {.ptr = 0}, };
...
void applyStepAdjustment(controlRateConfig_t *controlRateConfig, uint8_t adjustmentFunction, int delta)
{
    ...
    switch(adjustmentFunction) {
        case ADJUSTMENT_RC_RATE:
            setAdjustment(&controlRateConfig->rcRate8,ADJUSTMENT_RC_RATE,delta,0,250);
            generatePitchRollCurve();
            break;
        case ADJUSTMENT_RC_EXPO:
            setAdjustment(&controlRateConfig->rcExpo8,ADJUSTMENT_RC_EXPO,delta,0,100);
            generatePitchRollCurve();
            break;
        case ADJUSTMENT_THROTTLE_EXPO:
            setAdjustment(&controlRateConfig->thrExpo8,ADJUSTMENT_THROTTLE_EXPO,delta,0,100);
            generateThrottleCurve();
            break;
        case ADJUSTMENT_PITCH_ROLL_RATE:
        case ADJUSTMENT_PITCH_RATE:
            setAdjustment(&controlRateConfig->rates[PITCH],ADJUSTMENT_PITCH_RATE,delta,0,100);
            if (adjustmentFunction == ADJUSTMENT_PITCH_RATE) {
                break;
            }

        case ADJUSTMENT_ROLL_RATE:
            setAdjustment(&controlRateConfig->rates[ROLL],ADJUSTMENT_ROLL_RATE,delta,0,100);
            break;
        case ADJUSTMENT_YAW_RATE:
            setAdjustment(&controlRateConfig->rates[YAW],ADJUSTMENT_YAW_RATE,delta,0,255);
            break;
        case ADJUSTMENT_PITCH_ROLL_P:
        case ADJUSTMENT_PITCH_P:
            setAdjustment(&pidProfile()->P8[PIDPITCH],ADJUSTMENT_PITCH_P,delta,0,200);
            if (adjustmentFunction == ADJUSTMENT_PITCH_P) {
                break;
            }

        case ADJUSTMENT_ROLL_P:
            setAdjustment(&pidProfile()->P8[PIDROLL],ADJUSTMENT_ROLL_P,delta,0,200);
            break;
        case ADJUSTMENT_PITCH_ROLL_I:
        case ADJUSTMENT_PITCH_I:
            setAdjustment(&pidProfile()->I8[PIDPITCH],ADJUSTMENT_PITCH_I,delta,0,200);
            if (adjustmentFunction == ADJUSTMENT_PITCH_I) {
                break;
            }

        case ADJUSTMENT_ROLL_I:
           setAdjustment(&pidProfile()->I8[PIDROLL],ADJUSTMENT_ROLL_I,delta,0,200);
            break;
        case ADJUSTMENT_PITCH_ROLL_D:
        case ADJUSTMENT_PITCH_D:
            setAdjustment(&pidProfile()->D8[PIDPITCH],ADJUSTMENT_PITCH_D,delta,0,200);
            if (adjustmentFunction == ADJUSTMENT_PITCH_D) {
                break;
            }

        case ADJUSTMENT_ROLL_D:
            setAdjustment(&pidProfile()->D8[PIDROLL],ADJUSTMENT_ROLL_D,delta,0,200);
            break;
    }
    ...
    if (ptr) {
        setAdjustment(ptr,adjustmentFunction,delta,0,200);
    }
