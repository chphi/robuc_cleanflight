...
# 29 "./src/main/fc/rc_controls.c" 2
...
# 30 "./src/main/fc/rc_controls.c" 2
...
# 33 "./src/main/fc/rc_controls.c" 2
...
# 35 "./src/main/fc/rc_controls.c" 2
...
# 39 "./src/main/fc/rc_controls.c" 2
...
# 47 "./src/main/fc/rc_controls.c" 2
...
# 53 "./src/main/fc/rc_controls.c" 2
...
# 62 "./src/main/fc/rc_controls.c" 2
...
extern const armingConfig_t pgResetTemplate_armingConfig; armingConfig_t armingConfig_System; extern const pgRegistry_t armingConfig_Registry; const pgRegistry_t armingConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 16 | (0 << 12), .size = sizeof(armingConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&armingConfig_System, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_armingConfig}, };

extern const rcControlsConfig_t pgResetTemplate_rcControlsConfig; static rcControlsConfig_t rcControlsConfig_Storage[3]; rcControlsConfig_t *rcControlsConfig_ProfileCurrent; extern const pgRegistry_t rcControlsConfig_Registry; const pgRegistry_t rcControlsConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 25 | (0 << 12), .size = sizeof(rcControlsConfig_t) | PGR_SIZE_PROFILE_FLAG, .address = (uint8_t*)&rcControlsConfig_Storage, .ptr = (uint8_t **)&rcControlsConfig_ProfileCurrent, .reset = {.ptr = (void*)&pgResetTemplate_rcControlsConfig}, };
static modeActivationProfile_t modeActivationProfile_Storage[3]; modeActivationProfile_t *modeActivationProfile_ProfileCurrent; extern const pgRegistry_t modeActivationProfile_Registry; const pgRegistry_t modeActivationProfile_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 41 | (0 << 12), .size = sizeof(modeActivationProfile_t) | PGR_SIZE_PROFILE_FLAG, .address = (uint8_t*)&modeActivationProfile_Storage, .ptr = (uint8_t **)&modeActivationProfile_ProfileCurrent, .reset = {.ptr = 0}, };
...
static uint32_t rcModeActivationMask;

const rcControlsConfig_t pgResetTemplate_rcControlsConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .deadband = 0, .yaw_deadband = 0, .alt_hold_deadband = 40, .alt_hold_fast_change = 1, .yaw_control_direction = 1, .deadband3d_throttle = 50, }
...
const armingConfig_t pgResetTemplate_armingConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .disarm_kill_switch = 1, .auto_disarm_delay = 5, .max_arm_angle = 25, }
