...
# 31 "./src/main/fc/fc_debug.c" 2

debugConfig_t debugConfig_System; extern const pgRegistry_t debugConfig_Registry; const pgRegistry_t debugConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 51 | (0 << 12), .size = sizeof(debugConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&debugConfig_System, .ptr = 0, .reset = {.ptr = 0}, };
