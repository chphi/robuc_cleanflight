...
# 19 "./src/main/fc/rate_profile.c" 2
...
# 20 "./src/main/fc/rate_profile.c" 2
...
# 21 "./src/main/fc/rate_profile.c" 2
# 1 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\lib\\gcc\\arm-none-eabi\\4.8.4\\include\\stddef.h" 1 3 4
# 22 "./src/main/fc/rate_profile.c" 2
...
# 24 "./src/main/fc/rate_profile.c" 2
...
# 26 "./src/main/fc/rate_profile.c" 2
...
# 28 "./src/main/fc/rate_profile.c" 2
...
# 29 "./src/main/fc/rate_profile.c" 2
...
# 30 "./src/main/fc/rate_profile.c" 2
...
# 31 "./src/main/fc/rate_profile.c" 2
...
# 34 "./src/main/fc/rate_profile.c" 2
...
# 35 "./src/main/fc/rate_profile.c" 2

static rateProfileSelection_t rateProfileSelection_Storage[3]; rateProfileSelection_t *rateProfileSelection_ProfileCurrent; extern const pgRegistry_t rateProfileSelection_Registry; const pgRegistry_t rateProfileSelection_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 36 | (0 << 12), .size = sizeof(rateProfileSelection_t) | PGR_SIZE_PROFILE_FLAG, .address = (uint8_t*)&rateProfileSelection_Storage, .ptr = (uint8_t **)&rateProfileSelection_ProfileCurrent, .reset = {.ptr = 0}, };
extern void pgResetFn_controlRateProfiles(controlRateConfig_t *); controlRateConfig_t controlRateProfiles_SystemArray[3]; extern const pgRegistry_t controlRateProfiles_Registry; const pgRegistry_t controlRateProfiles_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 12 | (0 << 12), .size = (sizeof(controlRateConfig_t) * 3) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&controlRateProfiles_SystemArray, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_controlRateProfiles}, };
...
{
    for (int i = 0; i < 3; i++) {
        static const controlRateConfig_t _reset_template_50 = { .rcRate8 = 90, .rcExpo8 = 65, .thrMid8 = 50, .tpa_breakpoint = 1500, }; memcpy((&instance[i]), &_reset_template_50, sizeof(*(&instance[i])));
...
void configureRateProfileSelection(uint8_t profileIndex, uint8_t rateProfileIndex)
{
    rateProfileSelection_Storage[profileIndex].defaultRateProfileIndex = rateProfileIndex % 3;
}
