...
# 26 "./src/main/fc/fc_tasks.c" 2





#define TASK_QUEUE_ARRAY_SIZE (TASK_COUNT + 1)


const uint32_t taskQueueArraySize = (TASK_COUNT + 1);
...
cfTask_t cfTasks[] = {
    ...
    [TASK_ALTITUDE] = {
        ...
        .desiredPeriod = ((25) * 1000),
        .staticPriority = TASK_PRIORITY_MEDIUM,
    },
# 187 "./src/main/fc/fc_tasks.c"
    [TASK_TELEMETRY] = {
        .taskName = "TELEMETRY",
        .taskFunc = taskTelemetry,
        .desiredPeriod = ((4) * 1000),
