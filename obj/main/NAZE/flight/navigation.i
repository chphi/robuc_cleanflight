...
# 27 "./src/main/flight/navigation.c" 2
...
# 30 "./src/main/flight/navigation.c" 2
...
# 33 "./src/main/flight/navigation.c" 2
...
# 38 "./src/main/flight/navigation.c" 2
...
# 47 "./src/main/flight/navigation.c" 2
...
# 51 "./src/main/flight/navigation.c" 2
...
void mwDisarm(void);
# 58 "./src/main/flight/navigation.c" 2
...
# 100 "./src/main/flight/navigation.c"
...
# 418 "./src/main/flight/navigation.c"
static void GPS_calc_longitude_scaling(int32_t lat)
{
...
# 483 "./src/main/flight/navigation.c"
static void GPS_calc_velocity(void)
{
...
# 517 "./src/main/flight/navigation.c"
static void GPS_calc_location_error(int32_t *target_lat, int32_t *target_lng, int32_t *gps_lat, int32_t *gps_lng)
{
...
# 610 "./src/main/flight/navigation.c"
static uint16_t GPS_calc_desired_speed(uint16_t max_speed, _Bool _slow)
{
...
void updateGpsWaypointsAndMode(void)
{
    ...
    if ((stateFlags & (GPS_FIX)) && GPS_numSat >= 5) {
        ...
        if (((1 << (BOXGPSHOME)) & rcModeActivationMask)) {
            ...
            if (((1 << (BOXGPSHOLD)) & rcModeActivationMask) && areSticksInApModePosition(gpsProfile->ap_mode)) {
