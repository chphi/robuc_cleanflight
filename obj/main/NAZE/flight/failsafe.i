...
# 21 "./src/main/flight/failsafe.c" 2
...
# 23 "./src/main/flight/failsafe.c" 2
...
# 25 "./src/main/flight/failsafe.c" 2
...
# 27 "./src/main/flight/failsafe.c" 2
...
# 30 "./src/main/flight/failsafe.c" 2
...
void mwDisarm(void);
# 40 "./src/main/flight/failsafe.c" 2
...
# 43 "./src/main/flight/failsafe.c" 2
# 55 "./src/main/flight/failsafe.c"
static failsafeState_t failsafeState;

extern const failsafeConfig_t pgResetTemplate_failsafeConfig; failsafeConfig_t failsafeConfig_System; extern const pgRegistry_t failsafeConfig_Registry; const pgRegistry_t failsafeConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 1 | (0 << 12), .size = sizeof(failsafeConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&failsafeConfig_System, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_failsafeConfig}, };

const failsafeConfig_t pgResetTemplate_failsafeConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .failsafe_delay = 10, .failsafe_off_delay = 200, .failsafe_throttle = 1000, .failsafe_throttle_low_delay = 100, }
...
void failsafeStartMonitoring(void)
{
    failsafeState.monitoring = 1;
}

static _Bool failsafeShouldHaveCausedLandingByNow(void)
{
...
void failsafeUpdateState(void)
{
    ...
    _Bool receivingRxData = failsafeIsReceivingRxData();
    _Bool armed = (armingFlags & (ARMED));
    _Bool failsafeSwitchIsOn = rcModeIsActive(BOXFAILSAFE);
