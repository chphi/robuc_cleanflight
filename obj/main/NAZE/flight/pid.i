...
# 6 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\math.h" 2 3
# 1 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\machine\\ieeefp.h" 1 3
# 7 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\math.h" 2 3
# 1 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\_ansi.h" 1 3
# 8 "c:\\dev\\gcc-arm-none-eabi-4_8-2014q2\\arm-none-eabi\\include\\math.h" 2 3
...
# 100 "./src/main/config/config_unittest.h"
...
float scaleItermToRcInput(int axis) {
    ...
    if (!antiWindUpIncrement) {
        antiWindUpIncrement = (0.001 / 500) * targetLooptime;
    }

    if (((rcCommandDeflection) > 0 ? (rcCommandDeflection) : -(rcCommandDeflection)) > 0.7f && (!flightModeFlags)) {
...
void filterIsSetCheck(pidProfile_t *pidProfile) {
    static _Bool deltaStateIsSet = 0;
        ...
        uint16_t max_angle_inclination, rollAndPitchTrims_t *angleTrim, rxConfig_t *rxConfig)
{
    ...
    if ((flightModeFlags & (HORIZON_MODE))) {
        ...
        if(((stickPosAil) > 0 ? (stickPosAil) : -(stickPosAil)) > ((stickPosEle) > 0 ? (stickPosEle) : -(stickPosEle))){
            mostDeflectedPos = ((stickPosAil) > 0 ? (stickPosAil) : -(stickPosAil));
        }
        else {
            mostDeflectedPos = ((stickPosEle) > 0 ? (stickPosEle) : -(stickPosEle));
        }
    ...
    for (axis = 0; axis < 3; axis++) {
        ...
        if (((1 << (BOXAIRMODE)) & rcModeActivationMask)) {
            ...
            if ((stateFlags & (ANTI_WINDUP)) || motorLimitReached) {
                ...
                errorGyroIfLimit[axis] = ((errorGyroIf[axis]) > 0 ? (errorGyroIf[axis]) : -(errorGyroIf[axis]));
            }
        }
