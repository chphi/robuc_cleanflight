...
extern const pidProfile_t pgResetTemplate_pidProfile; static pidProfile_t pidProfile_Storage[3]; pidProfile_t *pidProfile_ProfileCurrent; extern const pgRegistry_t pidProfile_Registry; const pgRegistry_t pidProfile_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 14 | (0 << 12), .size = sizeof(pidProfile_t) | PGR_SIZE_PROFILE_FLAG, .address = (uint8_t*)&pidProfile_Storage, .ptr = (uint8_t **)&pidProfile_ProfileCurrent, .reset = {.ptr = (void*)&pgResetTemplate_pidProfile}, };

const pidProfile_t pgResetTemplate_pidProfile __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .pidController = 0, .P8[PIDROLL] = 40, .I8[PIDROLL] = 30, .D8[PIDROLL] = 23, .P8[PIDPITCH] = 40, .I8[PIDPITCH] = 30, .D8[PIDPITCH] = 23, .P8[PIDYAW] = 85, .I8[PIDYAW] = 45, .D8[PIDYAW] = 0, .P8[PIDALT] = 50, .I8[PIDALT] = 0, .D8[PIDALT] = 0, .P8[PIDPOS] = 15, .I8[PIDPOS] = 0, .D8[PIDPOS] = 0, .P8[PIDPOSR] = 34, .I8[PIDPOSR] = 14, .D8[PIDPOSR] = 53, .P8[PIDNAVR] = 25, .I8[PIDNAVR] = 33, .D8[PIDNAVR] = 83, .P8[PIDLEVEL] = 20, .I8[PIDLEVEL] = 10, .D8[PIDLEVEL] = 75, .P8[PIDMAG] = 40, .P8[PIDVEL] = 120, .I8[PIDVEL] = 45, .D8[PIDVEL] = 1, .yaw_p_limit = 500, .yaw_lpf_hz = 0, .dterm_filter_type = FILTER_BIQUAD, .dterm_lpf_hz = 100, .dterm_notch_hz = 260, .dterm_notch_cutoff = 160, .deltaMethod = PID_DELTA_FROM_MEASUREMENT, .horizon_tilt_effect = 75, .horizon_tilt_mode = HORIZON_TILT_MODE_SAFE, }
# 113 "./src/main/flight/pid.c"
 ;
        ...
        uint8_t horizonTiltMode, int horizonSensitivity)
{
    ...
    const int32_t mostDeflectedPos = ((((stickPosAil) > 0 ? (stickPosAil) : -(stickPosAil))) > (((stickPosEle) > 0 ? (stickPosEle) : -(stickPosEle))) ? (((stickPosAil) > 0 ? (stickPosAil) : -(stickPosAil))) : (((stickPosEle) > 0 ? (stickPosEle) : -(stickPosEle))));


    int horizonLevelStrength = (500 - mostDeflectedPos) / 5;


    const int currentInclination = ((((attitude.values.roll) > 0 ? (attitude.values.roll) : -(attitude.values.roll))) > (((attitude.values.pitch) > 0 ? (attitude.values.pitch) : -(attitude.values.pitch))) ? (((attitude.values.roll) > 0 ? (attitude.values.roll) : -(attitude.values.roll))) : (((attitude.values.pitch) > 0 ? (attitude.values.pitch) : -(attitude.values.pitch))))
                                                                           ;
