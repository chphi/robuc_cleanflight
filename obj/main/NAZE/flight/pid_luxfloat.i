# 1 "./src/main/flight/pid_luxfloat.c"
...
# 1 "./src/main/flight/pid_luxfloat.c"
# 18 "./src/main/flight/pid_luxfloat.c"
...
# 21 "./src/main/flight/pid_luxfloat.c" 2
...
# 22 "./src/main/flight/pid_luxfloat.c" 2
...
# 23 "./src/main/flight/pid_luxfloat.c" 2
...
# 24 "./src/main/flight/pid_luxfloat.c" 2
...
# 26 "./src/main/flight/pid_luxfloat.c" 2
...
# 28 "./src/main/flight/pid_luxfloat.c" 2
...
# 30 "./src/main/flight/pid_luxfloat.c" 2
...
# 31 "./src/main/flight/pid_luxfloat.c" 2
...
# 32 "./src/main/flight/pid_luxfloat.c" 2
...
# 34 "./src/main/flight/pid_luxfloat.c" 2
...
# 36 "./src/main/flight/pid_luxfloat.c" 2
...
# 37 "./src/main/flight/pid_luxfloat.c" 2
...
# 38 "./src/main/flight/pid_luxfloat.c" 2
...
# 40 "./src/main/flight/pid_luxfloat.c" 2
...
# 41 "./src/main/flight/pid_luxfloat.c" 2
...
# 42 "./src/main/flight/pid_luxfloat.c" 2
...
# 44 "./src/main/flight/pid_luxfloat.c" 2
...
void mwDisarm(void);
# 46 "./src/main/flight/pid_luxfloat.c" 2
...
# 47 "./src/main/flight/pid_luxfloat.c" 2
...
# 48 "./src/main/flight/pid_luxfloat.c" 2
...
# 52 "./src/main/flight/pid_luxfloat.c" 2
...
# 53 "./src/main/flight/pid_luxfloat.c" 2
...
# 54 "./src/main/flight/pid_luxfloat.c" 2
...
# 55 "./src/main/flight/pid_luxfloat.c" 2
...
static const float luxGyroScale = 16.4f / 4;
...
static int16_t pidLuxFloatCore(int axis, const pidProfile_t *pidProfile, float gyroRate, float angleRate)
{
    ...
    ITerm = constrainf(ITerm, -256, 256);

    if (rcModeIsActive(BOXAIRMODE)) {
        if ((stateFlags & (ANTI_WINDUP)) || motorLimitReached) {
            ITerm = constrainf(ITerm, -ITermLimitf[axis], ITermLimitf[axis]);
        } else {
            ITermLimitf[axis] = ((ITerm) > 0 ? (ITerm) : -(ITerm));
        }
    }
    ...
    if (pidProfile->D8[axis] == 0) {
        ...
        DTerm = constrainf(DTerm, -512, 512);
    }
