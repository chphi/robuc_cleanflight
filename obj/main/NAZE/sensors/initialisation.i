...
# 30 "./src/main/sensors/initialisation.c" 2
...
# 212 "./src/main/drivers/accgyro_lsm303dlhc.h"
...
# 441 "./src/main/drivers/accgyro_lsm303dlhc.h"
...
# 48 "./src/main/sensors/initialisation.c" 2
...
# 53 "./src/main/sensors/initialisation.c" 2
...
# 58 "./src/main/sensors/initialisation.c" 2
...
# 65 "./src/main/sensors/initialisation.c" 2
...
# 67 "./src/main/sensors/initialisation.c" 2
...
_Bool sensorsAutodetect(sensorAlignmentConfig_t *sensorAlignmentConfig, uint8_t gyroLpf,
...
const extiConfig_t *selectMPUIntExtiConfig(void)
{
    ...
    static const extiConfig_t nazeRev4MPUIntExtiConfig = {
            ...
            .exti_port_source = ((uint8_t)0x01),
            .exti_line = ((uint32_t)0x02000),
            .exti_pin_source = ((uint8_t)0x0D),
...
# 167 "./src/main/sensors/initialisation.c"
    return ((void *)0);
}
# 213 "./src/main/sensors/initialisation.c"
_Bool detectGyro(void)
{
    ...
    switch(gyroHardware) {
        ...
        case GYRO_MPU6050:
            ...
            ;
        case GYRO_L3G4200D:
# 243 "./src/main/sensors/initialisation.c"
            ;
        ...
        case GYRO_L3GD20:
# 267 "./src/main/sensors/initialisation.c"
            ;

        case GYRO_MPU6000:
# 279 "./src/main/sensors/initialisation.c"
            ;
...
retry:
    ...
    switch (accHardwareToUse) {
        ...
        case ACC_ADXL345:
            ...
            ;
        case ACC_LSM303DLHC:
# 371 "./src/main/sensors/initialisation.c"
            ;
        case ACC_MPU6050:
        ...
        case ACC_BMA280:
            ...
            ;
        case ACC_MPU6000:
# 420 "./src/main/sensors/initialisation.c"
            ;
        case ACC_MPU6500:
...
static void detectMag(magSensor_e magHardwareToUse)
{
    ...
    static const hmc5883Config_t nazeHmc5883Config_v5 = {
            ...
            .gpioPort = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),
            .exti_port_source = ((uint8_t)0x02),
            .exti_line = ((uint32_t)0x04000),
            .exti_pin_source = ((uint8_t)0x0E),
            .exti_irqn = EXTI15_10_IRQn
    };
    if (hardwareRevision < NAZE32_REV5) {
...
# 598 "./src/main/sensors/initialisation.c"
retry:
    ...
    switch(magHardwareToUse) {
        ...
        case MAG_AK8975:
# 628 "./src/main/sensors/initialisation.c"
            ;
...
_Bool sensorsAutodetect(sensorAlignmentConfig_t *sensorAlignmentConfig, uint8_t gyroLpf, uint8_t accHardwareToUse, uint8_t magHardwareToUse, uint8_t baroHardwareToUse,
        int16_t magDeclinationFromConfig,
        uint32_t looptime, uint8_t gyroSync, uint8_t gyroSyncDenominator) {
    ...
    gyroUpdateSampleRate(looptime, gyroLpf, gyroSync, gyroSyncDenominator);
    gyro.init(gyroLpf);
