...
# 1 "./src/main/sensors/initialisation.c"
# 17 "./src/main/sensors/initialisation.c"
...
# 18 "./src/main/sensors/initialisation.c" 2
...
# 22 "./src/main/sensors/initialisation.c" 2
...
# 24 "./src/main/sensors/initialisation.c" 2
...
# 26 "./src/main/sensors/initialisation.c" 2
...
# 28 "./src/main/sensors/initialisation.c" 2
...
# 33 "./src/main/sensors/initialisation.c" 2
...
# 1 "./src/main/drivers/accgyro_adxl345.h" 1
# 18 "./src/main/drivers/accgyro_adxl345.h"
...
_Bool adxl345Detect(drv_adxl345_config_t *init, acc_t *acc);
# 38 "./src/main/sensors/initialisation.c" 2
# 1 "./src/main/drivers/accgyro_bma280.h" 1
# 18 "./src/main/drivers/accgyro_bma280.h"
       

_Bool bma280Detect(acc_t *acc);
# 39 "./src/main/sensors/initialisation.c" 2
# 1 "./src/main/drivers/accgyro_l3g4200d.h" 1
# 18 "./src/main/drivers/accgyro_l3g4200d.h"
       

_Bool l3g4200dDetect(gyro_t *gyro);
# 40 "./src/main/sensors/initialisation.c" 2
# 1 "./src/main/drivers/accgyro_mma845x.h" 1
# 18 "./src/main/drivers/accgyro_mma845x.h"
       

_Bool mma8452Detect(acc_t *acc);
# 41 "./src/main/sensors/initialisation.c" 2
# 1 "./src/main/drivers/accgyro_mpu.h" 1
# 18 "./src/main/drivers/accgyro_mpu.h"
...
typedef _Bool (*mpuReadRegisterFunc)(uint8_t reg, uint8_t length, uint8_t* data);
typedef _Bool (*mpuWriteRegisterFunc)(uint8_t reg, uint8_t data);
...
_Bool mpuAccRead(int16_t *accData);
_Bool mpuGyroRead(int16_t *gyroADC);
mpuDetectionResult_t *detectMpu(const extiConfig_t *configToUse);
# 42 "./src/main/sensors/initialisation.c" 2
# 1 "./src/main/drivers/accgyro_mpu3050.h" 1
# 18 "./src/main/drivers/accgyro_mpu3050.h"
...
_Bool mpu3050Detect(gyro_t *gyro);
# 43 "./src/main/sensors/initialisation.c" 2
# 1 "./src/main/drivers/accgyro_mpu6050.h" 1
# 18 "./src/main/drivers/accgyro_mpu6050.h"
       

_Bool mpu6050AccDetect(acc_t *acc);
_Bool mpu6050GyroDetect(gyro_t *gyro);
# 44 "./src/main/sensors/initialisation.c" 2
# 1 "./src/main/drivers/accgyro_mpu6500.h" 1
# 18 "./src/main/drivers/accgyro_mpu6500.h"
#define MPU6500_WHO_AM_I_CONST (0x70)
...
_Bool mpu6500AccDetect(acc_t *acc);
_Bool mpu6500GyroDetect(gyro_t *gyro);

void mpu6500AccInit(acc_t *acc);
void mpu6500GyroInit(gyro_t* gyro, uint8_t lpf);
# 45 "./src/main/sensors/initialisation.c" 2
# 1 "./src/main/drivers/accgyro_l3gd20.h" 1
# 18 "./src/main/drivers/accgyro_l3gd20.h"
       

_Bool l3gd20Detect(gyro_t *gyro);
# 46 "./src/main/sensors/initialisation.c" 2
# 1 "./src/main/drivers/accgyro_lsm303dlhc.h" 1
# 18 "./src/main/drivers/accgyro_lsm303dlhc.h"
...
# 75 "./src/main/drivers/accgyro_lsm303dlhc.h"
...
# 203 "./src/main/drivers/accgyro_lsm303dlhc.h"
...
# 432 "./src/main/drivers/accgyro_lsm303dlhc.h"
...
_Bool lsm303dlhcAccDetect(acc_t *acc);
# 47 "./src/main/sensors/initialisation.c" 2
...
# 49 "./src/main/sensors/initialisation.c" 2
# 1 "./src/main/drivers/accgyro_spi_mpu6000.h" 1
...
_Bool mpu6000SpiDetect(void);

_Bool mpu6000SpiAccDetect(acc_t *acc);
_Bool mpu6000SpiGyroDetect(gyro_t *gyro);

_Bool mpu6000WriteRegister(uint8_t reg, uint8_t data);
_Bool mpu6000ReadRegister(uint8_t reg, uint8_t length, uint8_t *data);
# 50 "./src/main/sensors/initialisation.c" 2
# 1 "./src/main/drivers/accgyro_spi_mpu6500.h" 1
# 18 "./src/main/drivers/accgyro_spi_mpu6500.h"
       

_Bool mpu6500SpiDetect(void);

_Bool mpu6500SpiAccDetect(acc_t *acc);
_Bool mpu6500SpiGyroDetect(gyro_t *gyro);

_Bool mpu6500WriteRegister(uint8_t reg, uint8_t data);
_Bool mpu6500ReadRegister(uint8_t reg, uint8_t length, uint8_t *data);
# 51 "./src/main/sensors/initialisation.c" 2
...
# 52 "./src/main/sensors/initialisation.c" 2

# 1 "./src/main/drivers/barometer.h" 1
# 18 "./src/main/drivers/barometer.h"
...
# 54 "./src/main/sensors/initialisation.c" 2
# 1 "./src/main/drivers/barometer_bmp085.h" 1
# 18 "./src/main/drivers/barometer_bmp085.h"
...
_Bool bmp085Detect(const bmp085Config_t *config, baro_t *baro);
void bmp085Disable(const bmp085Config_t *config);


_Bool bmp085TestEOCConnected(const bmp085Config_t *config);
# 55 "./src/main/sensors/initialisation.c" 2
# 1 "./src/main/drivers/barometer_bmp280.h" 1
# 18 "./src/main/drivers/barometer_bmp280.h"
       

_Bool bmp280Detect(baro_t *baro);
# 56 "./src/main/sensors/initialisation.c" 2
# 1 "./src/main/drivers/barometer_ms5611.h" 1
# 18 "./src/main/drivers/barometer_ms5611.h"
       

_Bool ms5611Detect(baro_t *baro);
# 57 "./src/main/sensors/initialisation.c" 2
...
# 59 "./src/main/sensors/initialisation.c" 2
# 1 "./src/main/drivers/compass_hmc5883l.h" 1
# 18 "./src/main/drivers/compass_hmc5883l.h"
...
_Bool hmc5883lDetect(mag_t* mag, const hmc5883Config_t *hmc5883ConfigToUse);
_Bool hmc5883lInit(void);
_Bool hmc5883lRead(int16_t *magData);
# 60 "./src/main/sensors/initialisation.c" 2
# 1 "./src/main/drivers/compass_ak8975.h" 1
# 18 "./src/main/drivers/compass_ak8975.h"
       

_Bool ak8975Detect(mag_t *mag);
_Bool ak8975Init(void);
_Bool ak8975Read(int16_t *magData);
# 61 "./src/main/sensors/initialisation.c" 2
# 1 "./src/main/drivers/compass_ak8963.h" 1
# 18 "./src/main/drivers/compass_ak8963.h"
       

_Bool ak8963Detect(mag_t *mag);
_Bool ak8963Init(void);
_Bool ak8963Read(int16_t *magData);
# 62 "./src/main/sensors/initialisation.c" 2
...
# 64 "./src/main/sensors/initialisation.c" 2
...
void mwDisarm(void);
# 66 "./src/main/sensors/initialisation.c" 2
...
# 68 "./src/main/sensors/initialisation.c" 2
...
# 69 "./src/main/sensors/initialisation.c" 2
...
# 70 "./src/main/sensors/initialisation.c" 2
...
# 71 "./src/main/sensors/initialisation.c" 2
...
# 72 "./src/main/sensors/initialisation.c" 2
...
# 77 "./src/main/sensors/initialisation.c" 2


extern baro_t baro;
extern mag_t mag;

uint8_t detectedSensors[(SENSOR_INDEX_MAG + 1)] = { GYRO_NONE, ACC_NONE, BARO_NONE, MAG_NONE };
...
const extiConfig_t *selectMPUIntExtiConfig(void)
{
    ...
    static const extiConfig_t nazeRev4MPUIntExtiConfig = {
            .gpioAPB2Peripherals = ((uint32_t)0x00000008),
            .gpioPin = Pin_13,
            .gpioPort = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),
            .io = ((((1) + 1) << 4) | (13)),
    };

    static const extiConfig_t nazeRev5MPUIntExtiConfig = {
            .gpioAPB2Peripherals = ((uint32_t)0x00000010),
            .gpioPin = Pin_13,
            .gpioPort = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),
            .io = ((((2) + 1) << 4) | (13)),
    };
...
# 172 "./src/main/sensors/initialisation.c"
    return ((void *)0);
}
# 224 "./src/main/sensors/initialisation.c"
_Bool detectGyro(void)
{
    ...
    switch(gyroHardware) {
        ...
        case GYRO_MPU6050:
            ...
            ;
        case GYRO_L3G4200D:
# 254 "./src/main/sensors/initialisation.c"
            ;
        ...
        case GYRO_L3GD20:
# 278 "./src/main/sensors/initialisation.c"
            ;

        case GYRO_MPU6000:
# 290 "./src/main/sensors/initialisation.c"
            ;
...
static _Bool detectAcc(accelerationSensor_e accHardwareToUse)
{
    _Bool sensorDetected;
    (void)(sensorDetected);
...
retry:
    ...
    switch (accHardwareToUse) {
        ...
        case ACC_ADXL345:
            ...
            ;
        case ACC_LSM303DLHC:
# 382 "./src/main/sensors/initialisation.c"
            ;
        case ACC_MPU6050:
        ...
        case ACC_BMA280:
            ...
            ;
        case ACC_MPU6000:
# 431 "./src/main/sensors/initialisation.c"
            ;
        case ACC_MPU6500:
...
static _Bool detectBaro(baroSensor_e baroHardwareToUse)
{
    ...
    const bmp085Config_t *bmp085Config = ((void *)0);


    static const bmp085Config_t defaultBMP085Config = {
            .gpioAPB2Peripherals = ((uint32_t)0x00000010),
            .xclrGpioPin = Pin_13,
            .xclrGpioPort = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),
            .eocGpioPin = Pin_14,
            .eocGpioPort = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))
    };
...
static _Bool detectMag(magSensor_e magHardwareToUse)
{
...
# 610 "./src/main/sensors/initialisation.c"
retry:
    ...
    switch(magHardwareToUse) {
        ...
        case MAG_AK8975:
# 640 "./src/main/sensors/initialisation.c"
            ;

        case MAG_AK8963:
# 652 "./src/main/sensors/initialisation.c"
            ;
