...
# 21 "./src/main/sensors/battery.c" 2
...
# 23 "./src/main/sensors/battery.c" 2
...
# 29 "./src/main/sensors/battery.c" 2
...
# 33 "./src/main/sensors/battery.c" 2
...
# 43 "./src/main/sensors/battery.c" 2
...
void amperageMeterInit(void);
# 44 "./src/main/sensors/battery.c" 2
...
extern const batteryConfig_t pgResetTemplate_batteryConfig; batteryConfig_t batteryConfig_System; extern const pgRegistry_t batteryConfig_Registry; const pgRegistry_t batteryConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 11 | (1 << 12), .size = sizeof(batteryConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&batteryConfig_System, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_batteryConfig}, };

const batteryConfig_t pgResetTemplate_batteryConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .vbatmaxcellvoltage = 43, .vbatmincellvoltage = 33, .vbatwarningcellvoltage = 35, .vbathysteresis = 1, }
...
void batteryUpdate(void)
{
    ...
    vbat = getVoltageForADCChannel(ADC_CHANNEL1);
    ...
    if (batteryState == BATTERY_NOT_PRESENT && vbat > 10)
    {
        ...
        uint16_t vbatLatestVoltage = getLatestVoltageForADCChannel(ADC_CHANNEL1);
