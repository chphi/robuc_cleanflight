...
static _Bool gyroFilterStateIsSet;
...
_Bool isOnFinalGyroCalibrationCycle(void)
{
    return calibratingG == 1;
}

_Bool isOnFirstGyroCalibrationCycle(void)
{
