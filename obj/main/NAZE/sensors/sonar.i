...
static int16_t sonarMaxTiltDeciDegrees;
float sonarMaxTiltCos;

static int32_t calculatedAltitude;

const sonarHardware_t *sonarGetHardwareConfiguration(_Bool usingCurrentMeterIOPins)
{

    static const sonarHardware_t const sonarPWM = {
        .trigger_pin = Pin_8,
        .trigger_gpio = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),
        .echo_pin = Pin_9,
        .echo_gpio = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),
        .triggerIO = ((((1) + 1) << 4) | (8)),
        .echoIO = ((((1) + 1) << 4) | (9)),
    };
...
void sonarInit(const sonarHardware_t *sonarHardware)
{
    ...
    sonarMaxTiltCos = cosf(sonarMaxTiltDeciDegrees / 10.0f * (3.14159265358979323846f / 180.0f));
