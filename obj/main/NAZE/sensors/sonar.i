...
const sonarHardware_t *sonarGetHardwareConfiguration(batteryConfig_t *batteryConfig)
{
    ...
    static const sonarHardware_t const sonarPWM56 = {
        ...
        .exti_line = ((uint32_t)0x00200),
        .exti_pin_source = ((uint8_t)0x09),
    ...
    static const sonarHardware_t sonarRC78 = {
        ...
        .echo_pin = Pin_1,
        .echo_gpio = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),
        .exti_line = ((uint32_t)0x00002),
        .exti_pin_source = ((uint8_t)0x01),
