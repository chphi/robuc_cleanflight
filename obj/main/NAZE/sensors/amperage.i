...
# 1 "./src/main/sensors/amperage.c"
# 18 "./src/main/sensors/amperage.c"
...
# 19 "./src/main/sensors/amperage.c" 2
...
# 20 "./src/main/sensors/amperage.c" 2
...
# 21 "./src/main/sensors/amperage.c" 2
...
# 23 "./src/main/sensors/amperage.c" 2
...
# 24 "./src/main/sensors/amperage.c" 2
...
# 26 "./src/main/sensors/amperage.c" 2
...
# 28 "./src/main/sensors/amperage.c" 2
...
# 29 "./src/main/sensors/amperage.c" 2
...
# 31 "./src/main/sensors/amperage.c" 2
...
# 32 "./src/main/sensors/amperage.c" 2
...
# 33 "./src/main/sensors/amperage.c" 2
...
void amperageMeterInit(void);
# 35 "./src/main/sensors/amperage.c" 2

amperageMeter_t amperageMeters[2];

extern void pgResetFn_amperageMeterConfig(amperageMeterConfig_t *); amperageMeterConfig_t amperageMeterConfig_SystemArray[2]; extern const pgRegistry_t amperageMeterConfig_Registry; const pgRegistry_t amperageMeterConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 50 | (0 << 12), .size = (sizeof(amperageMeterConfig_t) * 2) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&amperageMeterConfig_SystemArray, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_amperageMeterConfig}, };

void pgResetFn_amperageMeterConfig(amperageMeterConfig_t *instance)
{
    for (int i = 0; i < 2; i++) {
        if (i == AMPERAGE_METER_ADC) {
            static const amperageMeterConfig_t _reset_template_46 = { .scale = 400, }; memcpy((&instance[i]), &_reset_template_46, sizeof(*(&instance[i])));
...
int32_t amperageSensorToCentiamps(const uint16_t src, amperageMeterConfig_t *config)
{
    ...
    return (millivolts * 1000) / (int32_t)config->scale;
}
