...
# 22 "./src/main/sensors/barometer.c" 2
...
# 24 "./src/main/sensors/barometer.c" 2
...
# 29 "./src/main/sensors/barometer.c" 2
...
extern const barometerConfig_t pgResetTemplate_barometerConfig; static barometerConfig_t barometerConfig_Storage[3]; barometerConfig_t *barometerConfig_ProfileCurrent; extern const pgRegistry_t barometerConfig_Registry; const pgRegistry_t barometerConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 38 | (0 << 12), .size = sizeof(barometerConfig_t) | PGR_SIZE_PROFILE_FLAG, .address = (uint8_t*)&barometerConfig_Storage, .ptr = (uint8_t **)&barometerConfig_ProfileCurrent, .reset = {.ptr = (void*)&pgResetTemplate_barometerConfig}, };

static int32_t baroGroundAltitude = 0;
static int32_t baroGroundPressure = 0;
static uint32_t baroPressureSum = 0;

const barometerConfig_t pgResetTemplate_barometerConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .baro_sample_count = 21, .baro_noise_lpf = 0.6f, .baro_cf_vel = 0.985f, .baro_cf_alt = 0.965f, }
...
static int32_t applyBarometerMedianFilter(int32_t newPressureReading)
{
    ...
    static _Bool medianFilterReady = 0;
    int nextSampleIndex;
...
int32_t baroCalculateAltitude(void)
{
    ...
    if (isBaroCalibrationComplete()) {
        BaroAlt_tmp = lrintf((1.0f - powf((float)(baroPressureSum / (barometerConfig()->baro_sample_count - 1)) / 101325.0f, 0.190295f)) * 4433000.0f);
        BaroAlt_tmp -= baroGroundAltitude;
        BaroAlt = lrintf((float)BaroAlt * barometerConfig()->baro_noise_lpf + (float)BaroAlt_tmp * (1.0f - barometerConfig()->baro_noise_lpf));
    }
    else {
        BaroAlt = 0;
    }
