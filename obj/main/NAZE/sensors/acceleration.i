...
extern _Bool AccInflightCalibrationArmed;
extern _Bool AccInflightCalibrationMeasurementDone;
extern _Bool AccInflightCalibrationSavetoEEProm;
extern _Bool AccInflightCalibrationActive;
...
_Bool isOnFinalAccelerationCalibrationCycle(void)
{
    return calibratingA == 1;
}

_Bool isOnFirstAccelerationCalibrationCycle(void)
{
