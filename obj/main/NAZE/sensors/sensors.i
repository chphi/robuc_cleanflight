...
# 19 "./src/main/sensors/sensors.c" 2
...
# 20 "./src/main/sensors/sensors.c" 2
...
# 22 "./src/main/sensors/sensors.c" 2
...
# 24 "./src/main/sensors/sensors.c" 2
...
# 26 "./src/main/sensors/sensors.c" 2
...
# 27 "./src/main/sensors/sensors.c" 2
...
# 29 "./src/main/sensors/sensors.c" 2

sensorSelectionConfig_t sensorSelectionConfig_System; extern const pgRegistry_t sensorSelectionConfig_Registry; const pgRegistry_t sensorSelectionConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 7 | (0 << 12), .size = sizeof(sensorSelectionConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&sensorSelectionConfig_System, .ptr = 0, .reset = {.ptr = 0}, };
sensorAlignmentConfig_t sensorAlignmentConfig_System; extern const pgRegistry_t sensorAlignmentConfig_Registry; const pgRegistry_t sensorAlignmentConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 8 | (0 << 12), .size = sizeof(sensorAlignmentConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&sensorAlignmentConfig_System, .ptr = 0, .reset = {.ptr = 0}, };
sensorTrims_t sensorTrims_System; extern const pgRegistry_t sensorTrims_Registry; const pgRegistry_t sensorTrims_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 9 | (0 << 12), .size = sizeof(sensorTrims_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&sensorTrims_System, .ptr = 0, .reset = {.ptr = 0}, };
